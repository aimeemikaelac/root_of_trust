...
define void @contact_discovery(i32 %operation, i8* %contacts_in_V, i8* %database_in_V, i8* %matched_out_V, i32* %matched_finished, i32* %error_out, i32* %contacts_size_out) {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !197 ; [debug line = 38:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %matched_out_V, [5 x i8]* @p_str2, i32 1, i32 1, [5 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1), !dbg !199 ; [debug line = 39:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %database_in_V, [5 x i8]* @p_str2, i32 1, i32 1, [5 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !200 ; [debug line = 40:1]
  call void (...)* @_ssdm_op_SpecInterface(i8* %contacts_in_V, [5 x i8]* @p_str2, i32 1, i32 1, [5 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !201 ; [debug line = 41:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, [7 x i8]* @p_str4, i32 1, i32 1, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !202 ; [debug line = 42:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %matched_finished, [8 x i8]* @p_str5, i32 1, i32 1, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !203 ; [debug line = 43:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, [8 x i8]* @p_str5, i32 1, i32 1, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !204 ; [debug line = 44:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, [10 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !205 ; [debug line = 45:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, [8 x i8]* @p_str5, i32 1, i32 1, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !206 ; [debug line = 46:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %matched_finished, [10 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !207 ; [debug line = 47:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, [10 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !208 ; [debug line = 48:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, [10 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !209 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [11 x i8]* @p_str6, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !210 ; [debug line = 50:1]
  switch i32 %operation_read, label %19 [
    i32 0, label %1
    i32 1, label %8
    i32 2, label %16
  ], !dbg !211                                    ; [debug line = 56:2]

; <label>:1                                       ; preds = %0
  call void @_ssdm_op_Write.ap_none.i32P(i32* %matched_finished, i32 0), !dbg !212 ; [debug line = 59:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 0), !dbg !214 ; [debug line = 60:4]
  %contacts_size_load_1 = load i32* @contacts_size, align 4, !dbg !215 ; [#uses=1 type=i32] [debug line = 61:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %contacts_size_out, i32 %contacts_size_load_1), !dbg !215 ; [debug line = 61:4]
  br label %2, !dbg !216                          ; [debug line = 62:4]

; <label>:2                                       ; preds = %7, %1
  call void @llvm.dbg.value(metadata !{i8* %contacts_in_V}, i64 0, metadata !217), !dbg !222 ; [debug line = 112:48@62:11] [debug variable = stream<unsigned char>.V]
  %tmp = call i1 @_ssdm_op_NbReadReq.axis.i8P(i8* %contacts_in_V, i32 1), !dbg !224 ; [#uses=1 type=i1] [debug line = 113:20@62:11]
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !226), !dbg !224 ; [debug line = 113:20@62:11] [debug variable = tmp]
  br i1 %tmp, label %3, label %.loopexit.loopexit5, !dbg !223 ; [debug line = 62:11]

; <label>:3                                       ; preds = %2
  %contacts_size_load_3 = load i32* @contacts_size, align 4, !dbg !227 ; [#uses=1 type=i32] [debug line = 63:5]
  %tmp_2 = call i25 @_ssdm_op_PartSelect.i25.i32.i32.i32(i32 %contacts_size_load_3, i32 7, i32 31), !dbg !227 ; [#uses=1 type=i25] [debug line = 63:5]
  %icmp = icmp sgt i25 %tmp_2, 0, !dbg !227       ; [#uses=1 type=i1] [debug line = 63:5]
  br i1 %icmp, label %4, label %.preheader11.preheader, !dbg !227 ; [debug line = 63:5]

.preheader11.preheader:                           ; preds = %3
  br label %.preheader11, !dbg !229               ; [debug line = 67:10]

; <label>:4                                       ; preds = %3
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 1), !dbg !232 ; [debug line = 64:6]
  call void @llvm.dbg.value(metadata !{i8* %contacts_in_V}, i64 0, metadata !234), !dbg !238 ; [debug line = 129:56@65:6] [debug variable = stream<unsigned char>.V]
  %tmp_4_0 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %contacts_in_V), !dbg !240 ; [#uses=0 type=i8] [debug line = 131:9@65:6]
  call void @llvm.dbg.value(metadata !{i8 %tmp_4_0}, i64 0, metadata !242), !dbg !240 ; [debug line = 131:9@65:6] [debug variable = tmp]
  br label %7, !dbg !243                          ; [debug line = 66:5]

.preheader11:                                     ; preds = %5, %.preheader11.preheader
  %i1 = phi i7 [ %i_4, %5 ], [ 0, %.preheader11.preheader ] ; [#uses=3 type=i7]
  %i1_cast = zext i7 %i1 to i32, !dbg !229        ; [#uses=1 type=i32] [debug line = 67:10]
  %exitcond9 = icmp eq i7 %i1, -64, !dbg !229     ; [#uses=1 type=i1] [debug line = 67:10]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) ; [#uses=0 type=i32]
  %i_4 = add i7 %i1, 1, !dbg !244                 ; [#uses=1 type=i7] [debug line = 67:21]
  br i1 %exitcond9, label %6, label %5, !dbg !229 ; [debug line = 67:10]

; <label>:5                                       ; preds = %.preheader11
  call void @llvm.dbg.value(metadata !{i8* %contacts_in_V}, i64 0, metadata !234), !dbg !245 ; [debug line = 129:56@68:40] [debug variable = stream<unsigned char>.V]
  %tmp_5 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %contacts_in_V), !dbg !248 ; [#uses=1 type=i8] [debug line = 131:9@68:40]
  call void @llvm.dbg.value(metadata !{i8 %tmp_5}, i64 0, metadata !242), !dbg !248 ; [debug line = 131:9@68:40] [debug variable = tmp]
  %contacts_size_load_5 = load i32* @contacts_size, align 4, !dbg !246 ; [#uses=1 type=i32] [debug line = 68:40]
  %tmp_6 = shl i32 %contacts_size_load_5, 6, !dbg !246 ; [#uses=1 type=i32] [debug line = 68:40]
  %tmp_8 = add nsw i32 %tmp_6, %i1_cast, !dbg !246 ; [#uses=1 type=i32] [debug line = 68:40]
  %tmp_s = sext i32 %tmp_8 to i64, !dbg !246      ; [#uses=1 type=i64] [debug line = 68:40]
  %contacts_addr_1 = getelementptr inbounds [8192 x i8]* @contacts, i64 0, i64 %tmp_s, !dbg !246 ; [#uses=1 type=i8*] [debug line = 68:40]
  store i8 %tmp_5, i8* %contacts_addr_1, align 1, !dbg !246 ; [debug line = 68:40]
  call void @llvm.dbg.value(metadata !{i7 %i_4}, i64 0, metadata !249), !dbg !244 ; [debug line = 67:21] [debug variable = i]
  br label %.preheader11, !dbg !244               ; [debug line = 67:21]

; <label>:6                                       ; preds = %.preheader11
  %contacts_size_load_4 = load i32* @contacts_size, align 4, !dbg !250 ; [#uses=1 type=i32] [debug line = 70:6]
  %tmp_9 = add nsw i32 %contacts_size_load_4, 1, !dbg !250 ; [#uses=2 type=i32] [debug line = 70:6]
  store i32 %tmp_9, i32* @contacts_size, align 4, !dbg !250 ; [debug line = 70:6]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %contacts_size_out, i32 %tmp_9), !dbg !251 ; [debug line = 71:6]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 0), !dbg !252 ; [debug line = 72:6]
  br label %7

; <label>:7                                       ; preds = %6, %4
  br label %2, !dbg !253                          ; [debug line = 74:4]

; <label>:8                                       ; preds = %0
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 0), !dbg !254 ; [debug line = 79:4]
  %contacts_size_load_2 = load i32* @contacts_size, align 4, !dbg !255 ; [#uses=1 type=i32] [debug line = 80:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %contacts_size_out, i32 %contacts_size_load_2), !dbg !255 ; [debug line = 80:4]
  br label %9, !dbg !256                          ; [debug line = 81:4]

; <label>:9                                       ; preds = %14, %8
  call void @llvm.dbg.value(metadata !{i8* %database_in_V}, i64 0, metadata !217), !dbg !257 ; [debug line = 112:48@81:11] [debug variable = stream<unsigned char>.V]
  %tmp_1 = call i1 @_ssdm_op_NbReadReq.axis.i8P(i8* %database_in_V, i32 1), !dbg !259 ; [#uses=1 type=i1] [debug line = 113:20@81:11]
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !226), !dbg !259 ; [debug line = 113:20@81:11] [debug variable = tmp]
  br i1 %tmp_1, label %.preheader10.preheader, label %15, !dbg !258 ; [debug line = 81:11]

.preheader10.preheader:                           ; preds = %9
  br label %.preheader10, !dbg !260               ; [debug line = 83:9]

.preheader10:                                     ; preds = %10, %.preheader10.preheader
  %i_1 = phi i7 [ %i_2, %10 ], [ 0, %.preheader10.preheader ] ; [#uses=3 type=i7]
  %exitcond8 = icmp eq i7 %i_1, -64, !dbg !260    ; [#uses=1 type=i1] [debug line = 83:9]
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) ; [#uses=0 type=i32]
  %i_2 = add i7 %i_1, 1, !dbg !263                ; [#uses=1 type=i7] [debug line = 83:20]
  br i1 %exitcond8, label %.preheader.preheader, label %10, !dbg !260 ; [debug line = 83:9]

.preheader.preheader:                             ; preds = %.preheader10
  br label %.preheader, !dbg !264                 ; [debug line = 86:9]

; <label>:10                                      ; preds = %.preheader10
  call void @llvm.dbg.value(metadata !{i8* %database_in_V}, i64 0, metadata !234), !dbg !266 ; [debug line = 129:56@84:33] [debug variable = stream<unsigned char>.V]
  %tmp_4 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %database_in_V), !dbg !269 ; [#uses=1 type=i8] [debug line = 131:9@84:33]
  call void @llvm.dbg.value(metadata !{i8 %tmp_4}, i64 0, metadata !242), !dbg !269 ; [debug line = 131:9@84:33] [debug variable = tmp]
  %tmp_7 = zext i7 %i_1 to i64, !dbg !267         ; [#uses=1 type=i64] [debug line = 84:33]
  %current_database_ite = getelementptr inbounds [64 x i8]* @current_database_ite, i64 0, i64 %tmp_7, !dbg !267 ; [#uses=1 type=i8*] [debug line = 84:33]
  store i8 %tmp_4, i8* %current_database_ite, align 1, !dbg !267 ; [debug line = 84:33]
  call void @llvm.dbg.value(metadata !{i7 %i_2}, i64 0, metadata !249), !dbg !263 ; [debug line = 83:20] [debug variable = i]
  br label %.preheader10, !dbg !263               ; [debug line = 83:20]
...
.preheader:                                       ; preds = %compare.exit, %.preheader.preheader
  ...
  %exitcond7 = icmp eq i8 %contact_index_assign, -128, !dbg !264 ; [#uses=1 type=i1] [debug line = 86:9]
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  %i_5 = add i8 %contact_index_assign, 1, !dbg !270 ; [#uses=1 type=i8] [debug line = 86:21]
  br i1 %exitcond7, label %14, label %11, !dbg !264 ; [debug line = 86:9]

; <label>:11                                      ; preds = %.preheader
  call void @llvm.dbg.value(metadata !{i8 %contact_index_assign}, i64 0, metadata !271) nounwind, !dbg !277 ; [debug line = 19:18@87:18] [debug variable = contact_index]
  %tmp_11 = trunc i8 %contact_index_assign to i7  ; [#uses=1 type=i7]
  %tmp_i = call i13 @_ssdm_op_BitConcatenate.i13.i7.i6(i7 %tmp_11, i6 0), !dbg !278 ; [#uses=1 type=i13] [debug line = 24:3@87:18]
  br label %12, !dbg !282                         ; [debug line = 23:6@87:18]

; <label>:12                                      ; preds = %13, %11
  %i_i = phi i7 [ 0, %11 ], [ %i_6, %13 ]         ; [#uses=4 type=i7]
  %comp = phi i1 [ true, %11 ], [ %found_1, %13 ] ; [#uses=2 type=i1]
  %i_i_cast7 = zext i7 %i_i to i13, !dbg !282     ; [#uses=1 type=i13] [debug line = 23:6@87:18]
  %exitcond_i = icmp eq i7 %i_i, -64, !dbg !282   ; [#uses=1 type=i1] [debug line = 23:6@87:18]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) nounwind ; [#uses=0 type=i32]
  %i_6 = add i7 %i_i, 1, !dbg !283                ; [#uses=1 type=i7] [debug line = 23:17@87:18]
  br i1 %exitcond_i, label %compare.exit, label %13, !dbg !282 ; [debug line = 23:6@87:18]

; <label>:13                                      ; preds = %12
  %tmp_i_7 = zext i7 %i_i to i64, !dbg !278       ; [#uses=1 type=i64] [debug line = 24:3@87:18]
  %current_database_ite_1 = getelementptr inbounds [64 x i8]* @current_database_ite, i64 0, i64 %tmp_i_7, !dbg !278 ; [#uses=1 type=i8*] [debug line = 24:3@87:18]
  %current_database_ite_2 = load i8* %current_database_ite_1, align 1, !dbg !278 ; [#uses=1 type=i8] [debug line = 24:3@87:18]
  %tmp_12_i = add i13 %i_i_cast7, %tmp_i, !dbg !278 ; [#uses=1 type=i13] [debug line = 24:3@87:18]
  %tmp_13_i = zext i13 %tmp_12_i to i64, !dbg !278 ; [#uses=1 type=i64] [debug line = 24:3@87:18]
  %contacts_addr_2 = getelementptr inbounds [8192 x i8]* @contacts, i64 0, i64 %tmp_13_i, !dbg !278 ; [#uses=1 type=i8*] [debug line = 24:3@87:18]
  %contacts_load = load i8* %contacts_addr_2, align 1, !dbg !278 ; [#uses=1 type=i8] [debug line = 24:3@87:18]
  %tmp_14_i = icmp eq i8 %current_database_ite_2, %contacts_load, !dbg !278 ; [#uses=1 type=i1] [debug line = 24:3@87:18]
  %found_1 = and i1 %tmp_14_i, %comp, !dbg !278   ; [#uses=1 type=i1] [debug line = 24:3@87:18]
  call void @llvm.dbg.value(metadata !{i1 %found_1}, i64 0, metadata !284) nounwind, !dbg !278 ; [debug line = 24:3@87:18] [debug variable = found]
  call void @llvm.dbg.value(metadata !{i7 %i_6}, i64 0, metadata !285) nounwind, !dbg !283 ; [debug line = 23:17@87:18] [debug variable = i]
  br label %12, !dbg !283                         ; [debug line = 23:17@87:18]

compare.exit:                                     ; preds = %12
  call void @llvm.dbg.value(metadata !{i1 %comp}, i64 0, metadata !286), !dbg !275 ; [debug line = 87:18] [debug variable = comp]
  %found = or i1 %comp, %tmp_10, !dbg !287        ; [#uses=1 type=i1] [debug line = 88:6]
  call void @llvm.dbg.value(metadata !{i1 %found}, i64 0, metadata !288), !dbg !287 ; [debug line = 88:6] [debug variable = found]
  call void @llvm.dbg.value(metadata !{i8 %i_5}, i64 0, metadata !249), !dbg !270 ; [debug line = 86:21] [debug variable = i]
  br label %.preheader, !dbg !270                 ; [debug line = 86:21]

; <label>:14                                      ; preds = %.preheader
  call void @llvm.dbg.value(metadata !{i8* %matched_out_V}, i64 0, metadata !289), !dbg !294 ; [debug line = 144:48@90:5] [debug variable = stream<bool>.V]
  call void @llvm.dbg.value(metadata !{i1 %tmp_10}, i64 0, metadata !296), !dbg !298 ; [debug line = 145:31@90:5] [debug variable = tmp]
  %cast = zext i1 %tmp_10 to i8                   ; [#uses=1 type=i8]
  call void @_ssdm_op_Write.axis.volatile.i8P(i8* %matched_out_V, i8 %cast), !dbg !299 ; [debug line = 146:9@90:5]
  br label %9, !dbg !300                          ; [debug line = 91:4]

; <label>:15                                      ; preds = %9
  call void @_ssdm_op_Write.ap_none.i32P(i32* %matched_finished, i32 1), !dbg !301 ; [debug line = 92:4]
  br label %.loopexit, !dbg !302                  ; [debug line = 93:4]

; <label>:16                                      ; preds = %0
  call void @_ssdm_op_Write.ap_none.i32P(i32* %matched_finished, i32 0), !dbg !303 ; [debug line = 96:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 0), !dbg !304 ; [debug line = 97:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !305 ; [debug line = 99:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %contacts_size_out, i32 0), !dbg !306 ; [debug line = 101:4]
  br label %17, !dbg !307                         ; [debug line = 102:8]

; <label>:17                                      ; preds = %18, %16
  %i_3 = phi i8 [ 0, %16 ], [ %i, %18 ]           ; [#uses=3 type=i8]
  %exitcond = icmp eq i8 %i_3, -128, !dbg !307    ; [#uses=1 type=i1] [debug line = 102:8]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 128, i64 128, i64 128) ; [#uses=0 type=i32]
  %i = add i8 %i_3, 1, !dbg !309                  ; [#uses=1 type=i8] [debug line = 102:20]
  br i1 %exitcond, label %.loopexit.loopexit, label %18, !dbg !307 ; [debug line = 102:8]

; <label>:18                                      ; preds = %17
  %tmp_3 = zext i8 %i_3 to i64, !dbg !310         ; [#uses=1 type=i64] [debug line = 103:5]
  %contacts_addr = getelementptr inbounds [8192 x i8]* @contacts, i64 0, i64 %tmp_3, !dbg !310 ; [#uses=1 type=i8*] [debug line = 103:5]
  store i8 0, i8* %contacts_addr, align 1, !dbg !310 ; [debug line = 103:5]
  call void @llvm.dbg.value(metadata !{i8 %i}, i64 0, metadata !249), !dbg !309 ; [debug line = 102:20] [debug variable = i]
  br label %17, !dbg !309                         ; [debug line = 102:20]

; <label>:19                                      ; preds = %0
  %contacts_size_load = load i32* @contacts_size, align 4, !dbg !312 ; [#uses=1 type=i32] [debug line = 108:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %contacts_size_out, i32 %contacts_size_load), !dbg !312 ; [debug line = 108:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %matched_finished, i32 0), !dbg !313 ; [debug line = 109:4]
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 3), !dbg !314 ; [debug line = 110:4]
  br label %.loopexit, !dbg !315                  ; [debug line = 111:4]
...
.loopexit:                                        ; preds = %.loopexit.loopexit5, %.loopexit.loopexit, %19, %15
  ret void, !dbg !316                             ; [debug line = 113:1]
}
...
!210 = metadata !{i32 50, i32 1, metadata !198, null}
!211 = metadata !{i32 56, i32 2, metadata !198, null}
!212 = metadata !{i32 59, i32 4, metadata !213, null}
!213 = metadata !{i32 786443, metadata !198, i32 56, i32 19, metadata !62, i32 7} ; [ DW_TAG_lexical_block ]
!214 = metadata !{i32 60, i32 4, metadata !213, null}
!215 = metadata !{i32 61, i32 4, metadata !213, null}
!216 = metadata !{i32 62, i32 4, metadata !213, null}
!217 = metadata !{i32 790531, metadata !218, metadata !"stream<unsigned char>.V", null, i32 112, metadata !221, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!218 = metadata !{i32 786689, metadata !219, metadata !"this", metadata !69, i32 16777328, metadata !220, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!219 = metadata !{i32 786478, i32 0, metadata !68, metadata !"empty", metadata !"empty", metadata !"_ZNK3hls6streamIhE5emptyEv", metadata !69, i32 112, metadata !103, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !102, metadata !77, i32 112} ; [ DW_TAG_subprogram ]
!220 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !89} ; [ DW_TAG_pointer_type ]
!221 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !179} ; [ DW_TAG_pointer_type ]
!222 = metadata !{i32 112, i32 48, metadata !219, metadata !223}
!223 = metadata !{i32 62, i32 11, metadata !213, null}
!224 = metadata !{i32 113, i32 20, metadata !225, metadata !223}
!225 = metadata !{i32 786443, metadata !219, i32 112, i32 62, metadata !69, i32 22} ; [ DW_TAG_lexical_block ]
!226 = metadata !{i32 786688, metadata !225, metadata !"tmp", metadata !69, i32 113, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!227 = metadata !{i32 63, i32 5, metadata !228, null}
!228 = metadata !{i32 786443, metadata !213, i32 62, i32 31, metadata !62, i32 8} ; [ DW_TAG_lexical_block ]
!229 = metadata !{i32 67, i32 10, metadata !230, null}
!230 = metadata !{i32 786443, metadata !231, i32 67, i32 6, metadata !62, i32 11} ; [ DW_TAG_lexical_block ]
!231 = metadata !{i32 786443, metadata !228, i32 66, i32 12, metadata !62, i32 10} ; [ DW_TAG_lexical_block ]
!232 = metadata !{i32 64, i32 6, metadata !233, null}
!233 = metadata !{i32 786443, metadata !228, i32 63, i32 29, metadata !62, i32 9} ; [ DW_TAG_lexical_block ]
!234 = metadata !{i32 790531, metadata !235, metadata !"stream<unsigned char>.V", null, i32 129, metadata !221, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!235 = metadata !{i32 786689, metadata !236, metadata !"this", metadata !69, i32 16777345, metadata !237, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!236 = metadata !{i32 786478, i32 0, metadata !68, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamIhE4readEv", metadata !69, i32 129, metadata !110, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !109, metadata !77, i32 129} ; [ DW_TAG_subprogram ]
!237 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !67} ; [ DW_TAG_pointer_type ]
!238 = metadata !{i32 129, i32 56, metadata !236, metadata !239}
!239 = metadata !{i32 65, i32 6, metadata !233, null}
!240 = metadata !{i32 131, i32 9, metadata !241, metadata !239}
!241 = metadata !{i32 786443, metadata !236, i32 129, i32 63, metadata !69, i32 21} ; [ DW_TAG_lexical_block ]
!242 = metadata !{i32 786688, metadata !241, metadata !"tmp", metadata !69, i32 130, metadata !72, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!243 = metadata !{i32 66, i32 5, metadata !233, null}
!244 = metadata !{i32 67, i32 21, metadata !230, null}
!245 = metadata !{i32 129, i32 56, metadata !236, metadata !246}
!246 = metadata !{i32 68, i32 40, metadata !247, null}
!247 = metadata !{i32 786443, metadata !230, i32 67, i32 25, metadata !62, i32 12} ; [ DW_TAG_lexical_block ]
!248 = metadata !{i32 131, i32 9, metadata !241, metadata !246}
!249 = metadata !{i32 786688, metadata !198, metadata !"i", metadata !62, i32 51, metadata !65, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!250 = metadata !{i32 70, i32 6, metadata !231, null}
!251 = metadata !{i32 71, i32 6, metadata !231, null}
!252 = metadata !{i32 72, i32 6, metadata !231, null}
!253 = metadata !{i32 74, i32 4, metadata !228, null}
!254 = metadata !{i32 79, i32 4, metadata !213, null}
!255 = metadata !{i32 80, i32 4, metadata !213, null}
!256 = metadata !{i32 81, i32 4, metadata !213, null}
!257 = metadata !{i32 112, i32 48, metadata !219, metadata !258}
!258 = metadata !{i32 81, i32 11, metadata !213, null}
!259 = metadata !{i32 113, i32 20, metadata !225, metadata !258}
!260 = metadata !{i32 83, i32 9, metadata !261, null}
!261 = metadata !{i32 786443, metadata !262, i32 83, i32 5, metadata !62, i32 14} ; [ DW_TAG_lexical_block ]
!262 = metadata !{i32 786443, metadata !213, i32 81, i32 31, metadata !62, i32 13} ; [ DW_TAG_lexical_block ]
!263 = metadata !{i32 83, i32 20, metadata !261, null}
!264 = metadata !{i32 86, i32 9, metadata !265, null}
!265 = metadata !{i32 786443, metadata !262, i32 86, i32 5, metadata !62, i32 16} ; [ DW_TAG_lexical_block ]
!266 = metadata !{i32 129, i32 56, metadata !236, metadata !267}
!267 = metadata !{i32 84, i32 33, metadata !268, null}
!268 = metadata !{i32 786443, metadata !261, i32 83, i32 24, metadata !62, i32 15} ; [ DW_TAG_lexical_block ]
!269 = metadata !{i32 131, i32 9, metadata !241, metadata !267}
!270 = metadata !{i32 86, i32 21, metadata !265, null}
!271 = metadata !{i32 786689, metadata !272, metadata !"contact_index", metadata !62, i32 16777235, metadata !65, i32 0, metadata !275} ; [ DW_TAG_arg_variable ]
!272 = metadata !{i32 786478, i32 0, metadata !62, metadata !"compare", metadata !"compare", metadata !"_Z7comparei", metadata !62, i32 19, metadata !273, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !77, i32 19} ; [ DW_TAG_subprogram ]
!273 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !274, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!274 = metadata !{metadata !105, metadata !65}
!275 = metadata !{i32 87, i32 18, metadata !276, null}
!276 = metadata !{i32 786443, metadata !265, i32 86, i32 25, metadata !62, i32 17} ; [ DW_TAG_lexical_block ]
!277 = metadata !{i32 19, i32 18, metadata !272, metadata !275}
!278 = metadata !{i32 24, i32 3, metadata !279, metadata !275}
!279 = metadata !{i32 786443, metadata !280, i32 23, i32 21, metadata !62, i32 5} ; [ DW_TAG_lexical_block ]
!280 = metadata !{i32 786443, metadata !281, i32 23, i32 2, metadata !62, i32 4} ; [ DW_TAG_lexical_block ]
!281 = metadata !{i32 786443, metadata !272, i32 19, i32 32, metadata !62, i32 3} ; [ DW_TAG_lexical_block ]
!282 = metadata !{i32 23, i32 6, metadata !280, metadata !275}
!283 = metadata !{i32 23, i32 17, metadata !280, metadata !275}
!284 = metadata !{i32 786688, metadata !281, metadata !"found", metadata !62, i32 21, metadata !105, i32 0, metadata !275} ; [ DW_TAG_auto_variable ]
!285 = metadata !{i32 786688, metadata !281, metadata !"i", metadata !62, i32 20, metadata !65, i32 0, metadata !275} ; [ DW_TAG_auto_variable ]
!286 = metadata !{i32 786688, metadata !276, metadata !"comp", metadata !62, i32 87, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!287 = metadata !{i32 88, i32 6, metadata !276, null}
!288 = metadata !{i32 786688, metadata !198, metadata !"found", metadata !62, i32 54, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!289 = metadata !{i32 790531, metadata !290, metadata !"stream<bool>.V", null, i32 144, metadata !293, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!290 = metadata !{i32 786689, metadata !291, metadata !"this", metadata !69, i32 16777360, metadata !292, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!291 = metadata !{i32 786478, i32 0, metadata !68, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamIbE5writeERKb", metadata !69, i32 144, metadata !149, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !165, metadata !77, i32 144} ; [ DW_TAG_subprogram ]
!292 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !126} ; [ DW_TAG_pointer_type ]
!293 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !188} ; [ DW_TAG_pointer_type ]
!294 = metadata !{i32 144, i32 48, metadata !291, metadata !295}
!295 = metadata !{i32 90, i32 5, metadata !262, null}
!296 = metadata !{i32 786688, metadata !297, metadata !"tmp", metadata !69, i32 145, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!297 = metadata !{i32 786443, metadata !291, i32 144, i32 79, metadata !69, i32 20} ; [ DW_TAG_lexical_block ]
!298 = metadata !{i32 145, i32 31, metadata !297, metadata !295}
!299 = metadata !{i32 146, i32 9, metadata !297, metadata !295}
!300 = metadata !{i32 91, i32 4, metadata !262, null}
!301 = metadata !{i32 92, i32 4, metadata !213, null}
!302 = metadata !{i32 93, i32 4, metadata !213, null}
!303 = metadata !{i32 96, i32 4, metadata !213, null}
!304 = metadata !{i32 97, i32 4, metadata !213, null}
!305 = metadata !{i32 99, i32 4, metadata !213, null}
!306 = metadata !{i32 101, i32 4, metadata !213, null}
!307 = metadata !{i32 102, i32 8, metadata !308, null}
!308 = metadata !{i32 786443, metadata !213, i32 102, i32 4, metadata !62, i32 18} ; [ DW_TAG_lexical_block ]
!309 = metadata !{i32 102, i32 20, metadata !308, null}
!310 = metadata !{i32 103, i32 5, metadata !311, null}
!311 = metadata !{i32 786443, metadata !308, i32 102, i32 24, metadata !62, i32 19} ; [ DW_TAG_lexical_block ]
!312 = metadata !{i32 108, i32 4, metadata !213, null}
!313 = metadata !{i32 109, i32 4, metadata !213, null}
!314 = metadata !{i32 110, i32 4, metadata !213, null}
!315 = metadata !{i32 111, i32 4, metadata !213, null}
!316 = metadata !{i32 113, i32 1, metadata !198, null}
