...
set C_modelArgList {
	{ database_index int 13 regular  }
	{ contacts int 8 regular {array 8192 { 1 1 } 1 1 } {global 0}  }
	{ database int 8 regular {array 480000 { 1 1 } 1 1 } {global 0}  }
	{ results int 1 regular {array 7500 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "database_index", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ database_index sc_in sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "database_index", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "database_index", "role": "default" }} , 
 	...
 	{ "name": "results_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "results", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	database_index { ap_none {  { database_index in_data 0 13 } } }
	...
	results { ap_memory {  { results_address0 mem_address 1 13 }  { results_ce0 mem_ce 1 1 }  { results_we0 mem_we 1 1 }  { results_d0 mem_din 1 1 } } }
}
