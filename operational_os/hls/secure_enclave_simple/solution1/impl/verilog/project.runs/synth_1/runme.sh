...
HD_PWD='/home/michael/xilinx_workspace/secure_enclave_simple/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log secure_enclave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source secure_enclave.tcl
