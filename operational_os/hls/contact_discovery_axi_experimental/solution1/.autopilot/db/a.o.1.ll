...
@db_buffer = internal unnamed_addr global [8 x %struct.ap_uint.3] zeroinitializer, align 64 ; [#uses=2 type=[8 x %struct.ap_uint.3]*]
...
define internal fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %db_item) nounwind uwtable {
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %db_item}, metadata !3063), !dbg !3064 ; [debug line = 19:28] [debug variable = db_item]
  %db_item.addr = getelementptr inbounds %struct.ap_uint.3* %db_item, i64 0, i32 0, i32 0, i32 0, !dbg !3065 ; [#uses=1 type=i512*] [debug line = 2925:9@23:15]
  %db_item.load = load i512* %db_item.addr, align 64, !dbg !3065 ; [#uses=2 type=i512] [debug line = 2925:9@23:15]
  br label %1, !dbg !3071                         ; [debug line = 22:6]

; <label>:1                                       ; preds = %2, %0
  %contacts_index = phi i32 [ 0, %0 ], [ %contacts_index.1, %2 ] ; [#uses=3 type=i32]
  %matched = phi i1 [ false, %0 ], [ %matched.1, %2 ] ; [#uses=2 type=i1]
  %exitcond = icmp eq i32 %contacts_index, 128, !dbg !3071 ; [#uses=1 type=i1] [debug line = 22:6]
  br i1 %exitcond, label %3, label %2, !dbg !3071 ; [debug line = 22:6]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %contacts_index to i64, !dbg !3067 ; [#uses=1 type=i64] [debug line = 23:15]
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp, i32 0, i32 0, i32 0, !dbg !3065 ; [#uses=1 type=i512*] [debug line = 2925:9@23:15]
  %contacts.load = load i512* %contacts.addr, align 64, !dbg !3065 ; [#uses=2 type=i512] [debug line = 2925:9@23:15]
  ...
  %tmp.1 = icmp eq i512 %contacts.load, %db_item.load, !dbg !3065 ; [#uses=1 type=i1] [debug line = 2925:9@23:15]
  %matched.1 = or i1 %matched, %tmp.1, !dbg !3067 ; [#uses=1 type=i1] [debug line = 23:15]
  call void @llvm.dbg.value(metadata !{i1 %matched.1}, i64 0, metadata !3072), !dbg !3067 ; [debug line = 23:15] [debug variable = matched]
  %contacts_index.1 = add nsw i32 %contacts_index, 1, !dbg !3073 ; [#uses=1 type=i32] [debug line = 22:46]
  call void @llvm.dbg.value(metadata !{i32 %contacts_index.1}, i64 0, metadata !3074), !dbg !3073 ; [debug line = 22:46] [debug variable = contacts_index]
  br label %1, !dbg !3073                         ; [debug line = 22:46]

; <label>:3                                       ; preds = %1
  %matched.0.lcssa = phi i1 [ %matched, %1 ]      ; [#uses=1 type=i1]
  ret i1 %matched.0.lcssa, !dbg !3075             ; [debug line = 25:2]
}
...
define void @contact_discovery(i32 %operation, %struct.ap_uint.3* byval align 64 %contact_in, %struct.ap_uint.3* %db_mem, i64 %offset, i32 %db_size_in, i32* %error_out, i32* %contacts_size_out, %"class.hls::stream.27"* %results_out, i64* %current_offset) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %operation}, i64 0, metadata !3076), !dbg !3077 ; [debug line = 38:6] [debug variable = operation]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %contact_in}, metadata !3078), !dbg !3079 ; [debug line = 39:7] [debug variable = contact_in]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %db_mem}, i64 0, metadata !3080), !dbg !3081 ; [debug line = 40:7] [debug variable = db_mem]
  call void @llvm.dbg.value(metadata !{i64 %offset}, i64 0, metadata !3082), !dbg !3083 ; [debug line = 41:21] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %db_size_in}, i64 0, metadata !3084), !dbg !3085 ; [debug line = 42:15] [debug variable = db_size_in]
  call void @llvm.dbg.value(metadata !{i32* %error_out}, i64 0, metadata !3086), !dbg !3087 ; [debug line = 43:7] [debug variable = error_out]
  call void @llvm.dbg.value(metadata !{i32* %contacts_size_out}, i64 0, metadata !3088), !dbg !3089 ; [debug line = 44:7] [debug variable = contacts_size_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3090), !dbg !3091 ; [debug line = 45:30] [debug variable = results_out]
  call void @llvm.dbg.value(metadata !{i64* %current_offset}, i64 0, metadata !3092), !dbg !3093 ; [debug line = 46:22] [debug variable = current_offset]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_uint.3* %db_mem, i32 8388608) nounwind, !dbg !3094 ; [debug line = 47:3]
  call void (...)* @_ssdm_op_SpecInterface(i64* %current_offset, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3096 ; [debug line = 48:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %current_offset, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3097 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3098 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3099 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %db_mem, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 536870912, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 16, i32 16, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3100 ; [debug line = 52:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3102 ; [debug line = 55:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([7 x i8]* @.str8, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3104 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3105 ; [debug line = 59:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3107 ; [debug line = 61:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3108 ; [debug line = 62:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3109 ; [debug line = 63:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %contact_in, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3111 ; [debug line = 65:1]
  switch i32 %operation, label %14 [
    i32 0, label %2
    i32 1, label %6
    i32 2, label %13
  ], !dbg !3112                                   ; [debug line = 69:2]

; <label>:2                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3113 ; [debug line = 72:4]
  %contacts_size.load.1 = load i32* @contacts_size, align 4, !dbg !3115 ; [#uses=1 type=i32] [debug line = 73:4]
  store i32 %contacts_size.load.1, i32* %contacts_size_out, align 4, !dbg !3115 ; [debug line = 73:4]
  %contacts_size.load.2 = load i32* @contacts_size, align 4, !dbg !3116 ; [#uses=3 type=i32] [debug line = 74:4]
  %tmp = icmp sgt i32 %contacts_size.load.2, 127, !dbg !3116 ; [#uses=1 type=i1] [debug line = 74:4]
  br i1 %tmp, label %3, label %4, !dbg !3116      ; [debug line = 74:4]

; <label>:3                                       ; preds = %2
  store i32 1, i32* %error_out, align 4, !dbg !3117 ; [debug line = 75:5]
  %contacts_size.load.4 = load i32* @contacts_size, align 4, !dbg !3119 ; [#uses=1 type=i32] [debug line = 76:5]
  br label %5, !dbg !3120                         ; [debug line = 77:4]

; <label>:4                                       ; preds = %2
  %tmp.5 = sext i32 %contacts_size.load.2 to i64, !dbg !3121 ; [#uses=1 type=i64] [debug line = 78:5]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %contact_in}, i64 0, metadata !3123), !dbg !3124 ; [debug line = 279:87@78:5] [debug variable = op2]
  %contact_in.addr = getelementptr inbounds %struct.ap_uint.3* %contact_in, i64 0, i32 0, i32 0, i32 0, !dbg !3125 ; [#uses=1 type=i512*] [debug line = 280:10@78:5]
  %contact_in.load = load i512* %contact_in.addr, align 64, !dbg !3125 ; [#uses=2 type=i512] [debug line = 280:10@78:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %contact_in.load) nounwind
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp.5, i32 0, i32 0, i32 0, !dbg !3125 ; [#uses=1 type=i512*] [debug line = 280:10@78:5]
  store i512 %contact_in.load, i512* %contacts.addr, align 64, !dbg !3125 ; [debug line = 280:10@78:5]
  %tmp.6 = add nsw i32 %contacts_size.load.2, 1, !dbg !3127 ; [#uses=2 type=i32] [debug line = 79:5]
  store i32 %tmp.6, i32* @contacts_size, align 4, !dbg !3127 ; [debug line = 79:5]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %storemerge = phi i32 [ %tmp.6, %4 ], [ %contacts_size.load.4, %3 ] ; [#uses=1 type=i32]
  store i32 %storemerge, i32* %contacts_size_out, align 4, !dbg !3119 ; [debug line = 76:5]
  br label %.loopexit, !dbg !3128                 ; [debug line = 82:4]

; <label>:6                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3129 ; [debug line = 85:4]
  %contacts_size.load.3 = load i32* @contacts_size, align 4, !dbg !3130 ; [#uses=1 type=i32] [debug line = 86:4]
  store i32 %contacts_size.load.3, i32* %contacts_size_out, align 4, !dbg !3130 ; [debug line = 86:4]
  %db_mem.addr = getelementptr %struct.ap_uint.3* %db_mem, i32 0, i32 0, !dbg !3131 ; [#uses=1 type=%struct.ap_int_base.2*] [debug line = 98:5]
  %tmp.4 = bitcast %struct.ap_int_base.2* %db_mem.addr to i8*, !dbg !3131 ; [#uses=1 type=i8*] [debug line = 98:5]
  %.addr = getelementptr inbounds %struct.ap_uint.3* %1, i64 0, i32 0, i32 0, i32 0, !dbg !3134 ; [#uses=1 type=i512*] [debug line = 103:41]
  %results_out.addr = getelementptr inbounds %"class.hls::stream.27"* %results_out, i64 0, i32 0, !dbg !3138 ; [#uses=1 type=i8*] [debug line = 146:9@103:41]
  br label %7, !dbg !3140                         ; [debug line = 87:8]

; <label>:7                                       ; preds = %12, %6
  %database_index = phi i32 [ 0, %6 ], [ %database_index.1, %12 ] ; [#uses=4 type=i32]
  %tmp.7 = icmp ult i32 %database_index, %db_size_in, !dbg !3140 ; [#uses=1 type=i1] [debug line = 87:8]
  br i1 %tmp.7, label %8, label %.loopexit.loopexit, !dbg !3140 ; [debug line = 87:8]

; <label>:8                                       ; preds = %7
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3141 ; [#uses=1 type=i32] [debug line = 87:76]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3142 ; [debug line = 89:1]
  %tmp.8 = sext i32 %database_index to i64, !dbg !3131 ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.9 = add i64 %tmp.8, %offset, !dbg !3131    ; [#uses=2 type=i64] [debug line = 98:5]
  %tmp.10 = shl i64 %tmp.9, 6, !dbg !3131         ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.4.addr = getelementptr inbounds i8* %tmp.4, i64 %tmp.10, !dbg !3131 ; [#uses=1 type=i8*] [debug line = 98:5]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([8 x %struct.ap_uint.3]* @db_buffer to i8*), i8* %tmp.4.addr, i64 512, i32 1, i1 false), !dbg !3131 ; [debug line = 98:5]
  br label %9, !dbg !3143                         ; [debug line = 99:9]

; <label>:9                                       ; preds = %._crit_edge, %8
  %i = phi i32 [ 0, %8 ], [ %i.1, %._crit_edge ]  ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %i, 8, !dbg !3143       ; [#uses=1 type=i1] [debug line = 99:9]
  br i1 %exitcond, label %12, label %10, !dbg !3143 ; [debug line = 99:9]

; <label>:10                                      ; preds = %9
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !3144 ; [#uses=1 type=i32] [debug line = 99:24]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3145 ; [debug line = 100:1]
  %tmp.12 = add nsw i32 %i, %database_index, !dbg !3146 ; [#uses=1 type=i32] [debug line = 101:2]
  %tmp.13 = icmp ult i32 %tmp.12, %db_size_in, !dbg !3146 ; [#uses=1 type=i1] [debug line = 101:2]
  br i1 %tmp.13, label %11, label %._crit_edge, !dbg !3146 ; [debug line = 101:2]

; <label>:11                                      ; preds = %10
  %tmp.14 = sext i32 %i to i64, !dbg !3134        ; [#uses=1 type=i64] [debug line = 103:41]
  %db_buffer.addr = getelementptr inbounds [8 x %struct.ap_uint.3]* @db_buffer, i64 0, i64 %tmp.14, i32 0, i32 0, i32 0, !dbg !3134 ; [#uses=1 type=i512*] [debug line = 103:41]
  %db_buffer.load = load i512* %db_buffer.addr, align 64, !dbg !3134 ; [#uses=2 type=i512] [debug line = 103:41]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %db_buffer.load) nounwind
  store i512 %db_buffer.load, i512* %.addr, align 64, !dbg !3134 ; [debug line = 103:41]
  %tmp.15 = call fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %1), !dbg !3134 ; [#uses=1 type=i1] [debug line = 103:41]
  %tmp.17 = zext i1 %tmp.15 to i8, !dbg !3134     ; [#uses=1 type=i8] [debug line = 103:41]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3147), !dbg !3149 ; [debug line = 144:48@103:41] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.16}, metadata !3150) nounwind, !dbg !3151 ; [debug line = 145:22@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3150), !dbg !3152 ; [debug line = 145:31@103:41] [debug variable = tmp]
  store i8 %tmp.17, i8* %tmp.16, align 1, !dbg !3152 ; [debug line = 145:31@103:41]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %results_out.addr, i8* %tmp.16) nounwind, !dbg !3138 ; [debug line = 146:9@103:41]
  store i64 %tmp.9, i64* %current_offset, align 8, !dbg !3153 ; [debug line = 104:7]
  br label %._crit_edge, !dbg !3154               ; [debug line = 105:6]

._crit_edge:                                      ; preds = %11, %10
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !3155 ; [#uses=0 type=i32] [debug line = 108:5]
  %i.1 = add nsw i32 %i, 1, !dbg !3156            ; [#uses=1 type=i32] [debug line = 99:19]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !3157), !dbg !3156 ; [debug line = 99:19] [debug variable = i]
  br label %9, !dbg !3156                         ; [debug line = 99:19]

; <label>:12                                      ; preds = %9
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3158 ; [#uses=0 type=i32] [debug line = 109:4]
  %database_index.1 = add nsw i32 %database_index, 8, !dbg !3159 ; [#uses=1 type=i32] [debug line = 87:57]
  call void @llvm.dbg.value(metadata !{i32 %database_index.1}, i64 0, metadata !3160), !dbg !3159 ; [debug line = 87:57] [debug variable = database_index]
  br label %7, !dbg !3159                         ; [debug line = 87:57]

; <label>:13                                      ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3161 ; [debug line = 113:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !3162 ; [debug line = 114:4]
  store i32 0, i32* %contacts_size_out, align 4, !dbg !3163 ; [debug line = 115:4]
  br label %.loopexit, !dbg !3164                 ; [debug line = 116:4]

; <label>:14                                      ; preds = %0
  %contacts_size.load = load i32* @contacts_size, align 4, !dbg !3165 ; [#uses=1 type=i32] [debug line = 119:4]
  store i32 %contacts_size.load, i32* %contacts_size_out, align 4, !dbg !3165 ; [debug line = 119:4]
  store i32 3, i32* %error_out, align 4, !dbg !3166 ; [debug line = 120:4]
  br label %.loopexit, !dbg !3167                 ; [debug line = 121:4]

.loopexit.loopexit:                               ; preds = %7
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %14, %13, %5
  ret void, !dbg !3168                            ; [debug line = 123:1]
}
...
!llvm.dbg.cu = !{!0, !3035}
!opencl.kernels = !{!3036, !3043, !3049, !3052, !3055, !3057, !3057, !3057, !3057}
!hls.encrypted.func = !{}
...
!1383 = metadata !{i32 786484, i32 0, null, metadata !"db_buffer", metadata !"db_buffer", metadata !"_ZL9db_buffer", metadata !902, i32 13, metadata !1384, i32 1, i32 1, [8 x %struct.ap_uint.3]* @db_buffer} ; [ DW_TAG_variable ]
...
!1385 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !1386, i32 315, metadata !1387, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1388 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !1386, i32 316, metadata !1387, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1389 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !1386, i32 317, metadata !1387, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1390 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1391, i32 26, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1392 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1391, i32 30, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1393 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1394, i32 168, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1395 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1396, i32 73, metadata !1397, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1398 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1396, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1399 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1396, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1400 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1396, i32 114, metadata !1397, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1401 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1396, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1402 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1396, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1403 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1404, i32 283, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1405 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1404, i32 297, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1406 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1404, i32 403, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1407 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !1408, i32 57, metadata !213, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1409 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1408, i32 71, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1410 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1408, i32 76, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1411 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1408, i32 80, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1412 = metadata !{i32 786484, i32 0, metadata !1413, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1414, i32 70, metadata !1415, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1417 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !1418, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1420 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !1418, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1421 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1422 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1423 = metadata !{i32 786484, i32 0, metadata !1370, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1424 = metadata !{i32 786484, i32 0, metadata !1370, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 543, metadata !238, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1425 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1426, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1529 = metadata !{i32 786484, i32 0, metadata !1444, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1426, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1530 = metadata !{i32 786484, i32 0, metadata !1531, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1426, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1661 = metadata !{i32 786484, i32 0, metadata !1662, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1426, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1668 = metadata !{i32 786484, i32 0, metadata !1662, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1426, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1669 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1426, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1670 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1426, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1671 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1426, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1672 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1369, i32 60, metadata !1673, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2353 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1369, i32 61, metadata !2354, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2355 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1369, i32 62, metadata !2354, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2356 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1369, i32 63, metadata !2354, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2357 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1369, i32 66, metadata !2358, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3030 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1369, i32 67, metadata !3031, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3032 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1369, i32 68, metadata !3031, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3033 = metadata !{i32 786484, i32 0, metadata !1368, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1369, i32 69, metadata !3031, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3034 = metadata !{i32 786484, i32 0, null, metadata !"contacts_size", metadata !"contacts_size", metadata !"_ZL13contacts_size", metadata !902, i32 14, metadata !56, i32 1, i32 1, i32* @contacts_size} ; [ DW_TAG_variable ]
...
!3036 = metadata !{i1 (%struct.ap_uint.3*)* @match_db_contact, metadata !3037, metadata !3038, metadata !3039, metadata !3040, metadata !3041, metadata !3042}
...
!3043 = metadata !{void (i32, %struct.ap_uint.3*, %struct.ap_uint.3*, i64, i32, i32*, i32*, %"class.hls::stream.27"*, i64*)* @contact_discovery, metadata !3044, metadata !3045, metadata !3046, metadata !3047, metadata !3048, metadata !3042}
...
!3049 = metadata !{null, metadata !3037, metadata !3038, metadata !3050, metadata !3040, metadata !3051, metadata !3042}
!3050 = metadata !{metadata !"kernel_arg_type", metadata !"const uchar &"}
!3051 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!3052 = metadata !{null, metadata !3037, metadata !3038, metadata !3053, metadata !3040, metadata !3054, metadata !3042}
!3053 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<512> &"}
!3054 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3055 = metadata !{null, metadata !3037, metadata !3038, metadata !3056, metadata !3040, metadata !3054, metadata !3042}
!3056 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<512, false> &"}
!3057 = metadata !{null, metadata !3058, metadata !3059, metadata !3060, metadata !3061, metadata !3062, metadata !3042}
...
!3063 = metadata !{i32 786689, metadata !901, metadata !"db_item", metadata !902, i32 16777235, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3064 = metadata !{i32 19, i32 28, metadata !901, null}
!3065 = metadata !{i32 2925, i32 9, metadata !3066, metadata !3067}
!3066 = metadata !{i32 786443, metadata !1310, i32 2924, i32 107, metadata !891, i32 14} ; [ DW_TAG_lexical_block ]
!3067 = metadata !{i32 23, i32 15, metadata !3068, null}
!3068 = metadata !{i32 786443, metadata !3069, i32 22, i32 63, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3069 = metadata !{i32 786443, metadata !3070, i32 22, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3070 = metadata !{i32 786443, metadata !901, i32 19, i32 36, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3071 = metadata !{i32 22, i32 6, metadata !3069, null}
!3072 = metadata !{i32 786688, metadata !3070, metadata !"matched", metadata !902, i32 21, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3073 = metadata !{i32 22, i32 46, metadata !3069, null}
!3074 = metadata !{i32 786688, metadata !3070, metadata !"contacts_index", metadata !902, i32 20, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3075 = metadata !{i32 25, i32 2, metadata !3070, null}
!3076 = metadata !{i32 786689, metadata !1251, metadata !"operation", metadata !902, i32 16777254, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3077 = metadata !{i32 38, i32 6, metadata !1251, null}
!3078 = metadata !{i32 786689, metadata !1251, metadata !"contact_in", metadata !902, i32 33554471, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3079 = metadata !{i32 39, i32 7, metadata !1251, null}
!3080 = metadata !{i32 786689, metadata !1251, metadata !"db_mem", metadata !902, i32 50331688, metadata !1254, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3081 = metadata !{i32 40, i32 7, metadata !1251, null}
!3082 = metadata !{i32 786689, metadata !1251, metadata !"offset", metadata !902, i32 67108905, metadata !983, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3083 = metadata !{i32 41, i32 21, metadata !1251, null}
!3084 = metadata !{i32 786689, metadata !1251, metadata !"db_size_in", metadata !902, i32 83886122, metadata !967, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3085 = metadata !{i32 42, i32 15, metadata !1251, null}
!3086 = metadata !{i32 786689, metadata !1251, metadata !"error_out", metadata !902, i32 100663339, metadata !1255, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3087 = metadata !{i32 43, i32 7, metadata !1251, null}
!3088 = metadata !{i32 786689, metadata !1251, metadata !"contacts_size_out", metadata !902, i32 117440556, metadata !1255, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3089 = metadata !{i32 44, i32 7, metadata !1251, null}
!3090 = metadata !{i32 786689, metadata !1251, metadata !"results_out", metadata !902, i32 134217773, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3091 = metadata !{i32 45, i32 30, metadata !1251, null}
!3092 = metadata !{i32 786689, metadata !1251, metadata !"current_offset", metadata !902, i32 150994990, metadata !1307, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3093 = metadata !{i32 46, i32 22, metadata !1251, null}
!3094 = metadata !{i32 47, i32 3, metadata !3095, null}
!3095 = metadata !{i32 786443, metadata !1251, i32 47, i32 2, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3096 = metadata !{i32 48, i32 1, metadata !3095, null}
!3097 = metadata !{i32 49, i32 1, metadata !3095, null}
!3098 = metadata !{i32 50, i32 1, metadata !3095, null}
!3099 = metadata !{i32 51, i32 1, metadata !3095, null}
!3100 = metadata !{i32 52, i32 1, metadata !3095, null}
!3101 = metadata !{i32 53, i32 1, metadata !3095, null}
!3102 = metadata !{i32 55, i32 1, metadata !3095, null}
!3103 = metadata !{i32 56, i32 1, metadata !3095, null}
!3104 = metadata !{i32 58, i32 1, metadata !3095, null}
!3105 = metadata !{i32 59, i32 1, metadata !3095, null}
!3106 = metadata !{i32 60, i32 1, metadata !3095, null}
!3107 = metadata !{i32 61, i32 1, metadata !3095, null}
!3108 = metadata !{i32 62, i32 1, metadata !3095, null}
!3109 = metadata !{i32 63, i32 1, metadata !3095, null}
!3110 = metadata !{i32 64, i32 1, metadata !3095, null}
!3111 = metadata !{i32 65, i32 1, metadata !3095, null}
!3112 = metadata !{i32 69, i32 2, metadata !3095, null}
!3113 = metadata !{i32 72, i32 4, metadata !3114, null}
!3114 = metadata !{i32 786443, metadata !3095, i32 69, i32 19, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3115 = metadata !{i32 73, i32 4, metadata !3114, null}
!3116 = metadata !{i32 74, i32 4, metadata !3114, null}
!3117 = metadata !{i32 75, i32 5, metadata !3118, null}
!3118 = metadata !{i32 786443, metadata !3114, i32 74, i32 28, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3119 = metadata !{i32 76, i32 5, metadata !3118, null}
!3120 = metadata !{i32 77, i32 4, metadata !3118, null}
!3121 = metadata !{i32 78, i32 5, metadata !3122, null}
!3122 = metadata !{i32 786443, metadata !3114, i32 77, i32 10, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3123 = metadata !{i32 786689, metadata !1309, metadata !"op2", metadata !907, i32 33554711, metadata !1236, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3124 = metadata !{i32 279, i32 87, metadata !1309, metadata !3121}
!3125 = metadata !{i32 280, i32 10, metadata !3126, metadata !3121}
!3126 = metadata !{i32 786443, metadata !1309, i32 279, i32 92, metadata !907, i32 13} ; [ DW_TAG_lexical_block ]
!3127 = metadata !{i32 79, i32 5, metadata !3122, null}
!3128 = metadata !{i32 82, i32 4, metadata !3114, null}
!3129 = metadata !{i32 85, i32 4, metadata !3114, null}
!3130 = metadata !{i32 86, i32 4, metadata !3114, null}
!3131 = metadata !{i32 98, i32 5, metadata !3132, null}
!3132 = metadata !{i32 786443, metadata !3133, i32 87, i32 75, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!3133 = metadata !{i32 786443, metadata !3114, i32 87, i32 4, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3134 = metadata !{i32 103, i32 41, metadata !3135, null}
!3135 = metadata !{i32 786443, metadata !3136, i32 101, i32 37, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!3136 = metadata !{i32 786443, metadata !3137, i32 99, i32 23, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!3137 = metadata !{i32 786443, metadata !3132, i32 99, i32 5, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!3138 = metadata !{i32 146, i32 9, metadata !3139, metadata !3134}
!3139 = metadata !{i32 786443, metadata !1308, i32 144, i32 79, metadata !1259, i32 12} ; [ DW_TAG_lexical_block ]
!3140 = metadata !{i32 87, i32 8, metadata !3133, null}
!3141 = metadata !{i32 87, i32 76, metadata !3132, null}
!3142 = metadata !{i32 89, i32 1, metadata !3132, null}
!3143 = metadata !{i32 99, i32 9, metadata !3137, null}
!3144 = metadata !{i32 99, i32 24, metadata !3136, null}
!3145 = metadata !{i32 100, i32 1, metadata !3136, null}
!3146 = metadata !{i32 101, i32 2, metadata !3136, null}
!3147 = metadata !{i32 786689, metadata !1308, metadata !"this", metadata !1259, i32 16777360, metadata !3148, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3148 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1257} ; [ DW_TAG_pointer_type ]
!3149 = metadata !{i32 144, i32 48, metadata !1308, metadata !3134}
!3150 = metadata !{i32 786688, metadata !3139, metadata !"tmp", metadata !1259, i32 145, metadata !953, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3151 = metadata !{i32 145, i32 22, metadata !3139, metadata !3134}
!3152 = metadata !{i32 145, i32 31, metadata !3139, metadata !3134}
!3153 = metadata !{i32 104, i32 7, metadata !3135, null}
!3154 = metadata !{i32 105, i32 6, metadata !3135, null}
!3155 = metadata !{i32 108, i32 5, metadata !3136, null}
!3156 = metadata !{i32 99, i32 19, metadata !3137, null}
!3157 = metadata !{i32 786688, metadata !3095, metadata !"i", metadata !902, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3158 = metadata !{i32 109, i32 4, metadata !3132, null}
!3159 = metadata !{i32 87, i32 57, metadata !3133, null}
!3160 = metadata !{i32 786688, metadata !3095, metadata !"database_index", metadata !902, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3161 = metadata !{i32 113, i32 4, metadata !3114, null}
!3162 = metadata !{i32 114, i32 4, metadata !3114, null}
!3163 = metadata !{i32 115, i32 4, metadata !3114, null}
!3164 = metadata !{i32 116, i32 4, metadata !3114, null}
!3165 = metadata !{i32 119, i32 4, metadata !3114, null}
!3166 = metadata !{i32 120, i32 4, metadata !3114, null}
!3167 = metadata !{i32 121, i32 4, metadata !3114, null}
!3168 = metadata !{i32 123, i32 1, metadata !3095, null}
