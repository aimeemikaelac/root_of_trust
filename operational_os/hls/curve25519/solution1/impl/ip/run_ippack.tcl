...
set Library     "hls"
set IPName      "curve25519_donna"
set Version     "1.0"
set DisplayName "Curve25519_donna"
set Revision    "1705311759"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "curve25519_donna"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "mypublic_in {base_address 32 range 32} secret_in {base_address 64 range 32} basepoint_in {base_address 96 range 32} mypublic_out {base_address 128 range 32} secret_out {base_address 160 range 32} basepoint_out {base_address 192 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 502158 II x}
...
set enable_xo_gen 0
set kernel_files {/home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/curve25519/src/curve25519-donna.c}
if {$enable_xo_gen} {
