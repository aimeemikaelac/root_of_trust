...
architecture behave of contact_discovery_AXILiteS_s_axi is
    ...
    constant ADDR_OPERATION_DATA_0         : INTEGER := 16#00010#;
    constant ADDR_OPERATION_CTRL           : INTEGER := 16#00014#;
    constant ADDR_MATCHED_FINISHED_DATA_0  : INTEGER := 16#10000#;
    constant ADDR_MATCHED_FINISHED_CTRL    : INTEGER := 16#10004#;
    constant ADDR_ERROR_OUT_DATA_0         : INTEGER := 16#10008#;
    constant ADDR_ERROR_OUT_CTRL           : INTEGER := 16#1000c#;
    constant ADDR_DATABASE_SIZE_OUT_DATA_0 : INTEGER := 16#10010#;
    constant ADDR_DATABASE_SIZE_OUT_CTRL   : INTEGER := 16#10014#;
    constant ADDR_CONTACTS_SIZE_OUT_DATA_0 : INTEGER := 16#10018#;
    constant ADDR_CONTACTS_SIZE_OUT_CTRL   : INTEGER := 16#1001c#;
    constant ADDR_CONTACT_IN_BASE          : INTEGER := 16#00040#;
    constant ADDR_CONTACT_IN_HIGH          : INTEGER := 16#0007f#;
    constant ADDR_DATABASE_IN_BASE         : INTEGER := 16#00080#;
    constant ADDR_DATABASE_IN_HIGH         : INTEGER := 16#000bf#;
    constant ADDR_MATCHED_OUT_BASE         : INTEGER := 16#08000#;
    constant ADDR_MATCHED_OUT_HIGH         : INTEGER := 16#0ffff#;
    ...
    signal int_matched_out_address0 : UNSIGNED(12 downto 0);
    ...
    signal int_matched_out_address1 : UNSIGNED(12 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    -- matched_out
    int_matched_out_address0 <= SHIFT_RIGHT(UNSIGNED(matched_out_address0), 2)(12 downto 0);
    ...
    int_matched_out_address1 <= raddr(14 downto 2) when ar_hs = '1' else waddr(14 downto 2);
