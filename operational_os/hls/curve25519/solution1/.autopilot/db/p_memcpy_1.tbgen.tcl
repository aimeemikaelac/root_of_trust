...
set C_modelName {_memcpy.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 64 regular {array 19 { 0 3 } 0 1 }  }
	{ src int 64 regular {array 19 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dst", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "src", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dst", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 5 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 64 } } }
	src { ap_memory {  { src_address0 mem_address 1 5 }  { src_ce0 mem_ce 1 1 }  { src_q0 mem_dout 0 64 } } }
}
