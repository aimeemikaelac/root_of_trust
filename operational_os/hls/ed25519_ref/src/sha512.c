...
/* compress 1024-bits */
static int sha512_compress_128(sha512_context *md, unsigned char buf[SHA512_BLOCK_SIZE])
{
...
/**
   ...
   @return 0 if successful
*/
int sha512_update_128(sha512_context * md, const unsigned char in[SHA512_BLOCK_SIZE])
{
#pragma HLS ALLOCATION instances=mul limit=1 operation
#pragma HLS ALLOCATION instances=add limit=1 operation
#pragma HLS ALLOCATION instances=shl limit=1 operation
...
#pragma HLS ALLOCATION instances=icmp limit=1 operation
#pragma HLS ALLOCATION instances=sub limit=1 operation
#pragma HLS ALLOCATION instances=sha512_compress_128 limit=1 function
    size_t n;
    size_t i;
    size_t inlen = SHA512_BLOCK_SIZE;
    int temp_index;
    int err;
    unsigned char temp_buf[SHA512_BLOCK_SIZE];
//    if (md == NULL) return 1;
//    if (in == NULL) return 1;
    ...
    while (inlen > 0) {                                                                     
        if (md->curlen == 0 && inlen >= 128) {                           
           ...
           inlen          -= n;                                                             
           if (md->curlen == 128) {
        	   for(temp_index=0; temp_index<SHA512_BLOCK_SIZE; temp_index++){
