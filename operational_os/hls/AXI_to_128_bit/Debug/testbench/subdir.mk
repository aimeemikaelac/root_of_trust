...
CPP_SRCS += \
../src/axi_to_128_bit_tb.cpp 

OBJS += \
./testbench/axi_to_128_bit_tb.o 
...
testbench/axi_to_128_bit_tb.o: /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/AXI_to_128_bit/src/axi_to_128_bit_tb.cpp
	@echo 'Building file: $<'
