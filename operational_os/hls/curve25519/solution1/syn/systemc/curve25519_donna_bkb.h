...
#ifndef __curve25519_donna_bkb__HH__
#define __curve25519_donna_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(curve25519_donna_bkb) {
    ...
    SC_CTOR(curve25519_donna_bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
