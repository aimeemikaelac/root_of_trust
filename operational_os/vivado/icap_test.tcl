...
#
# icap_test.tcl: Tcl script for re-creating project 'icap_test'
#
# Generated by Vivado on Sun Mar 18 23:38:55 MDT 2018
...
#
# 1. This project restoration tcl script (icap_test.tcl) that was generated.
#
...
#
#    "/home/michael/hardware_security/zcu102/root_of_trust/operational_os/vivado/icap_test/icap_test.srcs/sources_1/bd/design_1/design_1.bd"
#    "/home/michael/hardware_security/zcu102/root_of_trust/operational_os/vivado/icap_test/icap_test.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/michael/root_of_trust/operational_os/vivado/icap_test/design_1_add_ten_0_0.dcp"
#    "/home/michael/hardware_security/zcu102/root_of_trust/operational_os/vivado/icap_test/icap_test.runs/design_1_add_five_0_0_synth_1/design_1_add_five_0_0.dcp"
#    "/home/michael/hardware_security/zcu102/root_of_trust/operational_os/vivado/icap_test/icap_test.srcs/constrs_1/new/constraints.xdc"
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/icap_test"]"

# Create project
create_project icap_test ./icap_test -part xczu9eg-ffvb1156-2-i
...
set obj [get_projects icap_test]
...
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/icap_test.cache/compile_simlib/vcs" -objects $obj
...
set_property -name "ip_output_repo" -value "$proj_dir/icap_test.cache/ip" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../../add_ten"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/icap_test/icap_test.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/icap_test/icap_test.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
 "[file normalize "$origin_dir/icap_test/design_1_add_ten_0_0.dcp"]"\
 "[file normalize "$origin_dir/icap_test/icap_test.runs/design_1_add_five_0_0_synth_1/design_1_add_five_0_0.dcp"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/icap_test/icap_test.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "$origin_dir/icap_test/icap_test.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/icap_test/design_1_add_ten_0_0.dcp"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "design_1_i/add_five_0" -objects $file_obj
set_property -name "used_in" -value "synthesis implementation" -objects $file_obj
set_property -name "used_in_implementation" -value "1" -objects $file_obj
set_property -name "used_in_synthesis" -value "1" -objects $file_obj

set file "$origin_dir/icap_test/icap_test.runs/design_1_add_five_0_0_synth_1/design_1_add_five_0_0.dcp"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/icap_test/icap_test.srcs/constrs_1/new/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/icap_test/icap_test.srcs/constrs_1/new/constraints.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "$orig_proj_dir/icap_test.srcs/constrs_1/new/constraints.xdc" -objects $obj
...
puts "INFO: Project created:icap_test"
