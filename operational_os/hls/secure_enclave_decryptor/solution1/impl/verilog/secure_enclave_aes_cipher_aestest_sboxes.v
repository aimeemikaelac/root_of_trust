...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module secure_enclave_aes_cipher_aestest_sboxes_rom (
...
(* ram_style = "block" *)reg [DWIDTH-1:0] ram5[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram6[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram7[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram8[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram9[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram10[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram11[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram12[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram13[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram14[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram15[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram16[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram17[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram18[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram19[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram20[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram21[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram22[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram23[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram24[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram25[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram26[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram27[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram28[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram29[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram30[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram31[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram32[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram33[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram34[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram35[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram36[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram37[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram38[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram39[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram40[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram41[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram42[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram43[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram44[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram45[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram46[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram47[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram48[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram49[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram50[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram51[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram52[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram53[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram54[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram55[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram56[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram57[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram58[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram59[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram60[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram61[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram62[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram63[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram64[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram65[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram66[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram67[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram68[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram69[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram70[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram71[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram72[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram73[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram74[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram75[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram76[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram77[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram78[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram79[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram80[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram81[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram82[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram83[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram84[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram85[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram86[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram87[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram88[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram89[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram90[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram91[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram92[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram93[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram94[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram95[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram96[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram97[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram98[MEM_SIZE-1:0];
(* ram_style = "block" *)reg [DWIDTH-1:0] ram99[MEM_SIZE-1:0];

initial begin
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram0);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram1);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram2);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram3);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram4);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram5);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram6);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram7);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram8);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram9);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram10);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram11);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram12);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram13);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram14);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram15);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram16);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram17);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram18);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram19);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram20);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram21);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram22);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram23);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram24);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram25);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram26);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram27);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram28);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram29);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram30);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram31);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram32);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram33);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram34);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram35);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram36);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram37);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram38);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram39);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram40);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram41);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram42);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram43);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram44);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram45);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram46);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram47);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram48);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram49);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram50);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram51);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram52);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram53);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram54);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram55);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram56);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram57);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram58);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram59);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram60);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram61);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram62);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram63);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram64);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram65);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram66);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram67);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram68);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram69);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram70);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram71);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram72);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram73);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram74);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram75);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram76);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram77);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram78);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram79);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram80);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram81);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram82);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram83);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram84);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram85);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram86);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram87);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram88);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram89);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram90);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram91);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram92);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram93);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram94);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram95);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram96);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram97);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram98);
    $readmemh("./secure_enclave_aes_cipher_aestest_sboxes_rom.dat", ram99);
end
...
`timescale 1 ns / 1 ps
module secure_enclave_aes_cipher_aestest_sboxes(
    reset,
    clk,
    address0,
    ce0,
...
secure_enclave_aes_cipher_aestest_sboxes_rom secure_enclave_aes_cipher_aestest_sboxes_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
