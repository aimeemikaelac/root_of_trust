...
typedef struct {
    ...
    XCurve25519_donna_uio_map maps[ MAX_UIO_MAPS ];
} XCurve25519_donna_uio_info;

/***************** Variable Definitions **************************************/
static XCurve25519_donna_uio_info uio_info;
...
static int uio_info_read_name(XCurve25519_donna_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XCurve25519_donna_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XCurve25519_donna_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XCurve25519_donna_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XCurve25519_donna_Initialize(XCurve25519_donna *InstancePtr, const char* InstanceName) {
	XCurve25519_donna_uio_info *InfoPtr = &uio_info;
