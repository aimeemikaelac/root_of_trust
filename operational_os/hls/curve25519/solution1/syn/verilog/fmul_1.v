...
reg    t_we1;
reg   [63:0] t_d1;
wire    grp_fproduct_3_fu_299_ap_start;
wire    grp_fproduct_3_fu_299_ap_done;
wire    grp_fproduct_3_fu_299_ap_idle;
wire    grp_fproduct_3_fu_299_ap_ready;
wire   [4:0] grp_fproduct_3_fu_299_output_r_address0;
wire    grp_fproduct_3_fu_299_output_r_ce0;
wire    grp_fproduct_3_fu_299_output_r_we0;
wire   [63:0] grp_fproduct_3_fu_299_output_r_d0;
wire   [3:0] grp_fproduct_3_fu_299_in2_address0;
wire    grp_fproduct_3_fu_299_in2_ce0;
wire   [3:0] grp_fproduct_3_fu_299_in_r_address0;
wire    grp_fproduct_3_fu_299_in_r_ce0;
reg   [3:0] i_i_reg_276;
...
reg    ap_reg_grp_fproduct_3_fu_299_ap_start;
wire    ap_CS_fsm_state2;
wire   [63:0] tmp_i_17_fu_537_p1;
...
wire   [63:0] tmp_827_fu_315_p2;
wire   [63:0] tmp_828_fu_321_p2;
wire   [63:0] tmp3_fu_327_p2;
wire   [63:0] grp_fu_309_p2;
wire   [63:0] tmp_829_fu_339_p2;
wire   [63:0] tmp_830_fu_345_p2;
wire   [63:0] tmp5_fu_351_p2;
wire   [63:0] tmp_831_fu_363_p2;
wire   [63:0] tmp_832_fu_369_p2;
wire   [63:0] tmp7_fu_375_p2;
wire   [63:0] tmp_833_fu_387_p2;
wire   [63:0] tmp_834_fu_393_p2;
wire   [63:0] tmp9_fu_399_p2;
wire   [63:0] tmp_835_fu_411_p2;
wire   [63:0] tmp_836_fu_417_p2;
wire   [63:0] tmp11_fu_423_p2;
wire   [63:0] tmp_837_fu_435_p2;
wire   [63:0] tmp_838_fu_441_p2;
wire   [63:0] tmp13_fu_447_p2;
wire   [63:0] tmp_839_fu_459_p2;
wire   [63:0] tmp_840_fu_465_p2;
wire   [63:0] tmp15_fu_471_p2;
wire   [63:0] tmp_841_fu_483_p2;
wire   [63:0] tmp_842_fu_489_p2;
wire   [63:0] tmp17_fu_495_p2;
wire   [63:0] tmp_843_fu_507_p2;
wire   [63:0] tmp_844_fu_513_p2;
wire   [63:0] tmp19_fu_519_p2;
wire   [3:0] tmp_368_i_fu_542_p2;
wire   [0:0] tmp_845_fu_553_p3;
...
wire   [63:0] v_assign_s_fu_614_p2;
wire   [0:0] tmp_846_fu_619_p3;
...
wire  signed [63:0] over_11_fu_651_p1;
wire   [63:0] tmp_848_fu_683_p2;
wire   [63:0] tmp_847_fu_677_p2;
wire   [63:0] tmp21_fu_689_p2;
wire   [63:0] tmp22_fu_695_p2;
wire   [0:0] tmp_849_fu_707_p3;
wire   [63:0] tmp_i13_i_cast_cast_fu_715_p3;
wire   [63:0] tmp_1064_i14_i_fu_723_p2;
wire   [63:0] tmp_380_i_fu_742_p3;
wire  signed [63:0] over_12_fu_739_p1;
reg   [22:0] ap_NS_fsm;

// power-on initialization
initial begin
#0 ap_CS_fsm = 23'd1;
#0 ap_reg_grp_fproduct_3_fu_299_ap_start = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_fproduct_3_fu_299_ap_start <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
            ap_reg_grp_fproduct_3_fu_299_ap_start <= 1'b1;
        end else if ((1'b1 == grp_fproduct_3_fu_299_ap_ready)) begin
            ap_reg_grp_fproduct_3_fu_299_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state18)) begin
        ...
        t_addr_100_reg_949[3 : 0] <= tmp_373_i_fu_606_p1[3 : 0];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state17) & (tmp_i_fu_531_p2 == 1'd1))) begin
        t_addr_98_reg_923[3 : 0] <= tmp_i_17_fu_537_p1[3 : 0];
        t_addr_99_reg_928[3 : 1] <= tmp_369_i_fu_548_p1[3 : 1];
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (grp_fproduct_3_fu_299_ap_done == 1'b1))) begin
...
assign grp_fproduct_3_fu_299_ap_start = ap_reg_grp_fproduct_3_fu_299_ap_start;

assign grp_fu_309_p2 = (t_q1 + t_q0);

assign i_7_fu_768_p2 = (i_i3_reg_288 + 4'd1);

assign i_fu_600_p2 = (i_i_reg_276 + 4'd2);

assign in2_address0 = grp_fproduct_3_fu_299_in_r_address0;

assign in2_ce0 = grp_fproduct_3_fu_299_in_r_ce0;

assign in_r_address0 = grp_fproduct_3_fu_299_in2_address0;

assign in_r_ce0 = grp_fproduct_3_fu_299_in2_ce0;

assign output_r_address0 = tmp_i4_reg_973;

assign output_r_d0 = t_q0;

assign over_11_fu_651_p1 = $signed(tmp_399_i_i_fu_641_p4);

assign over_12_fu_739_p1 = $signed(tmp_397_i16_i_reg_959);

assign over_fu_611_p1 = $signed(tmp_397_i_i_reg_934);

assign t_addr_5_reg_898 = 64'd0;

assign t_addr_84_reg_800 = 64'd7;

assign t_addr_88_reg_831 = 64'd5;

assign t_addr_92_reg_862 = 64'd3;

assign t_addr_96_reg_893 = 64'd1;

assign t_addr_97_reg_909 = 64'd10;

assign tmp11_fu_423_p2 = (tmp_835_fu_411_p2 + tmp_836_fu_417_p2);

assign tmp13_fu_447_p2 = (tmp_837_fu_435_p2 + tmp_838_fu_441_p2);

assign tmp15_fu_471_p2 = (tmp_839_fu_459_p2 + tmp_840_fu_465_p2);

assign tmp17_fu_495_p2 = (tmp_841_fu_483_p2 + tmp_842_fu_489_p2);

assign tmp19_fu_519_p2 = (tmp_843_fu_507_p2 + tmp_844_fu_513_p2);

assign tmp21_fu_689_p2 = (t_q0 + t_q1);

assign tmp22_fu_695_p2 = (tmp_848_fu_683_p2 + tmp_847_fu_677_p2);

assign tmp3_fu_327_p2 = (tmp_827_fu_315_p2 + tmp_828_fu_321_p2);

assign tmp5_fu_351_p2 = (tmp_829_fu_339_p2 + tmp_830_fu_345_p2);

assign tmp7_fu_375_p2 = (tmp_831_fu_363_p2 + tmp_832_fu_369_p2);

assign tmp9_fu_399_p2 = (tmp_833_fu_387_p2 + tmp_834_fu_393_p2);

assign tmp_1064_i14_i_fu_723_p2 = (v_assign_1_fu_701_p2 + tmp_i13_i_cast_cast_fu_715_p3);

assign tmp_1064_i_i_fu_569_p2 = (t_q0 + tmp_i_i_cast_cast_fu_561_p3);

assign tmp_1066_i_i_fu_635_p2 = (tmp_i10_i_cast_cast_fu_627_p3 + v_assign_s_fu_614_p2);
...
assign tmp_372_i_fu_663_p2 = (v_assign_s_fu_614_p2 - tmp_371_i_fu_655_p3);

assign tmp_373_i_fu_606_p1 = i_fu_600_p2;

assign tmp_374_i_fu_670_p2 = ($signed(t_q1) + $signed(over_11_fu_651_p1));

assign tmp_380_i_fu_742_p3 = {{tmp_397_i16_i_reg_959}, {26'd0}};

assign tmp_381_i_fu_749_p2 = (v_assign_1_reg_954 - tmp_380_i_fu_742_p3);

assign tmp_382_i_fu_755_p2 = ($signed(over_12_fu_739_p1) + $signed(t_q1));

assign tmp_397_i_i_fu_575_p4 = {{tmp_1064_i_i_fu_569_p2[63:26]}};

assign tmp_399_i_i_fu_641_p4 = {{tmp_1066_i_i_fu_635_p2[63:25]}};

assign tmp_827_fu_315_p2 = t_q0 << 64'd4;

assign tmp_828_fu_321_p2 = t_q0 << 64'd1;

assign tmp_829_fu_339_p2 = t_q0 << 64'd4;

assign tmp_830_fu_345_p2 = t_q0 << 64'd1;

assign tmp_831_fu_363_p2 = t_q0 << 64'd4;

assign tmp_832_fu_369_p2 = t_q0 << 64'd1;

assign tmp_833_fu_387_p2 = t_q0 << 64'd4;

assign tmp_834_fu_393_p2 = t_q0 << 64'd1;

assign tmp_835_fu_411_p2 = t_q0 << 64'd4;

assign tmp_836_fu_417_p2 = t_q0 << 64'd1;

assign tmp_837_fu_435_p2 = t_q0 << 64'd4;

assign tmp_838_fu_441_p2 = t_q0 << 64'd1;

assign tmp_839_fu_459_p2 = t_q0 << 64'd4;

assign tmp_840_fu_465_p2 = t_q0 << 64'd1;

assign tmp_841_fu_483_p2 = t_q0 << 64'd4;

assign tmp_842_fu_489_p2 = t_q0 << 64'd1;

assign tmp_843_fu_507_p2 = t_q0 << 64'd4;

assign tmp_844_fu_513_p2 = t_q0 << 64'd1;

assign tmp_845_fu_553_p3 = t_q0[32'd63];

assign tmp_846_fu_619_p3 = v_assign_s_fu_614_p2[32'd63];

assign tmp_847_fu_677_p2 = t_q0 << 64'd4;

assign tmp_848_fu_683_p2 = t_q0 << 64'd1;

assign tmp_849_fu_707_p3 = v_assign_1_fu_701_p2[32'd63];

assign tmp_i10_i_cast_cast_fu_627_p3 = ((tmp_846_fu_619_p3[0:0] === 1'b1) ? 64'd33554431 : 64'd0);

assign tmp_i13_i_cast_cast_fu_715_p3 = ((tmp_849_fu_707_p3[0:0] === 1'b1) ? 64'd67108863 : 64'd0);

assign tmp_i4_fu_774_p1 = i_i3_reg_288;

assign tmp_i_17_fu_537_p1 = i_i_reg_276;

assign tmp_i_fu_531_p2 = ((i_i_reg_276 < 4'd10) ? 1'b1 : 1'b0);

assign tmp_i_i_cast_cast_fu_561_p3 = ((tmp_845_fu_553_p3[0:0] === 1'b1) ? 64'd67108863 : 64'd0);

assign v_assign_1_fu_701_p2 = (tmp21_fu_689_p2 + tmp22_fu_695_p2);

assign v_assign_s_fu_614_p2 = ($signed(t_load_111_reg_939) + $signed(over_fu_611_p1));

always @ (posedge ap_clk) begin
    t_addr_98_reg_923[4] <= 1'b0;
    t_addr_99_reg_928[0] <= 1'b1;
    t_addr_99_reg_928[4] <= 1'b0;
    t_addr_100_reg_949[4] <= 1'b0;
