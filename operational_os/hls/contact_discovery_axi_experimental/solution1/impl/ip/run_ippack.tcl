...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS db_in_V results_out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
