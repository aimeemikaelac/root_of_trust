...
if __name__ == "__main__":
    if os.path.exists("test.dat"):
        os.remove("test.dat")
    child = pexpect.spawn("./password_manager_without_enclave")
...
#    child.interact()
    try:
        ...
        pass
    datafile = "data/password_manager_without_enclave_arm_test_{}.csv".format(datetime.datetime.now().isoformat())
