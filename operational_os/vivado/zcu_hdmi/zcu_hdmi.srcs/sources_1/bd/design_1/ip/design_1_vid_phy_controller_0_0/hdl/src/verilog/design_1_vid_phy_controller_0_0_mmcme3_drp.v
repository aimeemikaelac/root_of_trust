...
module design_1_vid_phy_controller_0_0_mmcme3_drp
   #(
      //***********************************************************************
...
(* mark_debug = "true" *)       output reg        SRDY,
...
(* mark_debug = "true" *)       output reg        DWE,
(* mark_debug = "true" *)       output reg        DEN,
(* mark_debug = "true" *)       output reg [6:0]  DADDR,
(* mark_debug = "true" *)       output reg [15:0] DI,
(* mark_debug = "true" *)       output            DCLK,
(* mark_debug = "true" *)       output reg        RST_MMCM
   );
   ...
   // required.
   `include "vid_phy_controller_v2_0_4_mmcme3_drp_func.v"
