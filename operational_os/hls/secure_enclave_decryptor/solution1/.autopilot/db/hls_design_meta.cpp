...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("key_V", 128, hls_in, 0, "ap_vld", "in_data", 1),
	Port_Property("key_V_ap_vld", 1, hls_in, 0, "ap_vld", "in_vld", 1),
...
const char* HLS_Design_Meta::dut_name = "secure_enclave_aes_cipher";
