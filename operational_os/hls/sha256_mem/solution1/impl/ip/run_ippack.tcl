...
set Library     "hls"
set IPName      "sha256_mem"
set Version     "1.0"
set DisplayName "Sha256_mem"
set Revision    "1705062135"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 message_addr W 0x0 "Data signal of message_addr" {{0 32 message_addr W 0 "Bit 31 to 0 Data signal of message_addr"}}} {0x14 message_addr_ctrl RW 0x0 "Control signal of message_addr" {{0 1 message_addr_ap_vld W 0 "Control signal message_addr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 num_blocks W 0x0 "Data signal of num_blocks" {{0 32 num_blocks W 0 "Bit 31 to 0 Data signal of num_blocks"}}} {0x1c num_blocks_ctrl RW 0x0 "Control signal of num_blocks" {{0 1 num_blocks_ap_vld W 0 "Control signal num_blocks_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {/home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/sha256_mem/src/sha256_mem.cpp}
if {$enable_xo_gen} {
