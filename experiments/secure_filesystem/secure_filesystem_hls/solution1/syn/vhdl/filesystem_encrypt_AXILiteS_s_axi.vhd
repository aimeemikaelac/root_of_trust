...
entity filesystem_encrypt_AXILiteS_s_axi is
generic (
...
end entity filesystem_encrypt_AXILiteS_s_axi;
...
architecture behave of filesystem_encrypt_AXILiteS_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_IV_V_DATA_0     : INTEGER := 16#10#;
    constant ADDR_IV_V_DATA_1     : INTEGER := 16#14#;
    constant ADDR_IV_V_DATA_2     : INTEGER := 16#18#;
    constant ADDR_IV_V_DATA_3     : INTEGER := 16#1c#;
    constant ADDR_IV_V_CTRL       : INTEGER := 16#20#;
    ...
    -- internal registers
    signal int_iv_V            : UNSIGNED(127 downto 0) := (others => '0');
    signal int_length_r        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_length_r_ap_vld : STD_LOGIC := '0';
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (w_hs  = '1' and waddr = ADDR_LENGTH_R_CTRL and WSTRB(0) = '1' and WDATA(0) = '1') then
