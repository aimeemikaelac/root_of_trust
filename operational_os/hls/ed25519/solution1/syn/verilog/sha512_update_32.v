...
reg   [63:0] md_curlen_read_7_reg_476;
...
wire   [8:0] tmp_22_fu_404_p1;
reg   [8:0] tmp_22_reg_497;
wire   [6:0] tmp_23_fu_408_p1;
reg   [6:0] tmp_23_reg_502;
...
wire    grp_sha512_compress_32_1_fu_352_ap_start;
wire    grp_sha512_compress_32_1_fu_352_ap_done;
wire    grp_sha512_compress_32_1_fu_352_ap_idle;
wire    grp_sha512_compress_32_1_fu_352_ap_ready;
wire   [2:0] grp_sha512_compress_32_1_fu_352_md_state_address0;
wire    grp_sha512_compress_32_1_fu_352_md_state_ce0;
wire    grp_sha512_compress_32_1_fu_352_md_state_we0;
wire   [63:0] grp_sha512_compress_32_1_fu_352_md_state_d0;
wire   [4:0] grp_sha512_compress_32_1_fu_352_buf_r_address0;
wire    grp_sha512_compress_32_1_fu_352_buf_r_ce0;
...
reg    ap_reg_grp_sha512_compress_32_1_fu_352_ap_start;
...
initial begin
#0 ap_CS_fsm = 17'd1;
#0 ap_reg_grp_sha512_compress_32_1_fu_352_ap_start = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_sha512_compress_32_1_fu_352_ap_start <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state4) & (1'd1 == or_cond_fu_392_p2))) begin
            ap_reg_grp_sha512_compress_32_1_fu_352_ap_start <= 1'b1;
        end else if ((1'b1 == grp_sha512_compress_32_1_fu_352_ap_ready)) begin
            ap_reg_grp_sha512_compress_32_1_fu_352_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state16) & (grp_sha512_compress_32_1_fu_352_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state16) & (grp_sha512_compress_32_1_fu_352_ap_done == 1'b1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        ...
        grp_fu_228_p0 = tmp_25_fu_422_p1;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        grp_fu_228_p0 = tmp_24_fu_412_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state17)) begin
        ...
        grp_fu_228_p1 = tmp_22_reg_497;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        grp_fu_228_p1 = tmp_23_reg_502;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
...
assign grp_sha512_compress_32_1_fu_352_ap_start = ap_reg_grp_sha512_compress_32_1_fu_352_ap_start;

assign icmp_fu_336_p2 = ((tmp_21_fu_382_p4 != 57'd0) ? 1'b1 : 1'b0);
...
assign tmp_21_fu_382_p4 = {{inlen_load_reg_464[63:7]}};

assign tmp_22_fu_404_p1 = i_reg_184[8:0];

assign tmp_23_fu_408_p1 = i_reg_184[6:0];

assign tmp_24_fu_412_p1 = p_01_idx_reg_172[6:0];

assign tmp_25_fu_422_p1 = md_curlen_i[8:0];
