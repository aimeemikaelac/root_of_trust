...
#ifndef __secure_enclave_key_store_aes_sboxes_0_H__
#define __secure_enclave_key_store_aes_sboxes_0_H__
...
struct secure_enclave_key_store_aes_sboxes_0_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(secure_enclave_key_store_aes_sboxes_0_ram) {
        ram[0] = "0b01100011";
        ram[1] = "0b01111100";
        ram[2] = "0b01110111";
        ram[3] = "0b01111011";
...
SC_MODULE(secure_enclave_key_store_aes_sboxes_0) {
...
secure_enclave_key_store_aes_sboxes_0_ram* meminst;


SC_CTOR(secure_enclave_key_store_aes_sboxes_0) {
meminst = new secure_enclave_key_store_aes_sboxes_0_ram("secure_enclave_key_store_aes_sboxes_0_ram");
