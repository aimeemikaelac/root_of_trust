...
set Library     "hls"
set IPName      "contact_discovery"
set Version     "1.0"
set DisplayName "Contact_discovery"
set Revision    "1805071621"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "contact_discovery"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 operation W 0x0 "Data signal of operation" {{0 32 operation W 0 "Bit 31 to 0 Data signal of operation"}}} {0x14 operation_ctrl RW 0x0 "Control signal of operation" {{0 1 operation_ap_vld W 0 "Control signal operation_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 contact_in_V_1 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 31 to 0 Data signal of contact_in_V"}}} {0x1c contact_in_V_2 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 63 to 32 Data signal of contact_in_V"}}} {0x20 contact_in_V_3 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 95 to 64 Data signal of contact_in_V"}}} {0x24 contact_in_V_4 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 127 to 96 Data signal of contact_in_V"}}} {0x28 contact_in_V_5 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 159 to 128 Data signal of contact_in_V"}}} {0x2c contact_in_V_6 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 191 to 160 Data signal of contact_in_V"}}} {0x30 contact_in_V_7 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 223 to 192 Data signal of contact_in_V"}}} {0x34 contact_in_V_8 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 255 to 224 Data signal of contact_in_V"}}} {0x38 contact_in_V_9 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 287 to 256 Data signal of contact_in_V"}}} {0x3c contact_in_V_10 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 319 to 288 Data signal of contact_in_V"}}} {0x40 contact_in_V_11 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 351 to 320 Data signal of contact_in_V"}}} {0x44 contact_in_V_12 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 383 to 352 Data signal of contact_in_V"}}} {0x48 contact_in_V_13 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 415 to 384 Data signal of contact_in_V"}}} {0x4c contact_in_V_14 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 447 to 416 Data signal of contact_in_V"}}} {0x50 contact_in_V_15 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 479 to 448 Data signal of contact_in_V"}}} {0x54 contact_in_V_16 W 0x0 "Data signal of contact_in_V" {{0 32 contact_in_V W 0 "Bit 511 to 480 Data signal of contact_in_V"}}} {0x5c offset_1 W 0x0 "Data signal of offset" {{0 32 offset W 0 "Bit 31 to 0 Data signal of offset"}}} {0x60 offset_2 W 0x0 "Data signal of offset" {{0 32 offset W 0 "Bit 63 to 32 Data signal of offset"}}} {0x68 db_size_in W 0x0 "Data signal of db_size_in" {{0 32 db_size_in W 0 "Bit 31 to 0 Data signal of db_size_in"}}} {0x70 error_out R 0x0 "Data signal of error_out" {{0 32 error_out R 0 "Bit 31 to 0 Data signal of error_out"}}} {0x78 contacts_size_out R 0x0 "Data signal of contacts_size_out" {{0 32 contacts_size_out R 0 "Bit 31 to 0 Data signal of contacts_size_out"}}} {0x80 current_offset_1 R 0x0 "Data signal of current_offset" {{0 32 current_offset R 0 "Bit 31 to 0 Data signal of current_offset"}}} {0x84 current_offset_2 R 0x0 "Data signal of current_offset" {{0 32 current_offset R 0 "Bit 63 to 32 Data signal of current_offset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_db_mem_V results_out_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_db_mem_V {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_db_mem_V"
        data_width "512"
        param_prefix "C_M_AXI_DB_MEM_V"
...
set enable_xo_gen 0
set kernel_files {/home/aimee/root_of_trust/operational_os/hls/contact_discovery_axi_experimental/src/contact_discovery.cpp /home/aimee/root_of_trust/operational_os/hls/contact_discovery_axi_experimental/src/sha512.c}
if {$enable_xo_gen} {
