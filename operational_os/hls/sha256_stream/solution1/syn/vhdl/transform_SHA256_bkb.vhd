...
entity transform_SHA256_bkb_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of transform_SHA256_bkb_rom is 
...
entity transform_SHA256_bkb is
    generic (
...
architecture arch of transform_SHA256_bkb is
    component transform_SHA256_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    transform_SHA256_bkb_rom_U :  component transform_SHA256_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
