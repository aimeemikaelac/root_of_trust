...
; <label>:6                                       ; preds = %match_db_contact.exit, %5
  %database_index = phi i32 [ 0, %5 ], [ %database_index_1, %match_db_contact.exit ]
  %exitcond = icmp eq i32 %database_index, %db_size_in_read
  %database_index_1 = add nsw i32 %database_index, 1
  br i1 %exitcond, label %.loopexit.loopexit, label %7
...
; <label>:8                                       ; preds = %9, %7
  %contacts_index_i = phi i8 [ 0, %7 ], [ %contacts_index, %9 ]
  %matched_i = phi i1 [ false, %7 ], [ %matched, %9 ]
  ...
  br i1 %exitcond_i, label %match_db_contact.exit, label %9
...
; <label>:9                                       ; preds = %8
  ...
  %tmp_1_i = icmp eq i512 %contacts_V_load, %tmp_V
  %matched = or i1 %tmp_1_i, %matched_i
  br label %8

match_db_contact.exit:                            ; preds = %8
  %tmp_1 = zext i1 %matched_i to i8
