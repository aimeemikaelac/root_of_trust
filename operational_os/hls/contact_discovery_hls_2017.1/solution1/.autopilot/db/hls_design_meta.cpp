...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("contacts_in_V_TDATA", 8, hls_in, 1, "axis", "in_data", 1),
	Port_Property("contacts_in_V_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("contacts_in_V_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("database_in_V_TDATA", 8, hls_in, 2, "axis", "in_data", 1),
	Port_Property("database_in_V_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("database_in_V_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
	Port_Property("matched_out_V_TDATA", 8, hls_out, 3, "axis", "out_data", 1),
	Port_Property("matched_out_V_TVALID", 1, hls_out, 3, "axis", "out_vld", 1),
	Port_Property("matched_out_V_TREADY", 1, hls_in, 3, "axis", "out_acc", 1),
