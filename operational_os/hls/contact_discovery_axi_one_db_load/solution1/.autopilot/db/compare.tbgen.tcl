...
set C_modelArgMapList {[ 
	{ "Name" : "db_index", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ db_index sc_in sc_lv 15 signal 0 } 
	...
	{ database_address0 sc_out sc_lv 21 signal 3 } 
	{ database_ce0 sc_out sc_logic 1 signal 3 } 
	{ database_q0 sc_in sc_lv 8 signal 3 } 
	{ database_address1 sc_out sc_lv 21 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "db_index", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "db_index", "role": "default" }} , 
...
set Spec2ImplPortList { 
	db_index { ap_none {  { db_index in_data 0 15 } } }
