...
void ed25519_sign(unsigned char signature[64], unsigned char microblaze_mem[MICROBLAZE_MEMORY], size_t blocks_in, size_t offset, bool start, const unsigned char public_key[32], const unsigned char private_key[64]){
