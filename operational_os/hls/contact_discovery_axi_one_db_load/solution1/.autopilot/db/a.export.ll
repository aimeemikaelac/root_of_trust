...
@results = internal unnamed_addr global [7500 x i1] zeroinitializer, align 16
@database_size = internal unnamed_addr global i32 0, align 4
@database = internal unnamed_addr global [480000 x i8] zeroinitializer, align 16
...
.preheader.preheader:
  %database_index_read = call i13 @_ssdm_op_Read.ap_auto.i13(i13 %database_index)
  %tmp = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 0)
  %tmp_s = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 1)
  %tmp_2 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 2)
  %tmp_1 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 3)
  %tmp_4 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 4)
  %tmp_5 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 5)
  %tmp_6 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 6)
  %tmp_7 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 7)
  %tmp_8 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 8)
  %tmp_9 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 9)
  %tmp_10 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 10)
  %tmp_11 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 11)
  %tmp_12 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 12)
  %tmp_13 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 13)
  %tmp_14 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 14)
  %tmp_15 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 15)
  %tmp_16 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 16)
  %tmp_17 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 17)
  %tmp_18 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 18)
  %tmp_19 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 19)
  %tmp_20 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 20)
  %tmp_21 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 21)
  %tmp_22 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 22)
  %tmp_23 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 23)
  %tmp_24 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 24)
  %tmp_25 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 25)
  %tmp_26 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 26)
  %tmp_27 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 27)
  %tmp_28 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 28)
  %tmp_29 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 29)
  %tmp_30 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 30)
  %tmp_31 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 31)
  %tmp_32 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 32)
  %tmp_33 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 33)
  %tmp_34 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 34)
  %tmp_35 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 35)
  %tmp_36 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 36)
  %tmp_37 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 37)
  %tmp_38 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 38)
  %tmp_39 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 39)
  %tmp_40 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 40)
  %tmp_41 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 41)
  %tmp_42 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 42)
  %tmp_43 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 43)
  %tmp_44 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 44)
  %tmp_45 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 45)
  %tmp_46 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 46)
  %tmp_47 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 47)
  %tmp_48 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 48)
  %tmp_49 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 49)
  %tmp_50 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 50)
  %tmp_51 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 51)
  %tmp_52 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 52)
  %tmp_53 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 53)
  %tmp_54 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 54)
  %tmp_55 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 55)
  %tmp_56 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 56)
  %tmp_57 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 57)
  %tmp_58 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 58)
  %tmp_59 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 59)
  %tmp_60 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 60)
  %tmp_61 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 61)
  %tmp_62 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 62)
  %tmp_63 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 63)
  %tmp_64 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 64)
  %tmp_65 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 65)
  %tmp_66 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 66)
  %tmp_67 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 67)
  %tmp_68 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 68)
  %tmp_69 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 69)
  %tmp_70 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 70)
  %tmp_71 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 71)
  %tmp_72 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 72)
  %tmp_73 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 73)
  %tmp_74 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 74)
  %tmp_75 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 75)
  %tmp_76 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 76)
  %tmp_77 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 77)
  %tmp_78 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 78)
  %tmp_79 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 79)
  %tmp_80 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 80)
  %tmp_81 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 81)
  %tmp_82 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 82)
  %tmp_83 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 83)
  %tmp_84 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 84)
  %tmp_85 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 85)
  %tmp_86 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 86)
  %tmp_87 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 87)
  %tmp_88 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 88)
  %tmp_89 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 89)
  %tmp_90 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 90)
  %tmp_91 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 91)
  %tmp_92 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 92)
  %tmp_93 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 93)
  %tmp_94 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 94)
  %tmp_95 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 95)
  %tmp_96 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 96)
  %tmp_97 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 97)
  %tmp_98 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 98)
  %tmp_99 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 99)
  %tmp_100 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 100)
  %tmp_101 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 101)
  %tmp_102 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 102)
  %tmp_103 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 103)
  %tmp_104 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 104)
  %tmp_105 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 105)
  %tmp_106 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 106)
  %tmp_107 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 107)
  %tmp_108 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 108)
  %tmp_109 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 109)
  %tmp_110 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 110)
  %tmp_111 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 111)
  %tmp_112 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 112)
  %tmp_113 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 113)
  %tmp_114 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 114)
  %tmp_115 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 115)
  %tmp_116 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 116)
  %tmp_117 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 117)
  %tmp_118 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 118)
  %tmp_119 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 119)
  %tmp_120 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 120)
  %tmp_121 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 121)
  %tmp_122 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 122)
  %tmp_123 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 123)
  %tmp_124 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 124)
  %tmp_125 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 125)
  %tmp_126 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 126)
  %tmp_127 = call fastcc zeroext i1 @compare(i13 %database_index_read, i8 127)
  ...
  %tmp_3 = zext i13 %database_index_read to i64
  %results_addr = getelementptr inbounds [7500 x i1]* @results, i64 0, i64 %tmp_3
...
define void @contact_discovery(i32 %operation, [64 x i8]* %contact_in, [64 x i8]* %database_in, [7500 x i1]* %matched_out, i32* %matched_finished, i32* %error_out, i32* %database_size_out, i32* %contacts_size_out) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([7500 x i1]* %matched_out) nounwind, !map !41
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecMemCore([7500 x i1]* %matched_out, [1 x i8]* @p_str8, [7 x i8]* @RAM_1P_str, [1 x i8]* @p_str8, i32 -1, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8, [1 x i8]* @p_str8) nounwind
...
; <label>:7                                       ; preds = %0
  call void @_ssdm_op_Write.ap_none.i32P(i32* %matched_finished, i32 0) nounwind
  call void @_ssdm_op_Write.ap_none.i32P(i32* %error_out, i32 0) nounwind
  %tmp_7 = icmp sgt i32 %database_size_load, 7499
...
; <label>:9                                       ; preds = %7
  %tmp_128 = trunc i32 %database_size_load to i14
  %tmp_2_cast = call i20 @_ssdm_op_BitConcatenate.i20.i14.i6(i14 %tmp_128, i6 0)
  br label %10
...
; <label>:11                                      ; preds = %10
  ...
  %tmp_i6_cast = zext i7 %i_i4 to i20
  %database_in_addr = getelementptr [64 x i8]* %database_in, i64 0, i64 %tmp_i6
  %database_in_load = load i8* %database_in_addr, align 1
  %sum_i9 = add i20 %tmp_i6_cast, %tmp_2_cast
  %sum_i9_cast = sext i20 %sum_i9 to i64
  %database_addr = getelementptr [480000 x i8]* @database, i64 0, i64 %sum_i9_cast
...
; <label>:14                                      ; preds = %15, %13
  %database_index = phi i13 [ 0, %13 ], [ %database_index_1, %15 ]
  %exitcond2 = icmp eq i13 %database_index, -692
  %database_index_1 = add i13 %database_index, 1
...
; <label>:15                                      ; preds = %14
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 7500, i64 7500, i64 7500) nounwind
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str4) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  call fastcc void @match_db_contact(i13 %database_index) nounwind
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_5) nounwind
  br label %14

.preheader:                                       ; preds = %.preheader.preheader, %16
  %i = phi i13 [ %i_1, %16 ], [ 0, %.preheader.preheader ]
  %exitcond = icmp eq i13 %i, -692
  %i_1 = add i13 %i, 1
  br i1 %exitcond, label %17, label %16

; <label>:16                                      ; preds = %.preheader
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 7500, i64 7500, i64 7500) nounwind
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str5) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_4 = zext i13 %i to i64
  %results_addr = getelementptr inbounds [7500 x i1]* @results, i64 0, i64 %tmp_4
  %results_load = load i1* %results_addr, align 1
  %matched_out_addr = getelementptr [7500 x i1]* %matched_out, i64 0, i64 %tmp_4
...
.preheader.preheader:
  ...
  %db_index_read = call i13 @_ssdm_op_Read.ap_auto.i13(i13 %db_index)
  %tmp_129 = trunc i8 %contacts_index_read to i7
  %tmp = call i13 @_ssdm_op_BitConcatenate.i13.i7.i6(i7 %tmp_129, i6 0)
  %tmp_s = call i19 @_ssdm_op_BitConcatenate.i19.i13.i6(i13 %db_index_read, i6 0)
  ...
  %tmp_8 = zext i19 %tmp_s to i64
  %database_addr = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8
  ...
  %tmp_7_s = or i19 %tmp_s, 1
  %tmp_8_1 = zext i19 %tmp_7_s to i64
  %database_addr_1 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_1
  ...
  %tmp_7_1 = or i19 %tmp_s, 2
  %tmp_8_2 = zext i19 %tmp_7_1 to i64
  %database_addr_2 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_2
  ...
  %tmp_7_2 = or i19 %tmp_s, 3
  %tmp_8_3 = zext i19 %tmp_7_2 to i64
  %database_addr_3 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_3
  ...
  %tmp_7_3 = or i19 %tmp_s, 4
  %tmp_8_4 = zext i19 %tmp_7_3 to i64
  %database_addr_4 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_4
  ...
  %tmp_7_4 = or i19 %tmp_s, 5
  %tmp_8_5 = zext i19 %tmp_7_4 to i64
  %database_addr_5 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_5
  ...
  %tmp_7_5 = or i19 %tmp_s, 6
  %tmp_8_6 = zext i19 %tmp_7_5 to i64
  %database_addr_6 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_6
  ...
  %tmp_7_6 = or i19 %tmp_s, 7
  %tmp_8_7 = zext i19 %tmp_7_6 to i64
  %database_addr_7 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_7
  ...
  %tmp_7_7 = or i19 %tmp_s, 8
  %tmp_8_8 = zext i19 %tmp_7_7 to i64
  %database_addr_8 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_8
  ...
  %tmp_7_8 = or i19 %tmp_s, 9
  %tmp_8_9 = zext i19 %tmp_7_8 to i64
  %database_addr_9 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_9
  ...
  %tmp_7_9 = or i19 %tmp_s, 10
  %tmp_8_s = zext i19 %tmp_7_9 to i64
  %database_addr_10 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_s
  ...
  %tmp_7_10 = or i19 %tmp_s, 11
  %tmp_8_10 = zext i19 %tmp_7_10 to i64
  %database_addr_11 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_10
  ...
  %tmp_7_11 = or i19 %tmp_s, 12
  %tmp_8_11 = zext i19 %tmp_7_11 to i64
  %database_addr_12 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_11
  ...
  %tmp_7_12 = or i19 %tmp_s, 13
  %tmp_8_12 = zext i19 %tmp_7_12 to i64
  %database_addr_13 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_12
  ...
  %tmp_7_13 = or i19 %tmp_s, 14
  %tmp_8_13 = zext i19 %tmp_7_13 to i64
  %database_addr_14 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_13
  ...
  %tmp_7_14 = or i19 %tmp_s, 15
  %tmp_8_14 = zext i19 %tmp_7_14 to i64
  %database_addr_15 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_14
  ...
  %tmp_7_15 = or i19 %tmp_s, 16
  %tmp_8_15 = zext i19 %tmp_7_15 to i64
  %database_addr_16 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_15
  ...
  %tmp_7_16 = or i19 %tmp_s, 17
  %tmp_8_16 = zext i19 %tmp_7_16 to i64
  %database_addr_17 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_16
  ...
  %tmp_7_17 = or i19 %tmp_s, 18
  %tmp_8_17 = zext i19 %tmp_7_17 to i64
  %database_addr_18 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_17
  ...
  %tmp_7_18 = or i19 %tmp_s, 19
  %tmp_8_18 = zext i19 %tmp_7_18 to i64
  %database_addr_19 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_18
  ...
  %tmp_7_19 = or i19 %tmp_s, 20
  %tmp_8_19 = zext i19 %tmp_7_19 to i64
  %database_addr_20 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_19
  ...
  %tmp_7_20 = or i19 %tmp_s, 21
  %tmp_8_20 = zext i19 %tmp_7_20 to i64
  %database_addr_21 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_20
  ...
  %tmp_7_21 = or i19 %tmp_s, 22
  %tmp_8_21 = zext i19 %tmp_7_21 to i64
  %database_addr_22 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_21
  ...
  %tmp_7_22 = or i19 %tmp_s, 23
  %tmp_8_22 = zext i19 %tmp_7_22 to i64
  %database_addr_23 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_22
  ...
  %tmp_7_23 = or i19 %tmp_s, 24
  %tmp_8_23 = zext i19 %tmp_7_23 to i64
  %database_addr_24 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_23
  ...
  %tmp_7_24 = or i19 %tmp_s, 25
  %tmp_8_24 = zext i19 %tmp_7_24 to i64
  %database_addr_25 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_24
  ...
  %tmp_7_25 = or i19 %tmp_s, 26
  %tmp_8_25 = zext i19 %tmp_7_25 to i64
  %database_addr_26 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_25
  ...
  %tmp_7_26 = or i19 %tmp_s, 27
  %tmp_8_26 = zext i19 %tmp_7_26 to i64
  %database_addr_27 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_26
  ...
  %tmp_7_27 = or i19 %tmp_s, 28
  %tmp_8_27 = zext i19 %tmp_7_27 to i64
  %database_addr_28 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_27
  ...
  %tmp_7_28 = or i19 %tmp_s, 29
  %tmp_8_28 = zext i19 %tmp_7_28 to i64
  %database_addr_29 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_28
  ...
  %tmp_7_29 = or i19 %tmp_s, 30
  %tmp_8_29 = zext i19 %tmp_7_29 to i64
  %database_addr_30 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_29
  ...
  %tmp_7_30 = or i19 %tmp_s, 31
  %tmp_8_30 = zext i19 %tmp_7_30 to i64
  %database_addr_31 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_30
  ...
  %tmp_7_31 = or i19 %tmp_s, 32
  %tmp_8_31 = zext i19 %tmp_7_31 to i64
  %database_addr_32 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_31
  ...
  %tmp_7_32 = or i19 %tmp_s, 33
  %tmp_8_32 = zext i19 %tmp_7_32 to i64
  %database_addr_33 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_32
  ...
  %tmp_7_33 = or i19 %tmp_s, 34
  %tmp_8_33 = zext i19 %tmp_7_33 to i64
  %database_addr_34 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_33
  ...
  %tmp_7_34 = or i19 %tmp_s, 35
  %tmp_8_34 = zext i19 %tmp_7_34 to i64
  %database_addr_35 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_34
  ...
  %tmp_7_35 = or i19 %tmp_s, 36
  %tmp_8_35 = zext i19 %tmp_7_35 to i64
  %database_addr_36 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_35
  ...
  %tmp_7_36 = or i19 %tmp_s, 37
  %tmp_8_36 = zext i19 %tmp_7_36 to i64
  %database_addr_37 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_36
  ...
  %tmp_7_37 = or i19 %tmp_s, 38
  %tmp_8_37 = zext i19 %tmp_7_37 to i64
  %database_addr_38 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_37
  ...
  %tmp_7_38 = or i19 %tmp_s, 39
  %tmp_8_38 = zext i19 %tmp_7_38 to i64
  %database_addr_39 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_38
  ...
  %tmp_7_39 = or i19 %tmp_s, 40
  %tmp_8_39 = zext i19 %tmp_7_39 to i64
  %database_addr_40 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_39
  ...
  %tmp_7_40 = or i19 %tmp_s, 41
  %tmp_8_40 = zext i19 %tmp_7_40 to i64
  %database_addr_41 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_40
  ...
  %tmp_7_41 = or i19 %tmp_s, 42
  %tmp_8_41 = zext i19 %tmp_7_41 to i64
  %database_addr_42 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_41
  ...
  %tmp_7_42 = or i19 %tmp_s, 43
  %tmp_8_42 = zext i19 %tmp_7_42 to i64
  %database_addr_43 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_42
  ...
  %tmp_7_43 = or i19 %tmp_s, 44
  %tmp_8_43 = zext i19 %tmp_7_43 to i64
  %database_addr_44 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_43
  ...
  %tmp_7_44 = or i19 %tmp_s, 45
  %tmp_8_44 = zext i19 %tmp_7_44 to i64
  %database_addr_45 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_44
  ...
  %tmp_7_45 = or i19 %tmp_s, 46
  %tmp_8_45 = zext i19 %tmp_7_45 to i64
  %database_addr_46 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_45
  ...
  %tmp_7_46 = or i19 %tmp_s, 47
  %tmp_8_46 = zext i19 %tmp_7_46 to i64
  %database_addr_47 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_46
  ...
  %tmp_7_47 = or i19 %tmp_s, 48
  %tmp_8_47 = zext i19 %tmp_7_47 to i64
  %database_addr_48 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_47
  ...
  %tmp_7_48 = or i19 %tmp_s, 49
  %tmp_8_48 = zext i19 %tmp_7_48 to i64
  %database_addr_49 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_48
  ...
  %tmp_7_49 = or i19 %tmp_s, 50
  %tmp_8_49 = zext i19 %tmp_7_49 to i64
  %database_addr_50 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_49
  ...
  %tmp_7_50 = or i19 %tmp_s, 51
  %tmp_8_50 = zext i19 %tmp_7_50 to i64
  %database_addr_51 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_50
  ...
  %tmp_7_51 = or i19 %tmp_s, 52
  %tmp_8_51 = zext i19 %tmp_7_51 to i64
  %database_addr_52 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_51
  ...
  %tmp_7_52 = or i19 %tmp_s, 53
  %tmp_8_52 = zext i19 %tmp_7_52 to i64
  %database_addr_53 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_52
  ...
  %tmp_7_53 = or i19 %tmp_s, 54
  %tmp_8_53 = zext i19 %tmp_7_53 to i64
  %database_addr_54 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_53
  ...
  %tmp_7_54 = or i19 %tmp_s, 55
  %tmp_8_54 = zext i19 %tmp_7_54 to i64
  %database_addr_55 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_54
  ...
  %tmp_7_55 = or i19 %tmp_s, 56
  %tmp_8_55 = zext i19 %tmp_7_55 to i64
  %database_addr_56 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_55
  ...
  %tmp_7_56 = or i19 %tmp_s, 57
  %tmp_8_56 = zext i19 %tmp_7_56 to i64
  %database_addr_57 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_56
  ...
  %tmp_7_57 = or i19 %tmp_s, 58
  %tmp_8_57 = zext i19 %tmp_7_57 to i64
  %database_addr_58 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_57
  ...
  %tmp_7_58 = or i19 %tmp_s, 59
  %tmp_8_58 = zext i19 %tmp_7_58 to i64
  %database_addr_59 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_58
  ...
  %tmp_7_59 = or i19 %tmp_s, 60
  %tmp_8_59 = zext i19 %tmp_7_59 to i64
  %database_addr_60 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_59
  ...
  %tmp_7_60 = or i19 %tmp_s, 61
  %tmp_8_60 = zext i19 %tmp_7_60 to i64
  %database_addr_61 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_60
  ...
  %tmp_7_61 = or i19 %tmp_s, 62
  %tmp_8_61 = zext i19 %tmp_7_61 to i64
  %database_addr_62 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_61
  ...
  %tmp_7_62 = or i19 %tmp_s, 63
  %tmp_8_62 = zext i19 %tmp_7_62 to i64
  %database_addr_63 = getelementptr inbounds [480000 x i8]* @database, i64 0, i64 %tmp_8_62
...
entry:
  ...
  %empty_13 = zext i6 %1 to i20
  %empty_14 = shl i20 %empty, 6
...
entry:
  %empty = zext i13 %0 to i19
  %empty_16 = zext i6 %1 to i19
  %empty_17 = shl i19 %empty, 6
...
!46 = metadata !{i32 0, i32 7499, i32 1}
