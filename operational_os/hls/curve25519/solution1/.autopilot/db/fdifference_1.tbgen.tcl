...
set C_modelName {fdifference.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 64 regular {array 19 { 2 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 5 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 64 }  { output_r_q0 mem_dout 0 64 } } }
