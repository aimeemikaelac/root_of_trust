...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("key_out_V", 128, hls_out, 3, "ap_ovld", "out_data", 1),
	Port_Property("key_out_V_ap_vld", 1, hls_out, 3, "ap_ovld", "out_vld", 1),
...
const char* HLS_Design_Meta::dut_name = "secure_enclave";
