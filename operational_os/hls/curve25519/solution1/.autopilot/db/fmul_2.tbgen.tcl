...
set C_modelName {fmul.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 64 regular {array 11 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ in_r_address0 sc_out sc_lv 4 signal 1 } 
	{ in_r_ce0 sc_out sc_logic 1 signal 1 } 
	{ in_r_q0 sc_in sc_lv 64 signal 1 } 
	{ in2_address0 sc_out sc_lv 4 signal 2 } 
	{ in2_ce0 sc_out sc_logic 1 signal 2 } 
	{ in2_q0 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "in_r", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_fproduct_2_fu_299", "Port" : "in2"}]},
			{"Name" : "in2", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_fproduct_2_fu_299", "Port" : "in_r"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.t_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fproduct_2_fu_299", "Parent" : "0",
		"CDFG" : "fproduct_2",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
