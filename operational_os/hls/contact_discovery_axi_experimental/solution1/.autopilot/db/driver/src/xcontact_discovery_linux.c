...
typedef struct {
    ...
    XContact_discovery_uio_map maps[ MAX_UIO_MAPS ];
} XContact_discovery_uio_info;

/***************** Variable Definitions **************************************/
static XContact_discovery_uio_info uio_info;
...
static int uio_info_read_name(XContact_discovery_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XContact_discovery_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XContact_discovery_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XContact_discovery_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XContact_discovery_Initialize(XContact_discovery *InstancePtr, const char* InstanceName) {
	XContact_discovery_uio_info *InfoPtr = &uio_info;
