...
set C_modelName {fproduct.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 64 regular {array 19 { 0 3 } 0 1 }  }
	{ in2 int 64 regular {array 19 { 1 3 } 1 1 }  }
	{ in_r int 26 regular {array 10 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "in_r", "interface" : "memory", "bitwidth" : 26, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ in2_address0 sc_out sc_lv 5 signal 1 } 
	...
	{ in_r_q0 sc_in sc_lv 26 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "in2", "role": "address0" }} , 
 	...
 	{ "name": "in_r_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "in_r", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	in2 { ap_memory {  { in2_address0 mem_address 1 5 }  { in2_ce0 mem_ce 1 1 }  { in2_q0 mem_dout 0 64 } } }
	in_r { ap_memory {  { in_r_address0 mem_address 1 4 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 26 } } }
}
