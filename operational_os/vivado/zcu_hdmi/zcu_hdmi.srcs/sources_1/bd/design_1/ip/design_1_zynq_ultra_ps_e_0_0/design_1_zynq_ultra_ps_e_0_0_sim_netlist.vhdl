...
entity design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e is
  port (
  ...
  attribute C_DP_USE_AUDIO of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_DP_USE_VIDEO : integer;
  attribute C_DP_USE_VIDEO of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_EN_EMIO_TRACE : integer;
  attribute C_EN_EMIO_TRACE of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_MAXIGP0_DATA_WIDTH : integer;
  attribute C_MAXIGP0_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_MAXIGP1_DATA_WIDTH : integer;
  attribute C_MAXIGP1_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_MAXIGP2_DATA_WIDTH : integer;
  attribute C_MAXIGP2_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 64;
  attribute C_NUM_F2P_0_INTR_INPUTS : integer;
  attribute C_NUM_F2P_0_INTR_INPUTS of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 1;
  attribute C_NUM_F2P_1_INTR_INPUTS : integer;
  attribute C_NUM_F2P_1_INTR_INPUTS of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 1;
  attribute C_NUM_FABRIC_RESETS : integer;
  attribute C_NUM_FABRIC_RESETS of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 1;
  attribute C_PL_CLK0_BUF : string;
  attribute C_PL_CLK0_BUF of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "TRUE";
  attribute C_PL_CLK1_BUF : string;
  attribute C_PL_CLK1_BUF of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "FALSE";
  attribute C_PL_CLK2_BUF : string;
  attribute C_PL_CLK2_BUF of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "FALSE";
  attribute C_PL_CLK3_BUF : string;
  attribute C_PL_CLK3_BUF of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "FALSE";
  attribute C_SAXIGP0_DATA_WIDTH : integer;
  attribute C_SAXIGP0_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP1_DATA_WIDTH : integer;
  attribute C_SAXIGP1_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP2_DATA_WIDTH : integer;
  attribute C_SAXIGP2_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP3_DATA_WIDTH : integer;
  attribute C_SAXIGP3_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP4_DATA_WIDTH : integer;
  attribute C_SAXIGP4_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP5_DATA_WIDTH : integer;
  attribute C_SAXIGP5_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_SAXIGP6_DATA_WIDTH : integer;
  attribute C_SAXIGP6_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 128;
  attribute C_TRACE_DATA_WIDTH : integer;
  attribute C_TRACE_DATA_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 32;
  attribute C_TRACE_PIPELINE_WIDTH : integer;
  attribute C_TRACE_PIPELINE_WIDTH of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 8;
  attribute C_USE_DEBUG_TEST : integer;
  attribute C_USE_DEBUG_TEST of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP0 : integer;
  attribute C_USE_DIFF_RW_CLK_GP0 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP1 : integer;
  attribute C_USE_DIFF_RW_CLK_GP1 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP2 : integer;
  attribute C_USE_DIFF_RW_CLK_GP2 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP3 : integer;
  attribute C_USE_DIFF_RW_CLK_GP3 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP4 : integer;
  attribute C_USE_DIFF_RW_CLK_GP4 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP5 : integer;
  attribute C_USE_DIFF_RW_CLK_GP5 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute C_USE_DIFF_RW_CLK_GP6 : integer;
  attribute C_USE_DIFF_RW_CLK_GP6 of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is 0;
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "design_1_zynq_ultra_ps_e_0_0.hwdef";
  attribute PSS_IO : string;
  attribute PSS_IO of design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e : entity is "Signal Name, DiffPair Type, DiffPair Signal,Direction, Site Type, IO Standard, Drive (mA), Slew Rate, Pull Type, IBIS Model, ODT, OUTPUT_IMPEDANCE " & LF &
 ...
 "DP1_MGTREFCLK0N, , , IN, PS_MGTREFCLK0N_505, , , , , ,,  " & LF &
 "DP1_MGTREFCLK0P, , , IN, PS_MGTREFCLK0P_505, , , , , ,,  " & LF &
...
entity design_1_zynq_ultra_ps_e_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_zynq_ultra_ps_e_0_0 : entity is "design_1_zynq_ultra_ps_e_0_0,zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_zynq_ultra_ps_e_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_zynq_ultra_ps_e_0_0 : entity is "zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e,Vivado 2016.4";
...
architecture STRUCTURE of design_1_zynq_ultra_ps_e_0_0 is
 ...
 " DDR4_DQ63, , , INOUT, PS_DDR_DQ63_504, DDR4, , , ,PS_DDR4_DQ_OUT34|PS_DDR4_DQ_IN40, RTT_40, 34";
  attribute PSS_POWER : string;
  attribute PSS_POWER of inst : label is "<BLOCKTYPE name={PS8}> <PS8><FPD><PROCESSSORS><PROCESSOR name={Cortex A-53} numCores={4} L2Cache={Enable} clockFreq={1099.989} load={0.5}/><PROCESSOR name={GPU Mali-400 MP} numCores={2} clockFreq={499.995} load={0.5} /></PROCESSSORS><PLLS><PLL domain={APU} vco={2199.978} /><PLL domain={DDR} vco={1899.981} /><PLL domain={Video} vco={2799.972} /></PLLS><MEMORY memType={DDR4} dataWidth={8} clockFreq={949.990} readRate={0.5} writeRate={0.5} cmdAddressActivity={0.5} /><SERDES><GT name={PCIe} standard={} lanes={} usageRate={0.5} /><GT name={SATA} standard={SATA3} lanes={1} usageRate={0.5} /><GT name={Display Port} standard={SVGA-60 (800x600)} lanes={2} usageRate={0.5} />clockFreq={60} /><GT name={USB3} standard={USB3.0} lanes={1}usageRate={0.5} /><GT name={SGMII} standard={SGMII} lanes={0} usageRate={0.5} /></SERDES><AFI master={2} slave={1} clockFreq={667} usageRate={0.5} /><FPINTERCONNECT clockFreq={667} Bandwidth={Low} /></FPD><LPD><PROCESSSORS><PROCESSOR name={Cortex R-5} usage={Enable} TCM={Enable} OCM={Enable} clockFreq={499.995} load={0.5}/></PROCESSSORS><PLLS><PLL domain={IO} vco={2999.970} /><PLL domain={RPLL} vco={2799.972} /></PLLS><CSUPMU><Unit name={CSU} usageRate={0.5} clockFreq={180} /><Unit name={PMU} usageRate={0.5} clockFreq={180} /></CSUPMU><GPIO><Bank ioBank={VCC_PSIO0} number={3} io_standard={LVCMOS 1.8V} /><Bank ioBank={VCC_PSIO1} number={2} io_standard={LVCMOS 1.8V} /><Bank ioBank={VCC_PSIO2} number={0} io_standard={LVCMOS 1.8V} /></GPIO><IOINTERFACES> <IO name={QSPI} io_standard={} ioBank={VCC_PSIO0} clockFreq={124.999} inputs={0} outputs={5} inouts={8} usageRate={0.5}/><IO name={NAND 3.1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={USB0} io_standard={} ioBank={VCC_PSIO2} clockFreq={249.997} inputs={3} outputs={1} inouts={8} usageRate={0.5}/><IO name={USB1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth3} io_standard={} ioBank={VCC_PSIO2} clockFreq={124.999} inputs={6} outputs={6} inouts={0} usageRate={0.5}/><IO name={GPIO 0} io_standard={} ioBank={VCC_PSIO0} clockFreq={1} inputs={0} outputs={0} inouts={3} usageRate={0.5}/><IO name={GPIO 1} io_standard={} ioBank={VCC_PSIO1} clockFreq={1} inputs={0} outputs={0} inouts={2} usageRate={0.5}/><IO name={GPIO 2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={UART0} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={1} outputs={1} inouts={0} usageRate={0.5}/><IO name={UART1} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={1} outputs={1} inouts={0} usageRate={0.5}/><IO name={I2C0} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={0} outputs={0} inouts={2} usageRate={0.5}/><IO name={I2C1} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={0} outputs={0} inouts={2} usageRate={0.5}/><IO name={SPI0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SPI1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN1} io_standard={} ioBank={VCC_PSIO0} clockFreq={99.999} inputs={1} outputs={1} inouts={0} usageRate={0.5}/><IO name={SD0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SD1} io_standard={} ioBank={VCC_PSIO1} clockFreq={199.998} inputs={2} outputs={2} inouts={9} usageRate={0.5}/><IO name={Trace} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC0} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC1} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC2} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC3} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={PJTAG} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={DPAUX} io_standard={} ioBank={VCC_PSIO1} clockFreq={} inputs={2} outputs={2} inouts={0} usageRate={0.5}/><IO name={WDT0} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={WDT1} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/></IOINTERFACES><AFI master={0} slave={0} clockFreq={667} usageRate={0.5} /><LPINTERCONNECT clockFreq={667} Bandwidth={High} /></LPD></PS8></BLOCKTYPE>/>";
begin
inst: entity work.design_1_zynq_ultra_ps_e_0_0_zynq_ultra_ps_e_v2_0_1_zynq_ultra_ps_e
     port map (
      ...
      ps_pl_irq_pl_ipi(3 downto 0) => ps_pl_irq_pl_ipi(3 downto 0),
