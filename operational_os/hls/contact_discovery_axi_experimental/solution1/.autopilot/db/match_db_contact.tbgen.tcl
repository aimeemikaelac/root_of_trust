...
set C_modelArgList {
	...
	{ contacts_V int 512 regular {array 128 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ contacts_V_address1 sc_out sc_lv 7 signal 1 } 
	{ contacts_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ contacts_V_q1 sc_in sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "contacts_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "contacts_V", "role": "address1" }} , 
 	{ "name": "contacts_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "contacts_V", "role": "ce1" }} , 
 	{ "name": "contacts_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "contacts_V", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	contacts_V { ap_memory {  { contacts_V_address0 mem_address 1 7 }  { contacts_V_ce0 mem_ce 1 1 }  { contacts_V_q0 mem_dout 0 512 }  { contacts_V_address1 mem_address 1 7 }  { contacts_V_ce1 mem_ce 1 1 }  { contacts_V_q1 mem_dout 0 512 } } }
}
