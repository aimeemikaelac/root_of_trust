...
proc create_root_design { parentCell } {
  ...
  # Create instance: aes_basic_0, and set properties
  set aes_basic_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:aes_basic:1.0 aes_basic_0 ]
...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: secure_enclave_0, and set properties
  set secure_enclave_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:secure_enclave:1.0 secure_enclave_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /secure_enclave_0/s_axi_AXILiteS]
...
CONFIG.PSU__IRQ_P2F_PL_IPI__INT {1} \
...
CONFIG.PSU__VIDEO_REF_CLK__IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins aes_basic_0/s_axi_AXILiteS] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins secure_enclave_0/s_axi_AXILiteS]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins aes_basic_0/ap_rst_n] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins secure_enclave_0/ap_rst_n]
  connect_bd_net -net secure_enclave_0_key_out_V [get_bd_pins aes_basic_0/extern_key_in_V] [get_bd_pins secure_enclave_0/key_out_V]
  connect_bd_net -net secure_enclave_0_key_out_V_ap_vld [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins secure_enclave_0/key_out_V_ap_vld]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins aes_basic_0/ap_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins secure_enclave_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs aes_basic_0/s_axi_AXILiteS/Reg] SEG_aes_basic_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs secure_enclave_0/s_axi_AXILiteS/Reg] SEG_secure_enclave_0_Reg2

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -y 210 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -y 170 -defaultsOSRD
preplace inst secure_enclave_0 -pg 1 -lvl 3 -y 230 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 350 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -y 400 -defaultsOSRD
preplace inst aes_basic_0 -pg 1 -lvl 3 -y 80 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 20 670 20 970
preplace netloc ps8_0_axi_periph_M02_AXI 1 2 1 960
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 2 680 440 980
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 N
preplace netloc secure_enclave_0_key_out_V 1 2 2 990 160 1340
preplace netloc rst_ps8_0_100M_interconnect_aresetn 1 1 1 660
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 960
preplace netloc secure_enclave_0_key_out_V_ap_vld 1 3 1 1330
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 30 650
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N
levelinfo -pg 1 0 340 820 1160 1360 -top 0 -bot 500
",
}
