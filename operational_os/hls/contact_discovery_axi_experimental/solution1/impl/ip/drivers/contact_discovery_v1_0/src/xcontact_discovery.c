...
u32 XContact_discovery_Get_database_size_out(XContact_discovery *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XContact_discovery_ReadReg(InstancePtr->Axilites_BaseAddress, XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_SIZE_OUT_DATA);
    return Data;
}
...
u32 XContact_discovery_Get_database_in_BaseAddress(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE);
}

u32 XContact_discovery_Get_database_in_HighAddress(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_HIGH);
}

u32 XContact_discovery_Get_database_in_TotalBytes(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + 1);
}

u32 XContact_discovery_Get_database_in_BitWidth(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XCONTACT_DISCOVERY_AXILITES_WIDTH_DATABASE_IN;
}

u32 XContact_discovery_Get_database_in_Depth(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XCONTACT_DISCOVERY_AXILITES_DEPTH_DATABASE_IN;
}

u32 XContact_discovery_Write_database_in_Words(XContact_discovery *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XContact_discovery_Read_database_in_Words(XContact_discovery *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + (offset + i)*4);
    }
    return length;
}

u32 XContact_discovery_Write_database_in_Bytes(XContact_discovery *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XContact_discovery_Read_database_in_Bytes(XContact_discovery *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_DATABASE_IN_BASE + offset + i);
    }
    return length;
}

u32 XContact_discovery_Get_matched_out_BaseAddress(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE);
}

u32 XContact_discovery_Get_matched_out_HighAddress(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_HIGH);
}

u32 XContact_discovery_Get_matched_out_TotalBytes(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + 1);
}

u32 XContact_discovery_Get_matched_out_BitWidth(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XCONTACT_DISCOVERY_AXILITES_WIDTH_MATCHED_OUT;
}

u32 XContact_discovery_Get_matched_out_Depth(XContact_discovery *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XCONTACT_DISCOVERY_AXILITES_DEPTH_MATCHED_OUT;
}

u32 XContact_discovery_Write_matched_out_Words(XContact_discovery *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XContact_discovery_Read_matched_out_Words(XContact_discovery *InstancePtr, int offset, int *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + (offset + i)*4);
    }
    return length;
}

u32 XContact_discovery_Write_matched_out_Bytes(XContact_discovery *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_HIGH - XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XContact_discovery_Read_matched_out_Bytes(XContact_discovery *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XCONTACT_DISCOVERY_AXILITES_ADDR_MATCHED_OUT_BASE + offset + i);
    }
    return length;
}
