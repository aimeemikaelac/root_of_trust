...
set Library     "hls"
set IPName      "secure_enclave"
set Version     "1.0"
set DisplayName "Secure_enclave"
set Revision    "1703142128"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "secure_enclave"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ap_return R 0x0 "Data signal of ap_return" {{0 32 ap_return R 0 "Bit 31 to 0 Data signal of ap_return"}}} {0x40 pin_attempt_V_1 W 0x0 "Data signal of pin_attempt_V" {{0 32 pin_attempt_V W 0 "Bit 31 to 0 Data signal of pin_attempt_V"}}} {0x44 pin_attempt_V_2 W 0x0 "Data signal of pin_attempt_V" {{0 32 pin_attempt_V W 0 "Bit 63 to 32 Data signal of pin_attempt_V"}}} {0x48 pin_attempt_V_3 W 0x0 "Data signal of pin_attempt_V" {{0 32 pin_attempt_V W 0 "Bit 95 to 64 Data signal of pin_attempt_V"}}} {0x4c pin_attempt_V_4 W 0x0 "Data signal of pin_attempt_V" {{0 32 pin_attempt_V W 0 "Bit 127 to 96 Data signal of pin_attempt_V"}}} {0x50 pin_attempt_V_ctrl RW 0x0 "Control signal of pin_attempt_V" {{0 1 pin_attempt_V_ap_vld W 0 "Control signal pin_attempt_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 counter_in W 0x0 "Data signal of counter_in" {{0 32 counter_in W 0 "Bit 31 to 0 Data signal of counter_in"}}} {0x84 counter_in_ctrl RW 0x0 "Control signal of counter_in" {{0 1 counter_in_ap_vld W 0 "Control signal counter_in_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 increment_counter R 0x0 "Data signal of increment_counter" {{0 32 increment_counter R 0 "Bit 31 to 0 Data signal of increment_counter"}}} {0x8c increment_counter_ctrl R 0x0 "Control signal of increment_counter" {{0 1 increment_counter_ap_vld R 0 "Control signal increment_counter_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 reset_counter R 0x0 "Data signal of reset_counter" {{0 32 reset_counter R 0 "Bit 31 to 0 Data signal of reset_counter"}}} {0x94 reset_counter_ctrl R 0x0 "Control signal of reset_counter" {{0 1 reset_counter_ap_vld R 0 "Control signal reset_counter_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "secure_storage_in_V {base_address 32 range 32} secure_storage_out_V {base_address 96 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
set enable_xo_gen 0
set kernel_files {/home/michael/xilinx_workspace/secure_enclave_simple/src/secure_enclave_simple.cpp}
if {$enable_xo_gen} {
