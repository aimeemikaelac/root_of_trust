...
HD_PWD='/home/michael/xilinx_workspace/zcu102_aes_basic/zcu102_aes_basic.runs/design_1_secure_enclave_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_secure_enclave_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_secure_enclave_0_0.tcl
