...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SI5324_LOL [ create_bd_port -dir I -from 0 -to 0 SI5324_LOL ]
  set SI5324_RST [ create_bd_port -dir O -from 0 -to 0 -type rst SI5324_RST ]
  set TX_CLK_N_OUT [ create_bd_port -dir O TX_CLK_N_OUT ]
  set TX_CLK_P_OUT [ create_bd_port -dir O TX_CLK_P_OUT ]
  set TX_HPD [ create_bd_port -dir I TX_HPD ]
  set TX_N_OUT [ create_bd_port -dir O -from 2 -to 0 TX_N_OUT ]
  set TX_P_OUT [ create_bd_port -dir O -from 2 -to 0 TX_P_OUT ]
...
CONFIG.LOGO_FILE {data/sym_notgate.png} \
  ...
  set v_hdmi_tx_ss_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_hdmi_tx_ss:2.0 v_hdmi_tx_ss_0 ]
  set_property -dict [ list \
CONFIG.C_INPUT_PIXELS_PER_CLOCK {1} \
 ] $v_hdmi_tx_ss_0
...
CONFIG.MAX_ROWS {1080} \
  ...
  set vid_phy_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:vid_phy_controller:2.0 vid_phy_controller_0 ]
  set_property -dict [ list \
...
CONFIG.PSU__REPORT__DBGLOG {<Select>} \
...
CONFIG.PSU__EP__IP.VALUE_SRC {DEFAULT} \
...
CONFIG.PSU__REPORT__DBGLOG.VALUE_SRC {DEFAULT} \
...
CONFIG.PSU__VIDEO_REF_CLK__IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net vid_phy_controller_0_tx_tmds_clk_n [get_bd_ports TX_CLK_N_OUT] [get_bd_pins vid_phy_controller_0/tx_tmds_clk_n]
