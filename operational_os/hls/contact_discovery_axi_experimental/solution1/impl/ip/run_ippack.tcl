...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_db_mem_V m_axi_results_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_results_out {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_results_out"
        data_width "32"
        param_prefix "C_M_AXI_RESULTS_OUT"
