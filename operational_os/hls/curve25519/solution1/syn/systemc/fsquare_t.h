...
#ifndef __fsquare_t_H__
#define __fsquare_t_H__
...
struct fsquare_t_ram : public sc_core::sc_module {
...
fsquare_t_ram* meminst;


SC_CTOR(fsquare_t) {
meminst = new fsquare_t_ram("fsquare_t_ram");
