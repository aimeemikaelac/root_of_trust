...
set C_modelArgList {
	...
	{ digest int 8 regular {array 32 { 0 } 0 1 }  }
}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "SHA256_m_block", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_transform_fu_252", "Port" : "message"}]},
			{"Name" : "SHA256_m_h", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_transform_fu_252", "Port" : "SHA256_m_h"}]},
			{"Name" : "digest", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "SHA256_sha256_k", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_transform_fu_252", "Port" : "SHA256_sha256_k"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_transform_fu_252", "Parent" : "0", "Child" : ["2", "3", "4"],
		"CDFG" : "transform",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "SHA256_sha256_k", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_transform_fu_252.SHA256_sha256_k_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_transform_fu_252.w_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_transform_fu_252.wv_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	digest { ap_memory {  { digest_address0 mem_address 1 5 }  { digest_ce0 mem_ce 1 1 }  { digest_we0 mem_we 1 1 }  { digest_d0 mem_din 1 8 } } }
}
