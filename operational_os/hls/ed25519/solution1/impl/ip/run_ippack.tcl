...
set Library     "hls"
set IPName      "ed25519_sign"
set Version     "1.0"
set DisplayName "Ed25519_sign"
set Revision    "1709281241"
set Description "An IP generated by Vivado HLS"
set Device      "zynquplus"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "ed25519_sign"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x80 offset_1 W 0x0 "Data signal of offset" {{0 32 offset W 0 "Bit 31 to 0 Data signal of offset"}}} {0x84 offset_2 W 0x0 "Data signal of offset" {{0 32 offset W 0 "Bit 63 to 32 Data signal of offset"}}} {0x8c blocks_in_1 W 0x0 "Data signal of blocks_in" {{0 32 blocks_in W 0 "Bit 31 to 0 Data signal of blocks_in"}}} {0x90 blocks_in_2 W 0x0 "Data signal of blocks_in" {{0 32 blocks_in W 0 "Bit 63 to 32 Data signal of blocks_in"}}} {0x94 blocks_in_ctrl RW 0x0 "Control signal of blocks_in" {{0 1 blocks_in_ap_vld W 0 "Control signal blocks_in_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "signature {base_address 64 range 64} public_key {base_address 160 range 32} private_key {base_address 192 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_microblaze_mem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_microblaze_mem {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_microblaze_mem"
        data_width "32"
        param_prefix "C_M_AXI_MICROBLAZE_MEM"
...
set enable_xo_gen 0
set kernel_files {/home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/verify.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/sign.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/sha512.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/seed.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/sc.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/keypair.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/key_exchange.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/ge.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/fe.cpp /home/michael/hardware_security/zcu102/root_of_trust/operational_os/hls/ed25519/src/add_scalar.cpp}
if {$enable_xo_gen} {
