...
set C_modelArgMapList {[ 
	{ "Name" : "SHA256_m_h", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "tmp_1", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "block_nb", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_1", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "tmp_1", "role": "default" }} , 
 	{ "name": "block_nb", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "block_nb", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "743"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "743"}
]}
...
set Spec2ImplPortList { 
	...
	tmp_1 { ap_none {  { tmp_1 in_data 0 7 } } }
	block_nb { ap_none {  { block_nb in_data 0 1 } } }
}
