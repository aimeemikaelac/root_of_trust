...
entity secure_enclave_aes_cipher_aestest_sboxes_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of secure_enclave_aes_cipher_aestest_sboxes_rom is 
...
entity secure_enclave_aes_cipher_aestest_sboxes is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of secure_enclave_aes_cipher_aestest_sboxes is
    component secure_enclave_aes_cipher_aestest_sboxes_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    secure_enclave_aes_cipher_aestest_sboxes_rom_U :  component secure_enclave_aes_cipher_aestest_sboxes_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
