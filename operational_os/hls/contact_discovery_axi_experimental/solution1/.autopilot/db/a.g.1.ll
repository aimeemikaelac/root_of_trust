...
@db_buffer = internal unnamed_addr global [1 x %struct.ap_uint.3] zeroinitializer, align 64 ; [#uses=2 type=[1 x %struct.ap_uint.3]*]
...
; <label>:7                                       ; preds = %._crit_edge, %6
  %database_index = phi i32 [ 0, %6 ], [ %database_index.1, %._crit_edge ] ; [#uses=4 type=i32]
  %exitcond3 = icmp eq i32 %database_index, %db_size_in, !dbg !3142 ; [#uses=1 type=i1] [debug line = 87:8]
  br i1 %exitcond3, label %.loopexit.loopexit, label %8, !dbg !3142 ; [debug line = 87:8]
...
; <label>:8                                       ; preds = %7
  ...
  %tmp.7 = sext i32 %database_index to i64, !dbg !3133 ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.8 = add i64 %tmp.7, %offset, !dbg !3133    ; [#uses=2 type=i64] [debug line = 98:5]
  %tmp.9 = shl i64 %tmp.8, 6, !dbg !3133          ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.4.addr = getelementptr inbounds i8* %tmp.4, i64 %tmp.9, !dbg !3133 ; [#uses=1 type=i8*] [debug line = 98:5]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([1 x %struct.ap_uint.3]* @db_buffer to i8*), i8* %tmp.4.addr, i64 64, i32 1, i1 false), !dbg !3133 ; [debug line = 98:5]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !3145 ; [#uses=1 type=i32] [debug line = 99:24]
  %tmp.10 = icmp ult i32 %database_index, %db_size_in, !dbg !3146 ; [#uses=1 type=i1] [debug line = 101:2]
  br i1 %tmp.10, label %9, label %._crit_edge, !dbg !3146 ; [debug line = 101:2]

._crit_edge:                                      ; preds = %9, %8
  %rend5 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !3147 ; [#uses=0 type=i32] [debug line = 108:5]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3148 ; [#uses=0 type=i32] [debug line = 109:4]
  %database_index.1 = add nsw i32 %database_index, 1, !dbg !3149 ; [#uses=1 type=i32] [debug line = 87:57]
  call void @llvm.dbg.value(metadata !{i32 %database_index.1}, i64 0, metadata !3150), !dbg !3149 ; [debug line = 87:57] [debug variable = database_index]
  br label %7, !dbg !3149                         ; [debug line = 87:57]

; <label>:9                                       ; preds = %8
  %db_buffer.load = load i512* getelementptr inbounds ([1 x %struct.ap_uint.3]* @db_buffer, i64 0, i64 0, i32 0, i32 0, i32 0), align 64, !dbg !3136 ; [#uses=2 type=i512] [debug line = 103:41]
  ...
  %tmp.11 = call fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %1), !dbg !3136 ; [#uses=1 type=i1] [debug line = 103:41]
  %tmp.13 = zext i1 %tmp.11 to i8, !dbg !3136     ; [#uses=1 type=i8] [debug line = 103:41]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3151), !dbg !3153 ; [debug line = 144:48@103:41] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.12}, metadata !3154) nounwind, !dbg !3155 ; [debug line = 145:22@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.13}, i64 0, metadata !3154), !dbg !3156 ; [debug line = 145:31@103:41] [debug variable = tmp]
  store i8 %tmp.13, i8* %tmp.12, align 1, !dbg !3156 ; [debug line = 145:31@103:41]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %results_out.addr, i8* %tmp.12) nounwind, !dbg !3140 ; [debug line = 146:9@103:41]
  store i64 %tmp.8, i64* %current_offset, align 8, !dbg !3157 ; [debug line = 104:7]
  br label %._crit_edge, !dbg !3158               ; [debug line = 105:6]

; <label>:10                                      ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3159 ; [debug line = 113:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !3160 ; [debug line = 114:4]
  store i32 0, i32* %contacts_size_out, align 4, !dbg !3161 ; [debug line = 115:4]
  br label %.loopexit, !dbg !3162                 ; [debug line = 116:4]

; <label>:11                                      ; preds = %0
  %contacts_size.load = load i32* @contacts_size, align 4, !dbg !3163 ; [#uses=1 type=i32] [debug line = 119:4]
  store i32 %contacts_size.load, i32* %contacts_size_out, align 4, !dbg !3163 ; [debug line = 119:4]
  store i32 3, i32* %error_out, align 4, !dbg !3164 ; [debug line = 120:4]
  br label %.loopexit, !dbg !3165                 ; [debug line = 121:4]

.loopexit.loopexit:                               ; preds = %7
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %11, %10, %5
  ret void, !dbg !3166                            ; [debug line = 123:1]
}
...
!1383 = metadata !{i32 786484, i32 0, null, metadata !"db_buffer", metadata !"db_buffer", metadata !"_ZL9db_buffer", metadata !902, i32 13, metadata !1384, i32 1, i32 1, [1 x %struct.ap_uint.3]* @db_buffer} ; [ DW_TAG_variable ]
...
!3134 = metadata !{i32 786443, metadata !3135, i32 87, i32 75, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
...
!3138 = metadata !{i32 786443, metadata !3139, i32 99, i32 23, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
...
!3145 = metadata !{i32 99, i32 24, metadata !3138, null}
!3146 = metadata !{i32 101, i32 2, metadata !3138, null}
!3147 = metadata !{i32 108, i32 5, metadata !3138, null}
!3148 = metadata !{i32 109, i32 4, metadata !3134, null}
!3149 = metadata !{i32 87, i32 57, metadata !3135, null}
!3150 = metadata !{i32 786688, metadata !3097, metadata !"database_index", metadata !902, i32 66, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3151 = metadata !{i32 786689, metadata !1308, metadata !"this", metadata !1259, i32 16777360, metadata !3152, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3152 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1257} ; [ DW_TAG_pointer_type ]
!3153 = metadata !{i32 144, i32 48, metadata !1308, metadata !3136}
!3154 = metadata !{i32 786688, metadata !3141, metadata !"tmp", metadata !1259, i32 145, metadata !953, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3155 = metadata !{i32 145, i32 22, metadata !3141, metadata !3136}
!3156 = metadata !{i32 145, i32 31, metadata !3141, metadata !3136}
!3157 = metadata !{i32 104, i32 7, metadata !3137, null}
!3158 = metadata !{i32 105, i32 6, metadata !3137, null}
!3159 = metadata !{i32 113, i32 4, metadata !3116, null}
!3160 = metadata !{i32 114, i32 4, metadata !3116, null}
!3161 = metadata !{i32 115, i32 4, metadata !3116, null}
!3162 = metadata !{i32 116, i32 4, metadata !3116, null}
!3163 = metadata !{i32 119, i32 4, metadata !3116, null}
!3164 = metadata !{i32 120, i32 4, metadata !3116, null}
!3165 = metadata !{i32 121, i32 4, metadata !3116, null}
!3166 = metadata !{i32 123, i32 1, metadata !3097, null}
