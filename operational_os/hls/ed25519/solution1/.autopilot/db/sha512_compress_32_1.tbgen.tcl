set moduleName sha512_compress_32_1
...
set C_modelName {sha512_compress_32.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ md_state int 64 regular {array 8 { 2 3 } 1 1 }  }
	{ buf_r int 8 regular {array 32 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ buf_r_address0 sc_out sc_lv 5 signal 1 } 
	{ buf_r_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf_r_q0 sc_in sc_lv 8 signal 1 } 
	{ buf_r_address1 sc_out sc_lv 5 signal 1 } 
...
set Spec2ImplPortList { 
	...
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 5 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_q0 mem_dout 0 8 }  { buf_r_address1 mem_address 1 5 }  { buf_r_ce1 mem_ce 1 1 }  { buf_r_q1 mem_dout 0 8 } } }
