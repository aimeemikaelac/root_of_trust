...
set C_modelName {_memcpy}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 64 regular {array 10 { 0 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 4 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 64 } } }
