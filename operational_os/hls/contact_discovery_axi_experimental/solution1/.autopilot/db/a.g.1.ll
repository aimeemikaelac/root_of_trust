...
@results_buffer = internal unnamed_addr global [32 x i1] zeroinitializer, align 16 ; [#uses=2 type=[32 x i1]*]
@llvm.global_ctors = appending global [1 x { i32, void ()* }] [{ i32, void ()* } { i32 65535, void ()* @_GLOBAL__I_a }] ; [#uses=0 type=[1 x { i32, void ()* }]*]
@db_buffer = internal unnamed_addr global [32 x %struct.ap_uint.3] zeroinitializer, align 64 ; [#uses=2 type=[32 x %struct.ap_uint.3]*]
...
define internal fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %db_item) nounwind uwtable {
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %db_item}, metadata !3066), !dbg !3067 ; [debug line = 20:28] [debug variable = db_item]
  %db_item.addr = getelementptr inbounds %struct.ap_uint.3* %db_item, i64 0, i32 0, i32 0, i32 0, !dbg !3068 ; [#uses=1 type=i512*] [debug line = 2925:9@24:15]
  %db_item.load = load i512* %db_item.addr, align 64, !dbg !3068 ; [#uses=2 type=i512] [debug line = 2925:9@24:15]
  br label %1, !dbg !3074                         ; [debug line = 23:6]

; <label>:1                                       ; preds = %2, %0
  %contacts_index = phi i32 [ 0, %0 ], [ %contacts_index.1, %2 ] ; [#uses=3 type=i32]
  %matched = phi i1 [ false, %0 ], [ %matched.1, %2 ] ; [#uses=2 type=i1]
  %exitcond = icmp eq i32 %contacts_index, 128, !dbg !3074 ; [#uses=1 type=i1] [debug line = 23:6]
  br i1 %exitcond, label %3, label %2, !dbg !3074 ; [debug line = 23:6]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %contacts_index to i64, !dbg !3070 ; [#uses=1 type=i64] [debug line = 24:15]
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp, i32 0, i32 0, i32 0, !dbg !3068 ; [#uses=1 type=i512*] [debug line = 2925:9@24:15]
  %contacts.load = load i512* %contacts.addr, align 64, !dbg !3068 ; [#uses=2 type=i512] [debug line = 2925:9@24:15]
  ...
  %tmp.1 = icmp eq i512 %contacts.load, %db_item.load, !dbg !3068 ; [#uses=1 type=i1] [debug line = 2925:9@24:15]
  %matched.1 = or i1 %matched, %tmp.1, !dbg !3070 ; [#uses=1 type=i1] [debug line = 24:15]
  call void @llvm.dbg.value(metadata !{i1 %matched.1}, i64 0, metadata !3075), !dbg !3070 ; [debug line = 24:15] [debug variable = matched]
  %contacts_index.1 = add nsw i32 %contacts_index, 1, !dbg !3076 ; [#uses=1 type=i32] [debug line = 23:46]
  call void @llvm.dbg.value(metadata !{i32 %contacts_index.1}, i64 0, metadata !3077), !dbg !3076 ; [debug line = 23:46] [debug variable = contacts_index]
  br label %1, !dbg !3076                         ; [debug line = 23:46]

; <label>:3                                       ; preds = %1
  %matched.0.lcssa = phi i1 [ %matched, %1 ]      ; [#uses=1 type=i1]
  ret i1 %matched.0.lcssa, !dbg !3078             ; [debug line = 26:2]
}
...
define void @contact_discovery(i32 %operation, %struct.ap_uint.3* byval align 64 %contact_in, %struct.ap_uint.3* %db_mem, i64 %offset, i32 %db_size_in, i32* %error_out, i32* %contacts_size_out, %"class.hls::stream.27"* %results_out) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %operation}, i64 0, metadata !3079), !dbg !3080 ; [debug line = 39:6] [debug variable = operation]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %contact_in}, metadata !3081), !dbg !3082 ; [debug line = 40:7] [debug variable = contact_in]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %db_mem}, i64 0, metadata !3083), !dbg !3084 ; [debug line = 41:7] [debug variable = db_mem]
  call void @llvm.dbg.value(metadata !{i64 %offset}, i64 0, metadata !3085), !dbg !3086 ; [debug line = 42:21] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %db_size_in}, i64 0, metadata !3087), !dbg !3088 ; [debug line = 43:15] [debug variable = db_size_in]
  call void @llvm.dbg.value(metadata !{i32* %error_out}, i64 0, metadata !3089), !dbg !3090 ; [debug line = 44:7] [debug variable = error_out]
  call void @llvm.dbg.value(metadata !{i32* %contacts_size_out}, i64 0, metadata !3091), !dbg !3092 ; [debug line = 45:7] [debug variable = contacts_size_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3093), !dbg !3094 ; [debug line = 46:30] [debug variable = results_out]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_uint.3* %db_mem, i32 8388608) nounwind, !dbg !3095 ; [debug line = 47:3]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3097 ; [debug line = 48:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3098 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %db_mem, i8* getelementptr inbounds ([6 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 536870912, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 16, i32 16, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3099 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.27"* %results_out, i8* getelementptr inbounds ([5 x i8]* @.str6, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3100 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3101 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3102 ; [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([7 x i8]* @.str8, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3103 ; [debug line = 56:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3104 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3105 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3106 ; [debug line = 59:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3107 ; [debug line = 60:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3108 ; [debug line = 61:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3109 ; [debug line = 62:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %contact_in, i8* getelementptr inbounds ([10 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3110 ; [debug line = 63:1]
  switch i32 %operation, label %16 [
    i32 0, label %2
    i32 1, label %6
    i32 2, label %15
  ], !dbg !3111                                   ; [debug line = 68:2]

; <label>:2                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3112 ; [debug line = 71:4]
  %contacts_size.load.1 = load i32* @contacts_size, align 4, !dbg !3114 ; [#uses=1 type=i32] [debug line = 72:4]
  store i32 %contacts_size.load.1, i32* %contacts_size_out, align 4, !dbg !3114 ; [debug line = 72:4]
  %contacts_size.load.2 = load i32* @contacts_size, align 4, !dbg !3115 ; [#uses=3 type=i32] [debug line = 73:4]
  %tmp = icmp sgt i32 %contacts_size.load.2, 127, !dbg !3115 ; [#uses=1 type=i1] [debug line = 73:4]
  br i1 %tmp, label %3, label %4, !dbg !3115      ; [debug line = 73:4]

; <label>:3                                       ; preds = %2
  store i32 1, i32* %error_out, align 4, !dbg !3116 ; [debug line = 74:5]
  %contacts_size.load.4 = load i32* @contacts_size, align 4, !dbg !3118 ; [#uses=1 type=i32] [debug line = 75:5]
  br label %5, !dbg !3119                         ; [debug line = 76:4]

; <label>:4                                       ; preds = %2
  %tmp.5 = sext i32 %contacts_size.load.2 to i64, !dbg !3120 ; [#uses=1 type=i64] [debug line = 77:5]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %contact_in}, i64 0, metadata !3122), !dbg !3123 ; [debug line = 279:87@77:5] [debug variable = op2]
  %contact_in.addr = getelementptr inbounds %struct.ap_uint.3* %contact_in, i64 0, i32 0, i32 0, i32 0, !dbg !3124 ; [#uses=1 type=i512*] [debug line = 280:10@77:5]
  %contact_in.load = load i512* %contact_in.addr, align 64, !dbg !3124 ; [#uses=2 type=i512] [debug line = 280:10@77:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %contact_in.load) nounwind
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp.5, i32 0, i32 0, i32 0, !dbg !3124 ; [#uses=1 type=i512*] [debug line = 280:10@77:5]
  store i512 %contact_in.load, i512* %contacts.addr, align 64, !dbg !3124 ; [debug line = 280:10@77:5]
  %tmp.6 = add nsw i32 %contacts_size.load.2, 1, !dbg !3126 ; [#uses=2 type=i32] [debug line = 78:5]
  store i32 %tmp.6, i32* @contacts_size, align 4, !dbg !3126 ; [debug line = 78:5]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %storemerge = phi i32 [ %tmp.6, %4 ], [ %contacts_size.load.4, %3 ] ; [#uses=1 type=i32]
  store i32 %storemerge, i32* %contacts_size_out, align 4, !dbg !3118 ; [debug line = 75:5]
  br label %.loopexit, !dbg !3127                 ; [debug line = 81:4]

; <label>:6                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3128 ; [debug line = 84:4]
  %contacts_size.load.3 = load i32* @contacts_size, align 4, !dbg !3129 ; [#uses=1 type=i32] [debug line = 85:4]
  store i32 %contacts_size.load.3, i32* %contacts_size_out, align 4, !dbg !3129 ; [debug line = 85:4]
  %db_mem.addr = getelementptr %struct.ap_uint.3* %db_mem, i32 0, i32 0, !dbg !3130 ; [#uses=1 type=%struct.ap_int_base.2*] [debug line = 98:5]
  %tmp.4 = bitcast %struct.ap_int_base.2* %db_mem.addr to i8*, !dbg !3130 ; [#uses=1 type=i8*] [debug line = 98:5]
  %.addr = getelementptr inbounds %struct.ap_uint.3* %1, i64 0, i32 0, i32 0, i32 0, !dbg !3133 ; [#uses=1 type=i512*] [debug line = 102:27]
  %results_out.addr = getelementptr inbounds %"class.hls::stream.27"* %results_out, i64 0, i32 0, !dbg !3137 ; [#uses=1 type=i8*] [debug line = 146:9@111:7]
  br label %7, !dbg !3143                         ; [debug line = 88:8]

; <label>:7                                       ; preds = %14, %6
  %database_index = phi i32 [ 0, %6 ], [ %database_index.1, %14 ] ; [#uses=5 type=i32]
  %tmp.7 = icmp slt i32 %database_index, 76000, !dbg !3143 ; [#uses=1 type=i1] [debug line = 88:8]
  br i1 %tmp.7, label %8, label %.loopexit.loopexit, !dbg !3143 ; [debug line = 88:8]

; <label>:8                                       ; preds = %7
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3144 ; [#uses=1 type=i32] [debug line = 88:76]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3145 ; [debug line = 89:1]
  %tmp.8 = sext i32 %database_index to i64, !dbg !3130 ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.9 = add i64 %tmp.8, %offset, !dbg !3130    ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.10 = shl i64 %tmp.9, 6, !dbg !3130         ; [#uses=1 type=i64] [debug line = 98:5]
  %tmp.4.addr = getelementptr inbounds i8* %tmp.4, i64 %tmp.10, !dbg !3130 ; [#uses=1 type=i8*] [debug line = 98:5]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast ([32 x %struct.ap_uint.3]* @db_buffer to i8*), i8* %tmp.4.addr, i64 2048, i32 1, i1 false), !dbg !3130 ; [debug line = 98:5]
  br label %9, !dbg !3146                         ; [debug line = 99:9]

; <label>:9                                       ; preds = %._crit_edge, %8
  %i = phi i32 [ 0, %8 ], [ %i.2, %._crit_edge ]  ; [#uses=4 type=i32]
  %exitcond3 = icmp eq i32 %i, 32, !dbg !3146     ; [#uses=1 type=i1] [debug line = 99:9]
  br i1 %exitcond3, label %.preheader.preheader, label %10, !dbg !3146 ; [debug line = 99:9]

.preheader.preheader:                             ; preds = %9
  br label %.preheader, !dbg !3147                ; [debug line = 109:9]

; <label>:10                                      ; preds = %9
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !3148 ; [#uses=1 type=i32] [debug line = 99:25]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3149 ; [debug line = 100:1]
  %tmp.11 = add nsw i32 %i, %database_index, !dbg !3150 ; [#uses=1 type=i32] [debug line = 101:2]
  %tmp.12 = icmp slt i32 %tmp.11, 76000, !dbg !3150 ; [#uses=1 type=i1] [debug line = 101:2]
  br i1 %tmp.12, label %11, label %._crit_edge, !dbg !3150 ; [debug line = 101:2]

; <label>:11                                      ; preds = %10
  %tmp.13 = sext i32 %i to i64, !dbg !3133        ; [#uses=2 type=i64] [debug line = 102:27]
  %db_buffer.addr = getelementptr inbounds [32 x %struct.ap_uint.3]* @db_buffer, i64 0, i64 %tmp.13, i32 0, i32 0, i32 0, !dbg !3133 ; [#uses=1 type=i512*] [debug line = 102:27]
  %db_buffer.load = load i512* %db_buffer.addr, align 64, !dbg !3133 ; [#uses=2 type=i512] [debug line = 102:27]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %db_buffer.load) nounwind
  store i512 %db_buffer.load, i512* %.addr, align 64, !dbg !3133 ; [debug line = 102:27]
  %tmp.14 = call fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %1), !dbg !3133 ; [#uses=1 type=i1] [debug line = 102:27]
  %results_buffer.addr = getelementptr inbounds [32 x i1]* @results_buffer, i64 0, i64 %tmp.13, !dbg !3133 ; [#uses=1 type=i1*] [debug line = 102:27]
  store i1 %tmp.14, i1* %results_buffer.addr, align 1, !dbg !3133 ; [debug line = 102:27]
  br label %._crit_edge, !dbg !3151               ; [debug line = 105:6]

._crit_edge:                                      ; preds = %11, %10
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3152 ; [#uses=0 type=i32] [debug line = 108:5]
  %i.2 = add nsw i32 %i, 1, !dbg !3153            ; [#uses=1 type=i32] [debug line = 99:20]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !3154), !dbg !3153 ; [debug line = 99:20] [debug variable = i]
  br label %9, !dbg !3153                         ; [debug line = 99:20]

.preheader:                                       ; preds = %._crit_edge4, %.preheader.preheader
  %i.1 = phi i32 [ %i.3, %._crit_edge4 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %i.1, 32, !dbg !3147    ; [#uses=1 type=i1] [debug line = 109:9]
  br i1 %exitcond, label %14, label %12, !dbg !3147 ; [debug line = 109:9]

; <label>:12                                      ; preds = %.preheader
  %tmp.17 = add nsw i32 %i.1, %database_index, !dbg !3155 ; [#uses=1 type=i32] [debug line = 110:6]
  %tmp.18 = icmp slt i32 %tmp.17, 76000, !dbg !3155 ; [#uses=1 type=i1] [debug line = 110:6]
  br i1 %tmp.18, label %13, label %._crit_edge4, !dbg !3155 ; [debug line = 110:6]

; <label>:13                                      ; preds = %12
  %tmp.19 = sext i32 %i.1 to i64, !dbg !3139      ; [#uses=1 type=i64] [debug line = 111:7]
  %results_buffer.addr.1 = getelementptr inbounds [32 x i1]* @results_buffer, i64 0, i64 %tmp.19, !dbg !3139 ; [#uses=1 type=i1*] [debug line = 111:7]
  %results_buffer.load = load i1* %results_buffer.addr.1, align 1, !dbg !3139 ; [#uses=2 type=i1] [debug line = 111:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %results_buffer.load) nounwind
  %tmp.21 = zext i1 %results_buffer.load to i8, !dbg !3139 ; [#uses=1 type=i8] [debug line = 111:7]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3156), !dbg !3158 ; [debug line = 144:48@111:7] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.20}, metadata !3159) nounwind, !dbg !3160 ; [debug line = 145:22@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.21}, i64 0, metadata !3159), !dbg !3161 ; [debug line = 145:31@111:7] [debug variable = tmp]
  store i8 %tmp.21, i8* %tmp.20, align 1, !dbg !3161 ; [debug line = 145:31@111:7]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %results_out.addr, i8* %tmp.20) nounwind, !dbg !3137 ; [debug line = 146:9@111:7]
  br label %._crit_edge4, !dbg !3162              ; [debug line = 112:6]

._crit_edge4:                                     ; preds = %13, %12
  %i.3 = add nsw i32 %i.1, 1, !dbg !3163          ; [#uses=1 type=i32] [debug line = 109:20]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !3154), !dbg !3163 ; [debug line = 109:20] [debug variable = i]
  br label %.preheader, !dbg !3163                ; [debug line = 109:20]

; <label>:14                                      ; preds = %.preheader
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !3164 ; [#uses=0 type=i32] [debug line = 114:4]
  %database_index.1 = add nsw i32 %database_index, 32, !dbg !3165 ; [#uses=1 type=i32] [debug line = 88:56]
  call void @llvm.dbg.value(metadata !{i32 %database_index.1}, i64 0, metadata !3166), !dbg !3165 ; [debug line = 88:56] [debug variable = database_index]
  br label %7, !dbg !3165                         ; [debug line = 88:56]

; <label>:15                                      ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3167 ; [debug line = 118:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !3168 ; [debug line = 119:4]
  store i32 0, i32* %contacts_size_out, align 4, !dbg !3169 ; [debug line = 120:4]
  br label %.loopexit, !dbg !3170                 ; [debug line = 121:4]

; <label>:16                                      ; preds = %0
  %contacts_size.load = load i32* @contacts_size, align 4, !dbg !3171 ; [#uses=1 type=i32] [debug line = 124:4]
  store i32 %contacts_size.load, i32* %contacts_size_out, align 4, !dbg !3171 ; [debug line = 124:4]
  store i32 3, i32* %error_out, align 4, !dbg !3172 ; [debug line = 125:4]
  br label %.loopexit, !dbg !3173                 ; [debug line = 126:4]

.loopexit.loopexit:                               ; preds = %7
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %16, %15, %5
  ret void, !dbg !3174                            ; [debug line = 128:1]
}
...
!llvm.dbg.cu = !{!0, !3}
!hls.encrypted.func = !{}
!opencl.kernels = !{!3039, !3046, !3052, !3055, !3058, !3060, !3060, !3060, !3060}
...
!1379 = metadata !{i32 786484, i32 0, null, metadata !"contacts", metadata !"contacts", metadata !"_ZL8contacts", metadata !903, i32 12, metadata !1380, i32 1, i32 1, [128 x %struct.ap_uint.3]* @contacts} ; [ DW_TAG_variable ]
...
!1383 = metadata !{i32 786484, i32 0, null, metadata !"db_buffer", metadata !"db_buffer", metadata !"_ZL9db_buffer", metadata !903, i32 13, metadata !1384, i32 1, i32 1, [32 x %struct.ap_uint.3]* @db_buffer} ; [ DW_TAG_variable ]
...
!1392 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1393, i32 26, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1394 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1393, i32 30, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1395 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1396, i32 168, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1400 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1398, i32 76, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1401 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1398, i32 111, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1403 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1398, i32 117, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1404 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1398, i32 120, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1405 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1406, i32 283, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1407 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1406, i32 297, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1408 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1406, i32 403, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1409 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !1410, i32 57, metadata !216, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1411 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1410, i32 71, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1412 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1410, i32 76, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1413 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1410, i32 80, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1419 = metadata !{i32 786484, i32 0, metadata !118, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !120, i32 307, metadata !1420, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1422 = metadata !{i32 786484, i32 0, metadata !131, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !120, i32 353, metadata !1420, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1423 = metadata !{i32 786484, i32 0, metadata !254, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !120, i32 456, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1424 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !120, i32 634, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1425 = metadata !{i32 786484, i32 0, metadata !1370, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !8, i32 542, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1426 = metadata !{i32 786484, i32 0, metadata !1370, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !8, i32 543, metadata !241, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1427 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1428, i32 613, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1531 = metadata !{i32 786484, i32 0, metadata !1446, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1428, i32 696, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1532 = metadata !{i32 786484, i32 0, metadata !1533, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1428, i32 1198, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1663 = metadata !{i32 786484, i32 0, metadata !1664, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1428, i32 1543, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1670 = metadata !{i32 786484, i32 0, metadata !1664, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1428, i32 1547, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1671 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1428, i32 1657, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1672 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1428, i32 1926, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1673 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1428, i32 2264, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3036 = metadata !{i32 786484, i32 0, null, metadata !"results_buffer", metadata !"results_buffer", metadata !"_ZL14results_buffer", metadata !903, i32 14, metadata !3037, i32 1, i32 1, [32 x i1]* @results_buffer} ; [ DW_TAG_variable ]
...
!3038 = metadata !{i32 786484, i32 0, null, metadata !"contacts_size", metadata !"contacts_size", metadata !"_ZL13contacts_size", metadata !903, i32 15, metadata !59, i32 1, i32 1, i32* @contacts_size} ; [ DW_TAG_variable ]
!3039 = metadata !{i1 (%struct.ap_uint.3*)* @match_db_contact, metadata !3040, metadata !3041, metadata !3042, metadata !3043, metadata !3044, metadata !3045}
...
!3046 = metadata !{void (i32, %struct.ap_uint.3*, %struct.ap_uint.3*, i64, i32, i32*, i32*, %"class.hls::stream.27"*)* @contact_discovery, metadata !3047, metadata !3048, metadata !3049, metadata !3050, metadata !3051, metadata !3045}
...
!3052 = metadata !{null, metadata !3040, metadata !3041, metadata !3053, metadata !3043, metadata !3054, metadata !3045}
!3053 = metadata !{metadata !"kernel_arg_type", metadata !"const uchar &"}
!3054 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!3055 = metadata !{null, metadata !3040, metadata !3041, metadata !3056, metadata !3043, metadata !3057, metadata !3045}
!3056 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<512> &"}
!3057 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3058 = metadata !{null, metadata !3040, metadata !3041, metadata !3059, metadata !3043, metadata !3057, metadata !3045}
!3059 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<512, false> &"}
!3060 = metadata !{null, metadata !3061, metadata !3062, metadata !3063, metadata !3064, metadata !3065, metadata !3045}
...
!3066 = metadata !{i32 786689, metadata !902, metadata !"db_item", metadata !903, i32 16777236, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3067 = metadata !{i32 20, i32 28, metadata !902, null}
!3068 = metadata !{i32 2925, i32 9, metadata !3069, metadata !3070}
!3069 = metadata !{i32 786443, metadata !1310, i32 2924, i32 107, metadata !894, i32 17} ; [ DW_TAG_lexical_block ]
!3070 = metadata !{i32 24, i32 15, metadata !3071, null}
!3071 = metadata !{i32 786443, metadata !3072, i32 23, i32 63, metadata !903, i32 2} ; [ DW_TAG_lexical_block ]
!3072 = metadata !{i32 786443, metadata !3073, i32 23, i32 2, metadata !903, i32 1} ; [ DW_TAG_lexical_block ]
!3073 = metadata !{i32 786443, metadata !902, i32 20, i32 36, metadata !903, i32 0} ; [ DW_TAG_lexical_block ]
!3074 = metadata !{i32 23, i32 6, metadata !3072, null}
!3075 = metadata !{i32 786688, metadata !3073, metadata !"matched", metadata !903, i32 22, metadata !241, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3076 = metadata !{i32 23, i32 46, metadata !3072, null}
!3077 = metadata !{i32 786688, metadata !3073, metadata !"contacts_index", metadata !903, i32 21, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3078 = metadata !{i32 26, i32 2, metadata !3073, null}
!3079 = metadata !{i32 786689, metadata !1252, metadata !"operation", metadata !903, i32 16777255, metadata !59, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3080 = metadata !{i32 39, i32 6, metadata !1252, null}
!3081 = metadata !{i32 786689, metadata !1252, metadata !"contact_in", metadata !903, i32 33554472, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3082 = metadata !{i32 40, i32 7, metadata !1252, null}
!3083 = metadata !{i32 786689, metadata !1252, metadata !"db_mem", metadata !903, i32 50331689, metadata !1255, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3084 = metadata !{i32 41, i32 7, metadata !1252, null}
!3085 = metadata !{i32 786689, metadata !1252, metadata !"offset", metadata !903, i32 67108906, metadata !984, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3086 = metadata !{i32 42, i32 21, metadata !1252, null}
!3087 = metadata !{i32 786689, metadata !1252, metadata !"db_size_in", metadata !903, i32 83886123, metadata !968, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3088 = metadata !{i32 43, i32 15, metadata !1252, null}
!3089 = metadata !{i32 786689, metadata !1252, metadata !"error_out", metadata !903, i32 100663340, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3090 = metadata !{i32 44, i32 7, metadata !1252, null}
!3091 = metadata !{i32 786689, metadata !1252, metadata !"contacts_size_out", metadata !903, i32 117440557, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3092 = metadata !{i32 45, i32 7, metadata !1252, null}
!3093 = metadata !{i32 786689, metadata !1252, metadata !"results_out", metadata !903, i32 134217774, metadata !1257, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3094 = metadata !{i32 46, i32 30, metadata !1252, null}
!3095 = metadata !{i32 47, i32 3, metadata !3096, null}
!3096 = metadata !{i32 786443, metadata !1252, i32 47, i32 2, metadata !903, i32 3} ; [ DW_TAG_lexical_block ]
!3097 = metadata !{i32 48, i32 1, metadata !3096, null}
!3098 = metadata !{i32 49, i32 1, metadata !3096, null}
!3099 = metadata !{i32 50, i32 1, metadata !3096, null}
!3100 = metadata !{i32 51, i32 1, metadata !3096, null}
!3101 = metadata !{i32 53, i32 1, metadata !3096, null}
!3102 = metadata !{i32 54, i32 1, metadata !3096, null}
!3103 = metadata !{i32 56, i32 1, metadata !3096, null}
!3104 = metadata !{i32 57, i32 1, metadata !3096, null}
!3105 = metadata !{i32 58, i32 1, metadata !3096, null}
!3106 = metadata !{i32 59, i32 1, metadata !3096, null}
!3107 = metadata !{i32 60, i32 1, metadata !3096, null}
!3108 = metadata !{i32 61, i32 1, metadata !3096, null}
!3109 = metadata !{i32 62, i32 1, metadata !3096, null}
!3110 = metadata !{i32 63, i32 1, metadata !3096, null}
!3111 = metadata !{i32 68, i32 2, metadata !3096, null}
!3112 = metadata !{i32 71, i32 4, metadata !3113, null}
!3113 = metadata !{i32 786443, metadata !3096, i32 68, i32 19, metadata !903, i32 4} ; [ DW_TAG_lexical_block ]
!3114 = metadata !{i32 72, i32 4, metadata !3113, null}
!3115 = metadata !{i32 73, i32 4, metadata !3113, null}
!3116 = metadata !{i32 74, i32 5, metadata !3117, null}
!3117 = metadata !{i32 786443, metadata !3113, i32 73, i32 28, metadata !903, i32 5} ; [ DW_TAG_lexical_block ]
!3118 = metadata !{i32 75, i32 5, metadata !3117, null}
!3119 = metadata !{i32 76, i32 4, metadata !3117, null}
!3120 = metadata !{i32 77, i32 5, metadata !3121, null}
!3121 = metadata !{i32 786443, metadata !3113, i32 76, i32 10, metadata !903, i32 6} ; [ DW_TAG_lexical_block ]
!3122 = metadata !{i32 786689, metadata !1309, metadata !"op2", metadata !908, i32 33554711, metadata !1237, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3123 = metadata !{i32 279, i32 87, metadata !1309, metadata !3120}
!3124 = metadata !{i32 280, i32 10, metadata !3125, metadata !3120}
!3125 = metadata !{i32 786443, metadata !1309, i32 279, i32 92, metadata !908, i32 16} ; [ DW_TAG_lexical_block ]
!3126 = metadata !{i32 78, i32 5, metadata !3121, null}
!3127 = metadata !{i32 81, i32 4, metadata !3113, null}
!3128 = metadata !{i32 84, i32 4, metadata !3113, null}
!3129 = metadata !{i32 85, i32 4, metadata !3113, null}
!3130 = metadata !{i32 98, i32 5, metadata !3131, null}
!3131 = metadata !{i32 786443, metadata !3132, i32 88, i32 75, metadata !903, i32 8} ; [ DW_TAG_lexical_block ]
!3132 = metadata !{i32 786443, metadata !3113, i32 88, i32 4, metadata !903, i32 7} ; [ DW_TAG_lexical_block ]
!3133 = metadata !{i32 102, i32 27, metadata !3134, null}
!3134 = metadata !{i32 786443, metadata !3135, i32 101, i32 36, metadata !903, i32 11} ; [ DW_TAG_lexical_block ]
!3135 = metadata !{i32 786443, metadata !3136, i32 99, i32 24, metadata !903, i32 10} ; [ DW_TAG_lexical_block ]
!3136 = metadata !{i32 786443, metadata !3131, i32 99, i32 5, metadata !903, i32 9} ; [ DW_TAG_lexical_block ]
!3137 = metadata !{i32 146, i32 9, metadata !3138, metadata !3139}
!3138 = metadata !{i32 786443, metadata !1308, i32 144, i32 79, metadata !1260, i32 15} ; [ DW_TAG_lexical_block ]
!3139 = metadata !{i32 111, i32 7, metadata !3140, null}
!3140 = metadata !{i32 786443, metadata !3141, i32 110, i32 40, metadata !903, i32 14} ; [ DW_TAG_lexical_block ]
!3141 = metadata !{i32 786443, metadata !3142, i32 109, i32 24, metadata !903, i32 13} ; [ DW_TAG_lexical_block ]
!3142 = metadata !{i32 786443, metadata !3131, i32 109, i32 5, metadata !903, i32 12} ; [ DW_TAG_lexical_block ]
!3143 = metadata !{i32 88, i32 8, metadata !3132, null}
!3144 = metadata !{i32 88, i32 76, metadata !3131, null}
!3145 = metadata !{i32 89, i32 1, metadata !3131, null}
!3146 = metadata !{i32 99, i32 9, metadata !3136, null}
!3147 = metadata !{i32 109, i32 9, metadata !3142, null}
!3148 = metadata !{i32 99, i32 25, metadata !3135, null}
!3149 = metadata !{i32 100, i32 1, metadata !3135, null}
!3150 = metadata !{i32 101, i32 2, metadata !3135, null}
!3151 = metadata !{i32 105, i32 6, metadata !3134, null}
!3152 = metadata !{i32 108, i32 5, metadata !3135, null}
!3153 = metadata !{i32 99, i32 20, metadata !3136, null}
!3154 = metadata !{i32 786688, metadata !3096, metadata !"i", metadata !903, i32 64, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3155 = metadata !{i32 110, i32 6, metadata !3141, null}
!3156 = metadata !{i32 786689, metadata !1308, metadata !"this", metadata !1260, i32 16777360, metadata !3157, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3157 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1258} ; [ DW_TAG_pointer_type ]
!3158 = metadata !{i32 144, i32 48, metadata !1308, metadata !3139}
!3159 = metadata !{i32 786688, metadata !3138, metadata !"tmp", metadata !1260, i32 145, metadata !954, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3160 = metadata !{i32 145, i32 22, metadata !3138, metadata !3139}
!3161 = metadata !{i32 145, i32 31, metadata !3138, metadata !3139}
!3162 = metadata !{i32 112, i32 6, metadata !3140, null}
!3163 = metadata !{i32 109, i32 20, metadata !3142, null}
!3164 = metadata !{i32 114, i32 4, metadata !3131, null}
!3165 = metadata !{i32 88, i32 56, metadata !3132, null}
!3166 = metadata !{i32 786688, metadata !3096, metadata !"database_index", metadata !903, i32 64, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3167 = metadata !{i32 118, i32 4, metadata !3113, null}
!3168 = metadata !{i32 119, i32 4, metadata !3113, null}
!3169 = metadata !{i32 120, i32 4, metadata !3113, null}
!3170 = metadata !{i32 121, i32 4, metadata !3113, null}
!3171 = metadata !{i32 124, i32 4, metadata !3113, null}
!3172 = metadata !{i32 125, i32 4, metadata !3113, null}
!3173 = metadata !{i32 126, i32 4, metadata !3113, null}
!3174 = metadata !{i32 128, i32 1, metadata !3096, null}
