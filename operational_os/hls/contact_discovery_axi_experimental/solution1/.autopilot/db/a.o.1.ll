...
define internal fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %db_item) nounwind uwtable {
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %db_item}, metadata !3060), !dbg !3061 ; [debug line = 16:28] [debug variable = db_item]
  %db_item.addr = getelementptr inbounds %struct.ap_uint.3* %db_item, i64 0, i32 0, i32 0, i32 0, !dbg !3062 ; [#uses=1 type=i512*] [debug line = 2925:9@20:15]
  %db_item.load = load i512* %db_item.addr, align 64, !dbg !3062 ; [#uses=2 type=i512] [debug line = 2925:9@20:15]
  br label %1, !dbg !3068                         ; [debug line = 19:6]

; <label>:1                                       ; preds = %2, %0
  %contacts_index = phi i32 [ 0, %0 ], [ %contacts_index.1, %2 ] ; [#uses=3 type=i32]
  %matched = phi i1 [ false, %0 ], [ %matched.1, %2 ] ; [#uses=2 type=i1]
  %exitcond = icmp eq i32 %contacts_index, 128, !dbg !3068 ; [#uses=1 type=i1] [debug line = 19:6]
  br i1 %exitcond, label %3, label %2, !dbg !3068 ; [debug line = 19:6]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %contacts_index to i64, !dbg !3064 ; [#uses=1 type=i64] [debug line = 20:15]
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp, i32 0, i32 0, i32 0, !dbg !3062 ; [#uses=1 type=i512*] [debug line = 2925:9@20:15]
  %contacts.load = load i512* %contacts.addr, align 64, !dbg !3062 ; [#uses=2 type=i512] [debug line = 2925:9@20:15]
  ...
  %tmp.1 = icmp eq i512 %contacts.load, %db_item.load, !dbg !3062 ; [#uses=1 type=i1] [debug line = 2925:9@20:15]
  %matched.1 = or i1 %matched, %tmp.1, !dbg !3064 ; [#uses=1 type=i1] [debug line = 20:15]
  call void @llvm.dbg.value(metadata !{i1 %matched.1}, i64 0, metadata !3069), !dbg !3064 ; [debug line = 20:15] [debug variable = matched]
  %contacts_index.1 = add nsw i32 %contacts_index, 1, !dbg !3070 ; [#uses=1 type=i32] [debug line = 19:46]
  call void @llvm.dbg.value(metadata !{i32 %contacts_index.1}, i64 0, metadata !3071), !dbg !3070 ; [debug line = 19:46] [debug variable = contacts_index]
  br label %1, !dbg !3070                         ; [debug line = 19:46]

; <label>:3                                       ; preds = %1
  %matched.0.lcssa = phi i1 [ %matched, %1 ]      ; [#uses=1 type=i1]
  ret i1 %matched.0.lcssa, !dbg !3072             ; [debug line = 22:2]
}
...
define void @contact_discovery(i32 %operation, %struct.ap_uint.3* byval align 64 %contact_in, %struct.ap_uint.3* %db_mem, i64 %offset, i32 %db_size_in, i32* %error_out, i32* %contacts_size_out, %"class.hls::stream.27"* %results_out, i64* %current_offset) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %operation}, i64 0, metadata !3073), !dbg !3074 ; [debug line = 35:6] [debug variable = operation]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %contact_in}, metadata !3075), !dbg !3076 ; [debug line = 36:7] [debug variable = contact_in]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %db_mem}, i64 0, metadata !3077), !dbg !3078 ; [debug line = 37:7] [debug variable = db_mem]
  call void @llvm.dbg.value(metadata !{i64 %offset}, i64 0, metadata !3079), !dbg !3080 ; [debug line = 38:21] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %db_size_in}, i64 0, metadata !3081), !dbg !3082 ; [debug line = 39:15] [debug variable = db_size_in]
  call void @llvm.dbg.value(metadata !{i32* %error_out}, i64 0, metadata !3083), !dbg !3084 ; [debug line = 40:7] [debug variable = error_out]
  call void @llvm.dbg.value(metadata !{i32* %contacts_size_out}, i64 0, metadata !3085), !dbg !3086 ; [debug line = 41:7] [debug variable = contacts_size_out]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3087), !dbg !3088 ; [debug line = 42:30] [debug variable = results_out]
  call void @llvm.dbg.value(metadata !{i64* %current_offset}, i64 0, metadata !3089), !dbg !3090 ; [debug line = 43:22] [debug variable = current_offset]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_uint.3* %db_mem, i32 8388608) nounwind, !dbg !3091 ; [debug line = 44:3]
  call void (...)* @_ssdm_op_SpecInterface(i64* %current_offset, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3093 ; [debug line = 45:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3095 ; [debug line = 47:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3096 ; [debug line = 48:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %db_mem, i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 536870912, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 16, i32 16, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3097 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.27"* %results_out, i8* getelementptr inbounds ([5 x i8]* @.str5, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3098 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3099 ; [debug line = 52:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3100 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3101 ; [debug line = 55:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3102 ; [debug line = 56:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3103 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3104 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3105 ; [debug line = 59:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3107 ; [debug line = 61:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %contact_in, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3108 ; [debug line = 62:1]
  switch i32 %operation, label %11 [
    i32 0, label %2
    i32 1, label %6
    i32 2, label %10
  ], !dbg !3109                                   ; [debug line = 66:2]

; <label>:2                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3110 ; [debug line = 69:4]
  %contacts_size.load.1 = load i32* @contacts_size, align 4, !dbg !3112 ; [#uses=1 type=i32] [debug line = 70:4]
  store i32 %contacts_size.load.1, i32* %contacts_size_out, align 4, !dbg !3112 ; [debug line = 70:4]
  %contacts_size.load.2 = load i32* @contacts_size, align 4, !dbg !3113 ; [#uses=3 type=i32] [debug line = 71:4]
  %tmp = icmp sgt i32 %contacts_size.load.2, 127, !dbg !3113 ; [#uses=1 type=i1] [debug line = 71:4]
  br i1 %tmp, label %3, label %4, !dbg !3113      ; [debug line = 71:4]

; <label>:3                                       ; preds = %2
  store i32 1, i32* %error_out, align 4, !dbg !3114 ; [debug line = 72:5]
  %contacts_size.load.4 = load i32* @contacts_size, align 4, !dbg !3116 ; [#uses=1 type=i32] [debug line = 73:5]
  br label %5, !dbg !3117                         ; [debug line = 74:4]

; <label>:4                                       ; preds = %2
  %tmp.4 = sext i32 %contacts_size.load.2 to i64, !dbg !3118 ; [#uses=1 type=i64] [debug line = 75:5]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %contact_in}, i64 0, metadata !3120), !dbg !3121 ; [debug line = 279:87@75:5] [debug variable = op2]
  %contact_in.addr = getelementptr inbounds %struct.ap_uint.3* %contact_in, i64 0, i32 0, i32 0, i32 0, !dbg !3122 ; [#uses=1 type=i512*] [debug line = 280:10@75:5]
  %contact_in.load = load i512* %contact_in.addr, align 64, !dbg !3122 ; [#uses=2 type=i512] [debug line = 280:10@75:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %contact_in.load) nounwind
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp.4, i32 0, i32 0, i32 0, !dbg !3122 ; [#uses=1 type=i512*] [debug line = 280:10@75:5]
  store i512 %contact_in.load, i512* %contacts.addr, align 64, !dbg !3122 ; [debug line = 280:10@75:5]
  %tmp.5 = add nsw i32 %contacts_size.load.2, 1, !dbg !3124 ; [#uses=2 type=i32] [debug line = 76:5]
  store i32 %tmp.5, i32* @contacts_size, align 4, !dbg !3124 ; [debug line = 76:5]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %storemerge = phi i32 [ %tmp.5, %4 ], [ %contacts_size.load.4, %3 ] ; [#uses=1 type=i32]
  store i32 %storemerge, i32* %contacts_size_out, align 4, !dbg !3116 ; [debug line = 73:5]
  br label %.loopexit3, !dbg !3125                ; [debug line = 79:4]

; <label>:6                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3126 ; [debug line = 82:4]
  %contacts_size.load.3 = load i32* @contacts_size, align 4, !dbg !3127 ; [#uses=1 type=i32] [debug line = 83:4]
  store i32 %contacts_size.load.3, i32* %contacts_size_out, align 4, !dbg !3127 ; [debug line = 83:4]
  %.addr = getelementptr inbounds %struct.ap_uint.3* %1, i64 0, i32 0, i32 0, i32 0, !dbg !3128 ; [#uses=1 type=i512*] [debug line = 99:40]
  %results_out.addr = getelementptr inbounds %"class.hls::stream.27"* %results_out, i64 0, i32 0, !dbg !3133 ; [#uses=1 type=i8*] [debug line = 146:9@99:40]
  br label %7, !dbg !3135                         ; [debug line = 84:8]

; <label>:7                                       ; preds = %.loopexit, %6
  %database_index = phi i32 [ 0, %6 ], [ %database_index.1, %.loopexit ] ; [#uses=4 type=i32]
  %tmp.6 = icmp ult i32 %database_index, %db_size_in, !dbg !3135 ; [#uses=1 type=i1] [debug line = 84:8]
  br i1 %tmp.6, label %.preheader.preheader, label %.loopexit3.loopexit, !dbg !3135 ; [debug line = 84:8]

.preheader.preheader:                             ; preds = %7
  %tmp.7 = sext i32 %database_index to i64, !dbg !3128 ; [#uses=1 type=i64] [debug line = 99:40]
  %tmp.8 = add i64 %tmp.7, %offset, !dbg !3128    ; [#uses=2 type=i64] [debug line = 99:40]
  br label %.preheader, !dbg !3136                ; [debug line = 94:9]

.preheader:                                       ; preds = %9, %.preheader.preheader
  %i = phi i32 [ %i.1, %9 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i32]
  %tmp.9 = icmp slt i32 %i, 32, !dbg !3136        ; [#uses=1 type=i1] [debug line = 94:9]
  br i1 %tmp.9, label %8, label %.loopexit, !dbg !3136 ; [debug line = 94:9]

; <label>:8                                       ; preds = %.preheader
  %tmp.10 = add nsw i32 %i, %database_index, !dbg !3137 ; [#uses=1 type=i32] [debug line = 95:6]
  %tmp.11 = icmp ult i32 %tmp.10, %db_size_in, !dbg !3137 ; [#uses=1 type=i1] [debug line = 95:6]
  br i1 %tmp.11, label %9, label %.loopexit, !dbg !3137 ; [debug line = 95:6]

; <label>:9                                       ; preds = %8
  %tmp.13 = sext i32 %i to i64, !dbg !3128        ; [#uses=1 type=i64] [debug line = 99:40]
  %tmp.14 = add i64 %tmp.13, %tmp.8, !dbg !3128   ; [#uses=1 type=i64] [debug line = 99:40]
  %db_mem.addr = getelementptr inbounds %struct.ap_uint.3* %db_mem, i64 %tmp.14, i32 0, i32 0, i32 0, !dbg !3128 ; [#uses=1 type=i512*] [debug line = 99:40]
  %db_mem.load = load i512* %db_mem.addr, align 8, !dbg !3128 ; [#uses=2 type=i512] [debug line = 99:40]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %db_mem.load) nounwind
  store i512 %db_mem.load, i512* %.addr, align 64, !dbg !3128 ; [debug line = 99:40]
  %tmp.15 = call fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %1), !dbg !3128 ; [#uses=1 type=i1] [debug line = 99:40]
  %tmp.17 = zext i1 %tmp.15 to i8, !dbg !3128     ; [#uses=1 type=i8] [debug line = 99:40]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.27"* %results_out}, i64 0, metadata !3138), !dbg !3140 ; [debug line = 144:48@99:40] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.16}, metadata !3141) nounwind, !dbg !3142 ; [debug line = 145:22@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8 %tmp.17}, i64 0, metadata !3141), !dbg !3143 ; [debug line = 145:31@99:40] [debug variable = tmp]
  store i8 %tmp.17, i8* %tmp.16, align 1, !dbg !3143 ; [debug line = 145:31@99:40]
  call void @_ssdm_op_IfWrite.Stream.i8P.i8P(i8* %results_out.addr, i8* %tmp.16) nounwind, !dbg !3133 ; [debug line = 146:9@99:40]
  store i64 %tmp.8, i64* %current_offset, align 8, !dbg !3144 ; [debug line = 100:6]
  %i.1 = add nsw i32 %i, 1, !dbg !3145            ; [#uses=1 type=i32] [debug line = 94:20]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !3146), !dbg !3145 ; [debug line = 94:20] [debug variable = i]
  br label %.preheader, !dbg !3145                ; [debug line = 94:20]

.loopexit:                                        ; preds = %8, %.preheader
  %database_index.1 = add nsw i32 %database_index, 32, !dbg !3147 ; [#uses=1 type=i32] [debug line = 84:57]
  call void @llvm.dbg.value(metadata !{i32 %database_index.1}, i64 0, metadata !3148), !dbg !3147 ; [debug line = 84:57] [debug variable = database_index]
  br label %7, !dbg !3147                         ; [debug line = 84:57]

; <label>:10                                      ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3149 ; [debug line = 106:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !3150 ; [debug line = 107:4]
  store i32 0, i32* %contacts_size_out, align 4, !dbg !3151 ; [debug line = 108:4]
  br label %.loopexit3, !dbg !3152                ; [debug line = 109:4]

; <label>:11                                      ; preds = %0
  %contacts_size.load = load i32* @contacts_size, align 4, !dbg !3153 ; [#uses=1 type=i32] [debug line = 112:4]
  store i32 %contacts_size.load, i32* %contacts_size_out, align 4, !dbg !3153 ; [debug line = 112:4]
  store i32 3, i32* %error_out, align 4, !dbg !3154 ; [debug line = 113:4]
  br label %.loopexit3, !dbg !3155                ; [debug line = 114:4]

.loopexit3.loopexit:                              ; preds = %7
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %11, %10, %5
  ret void, !dbg !3156                            ; [debug line = 116:1]
}
...
!1380 = metadata !{i32 786484, i32 0, null, metadata !"contacts", metadata !"contacts", metadata !"_ZL8contacts", metadata !903, i32 10, metadata !1381, i32 1, i32 1, [128 x %struct.ap_uint.3]* @contacts} ; [ DW_TAG_variable ]
...
!1384 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !1385, i32 315, metadata !1386, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1387 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !1385, i32 316, metadata !1386, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1388 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !1385, i32 317, metadata !1386, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1389 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1390, i32 26, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1391 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1390, i32 30, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1392 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1393, i32 168, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1394 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1395, i32 73, metadata !1396, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1397 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1395, i32 76, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1398 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1395, i32 111, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1399 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1395, i32 114, metadata !1396, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1400 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1395, i32 117, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1401 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1395, i32 120, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1402 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1403, i32 283, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1404 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1403, i32 297, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1405 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1403, i32 403, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1406 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1407, i32 71, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1408 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1407, i32 76, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1409 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1407, i32 80, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1410 = metadata !{i32 786484, i32 0, metadata !1411, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1412, i32 70, metadata !1413, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1415 = metadata !{i32 786484, i32 0, metadata !118, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !120, i32 307, metadata !1416, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1418 = metadata !{i32 786484, i32 0, metadata !131, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !120, i32 353, metadata !1416, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1419 = metadata !{i32 786484, i32 0, metadata !254, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !120, i32 456, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1420 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !120, i32 634, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1421 = metadata !{i32 786484, i32 0, metadata !1371, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !8, i32 542, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1422 = metadata !{i32 786484, i32 0, metadata !1371, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !8, i32 543, metadata !241, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1423 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1424, i32 613, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1527 = metadata !{i32 786484, i32 0, metadata !1442, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1424, i32 696, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1528 = metadata !{i32 786484, i32 0, metadata !1529, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1424, i32 1198, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1659 = metadata !{i32 786484, i32 0, metadata !1660, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1424, i32 1543, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1666 = metadata !{i32 786484, i32 0, metadata !1660, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1424, i32 1547, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1667 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1424, i32 1657, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1668 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1424, i32 1926, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1669 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1424, i32 2264, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1670 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1370, i32 60, metadata !1671, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2351 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1370, i32 61, metadata !2352, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2353 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1370, i32 62, metadata !2352, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2354 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1370, i32 63, metadata !2352, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2355 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1370, i32 66, metadata !2356, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3028 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1370, i32 67, metadata !3029, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3030 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1370, i32 68, metadata !3029, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3031 = metadata !{i32 786484, i32 0, metadata !1369, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1370, i32 69, metadata !3029, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3032 = metadata !{i32 786484, i32 0, null, metadata !"contacts_size", metadata !"contacts_size", metadata !"_ZL13contacts_size", metadata !903, i32 11, metadata !59, i32 1, i32 1, i32* @contacts_size} ; [ DW_TAG_variable ]
...
!3060 = metadata !{i32 786689, metadata !902, metadata !"db_item", metadata !903, i32 16777232, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3061 = metadata !{i32 16, i32 28, metadata !902, null}
!3062 = metadata !{i32 2925, i32 9, metadata !3063, metadata !3064}
!3063 = metadata !{i32 786443, metadata !1311, i32 2924, i32 107, metadata !894, i32 14} ; [ DW_TAG_lexical_block ]
!3064 = metadata !{i32 20, i32 15, metadata !3065, null}
!3065 = metadata !{i32 786443, metadata !3066, i32 19, i32 63, metadata !903, i32 2} ; [ DW_TAG_lexical_block ]
!3066 = metadata !{i32 786443, metadata !3067, i32 19, i32 2, metadata !903, i32 1} ; [ DW_TAG_lexical_block ]
!3067 = metadata !{i32 786443, metadata !902, i32 16, i32 36, metadata !903, i32 0} ; [ DW_TAG_lexical_block ]
!3068 = metadata !{i32 19, i32 6, metadata !3066, null}
!3069 = metadata !{i32 786688, metadata !3067, metadata !"matched", metadata !903, i32 18, metadata !241, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3070 = metadata !{i32 19, i32 46, metadata !3066, null}
!3071 = metadata !{i32 786688, metadata !3067, metadata !"contacts_index", metadata !903, i32 17, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3072 = metadata !{i32 22, i32 2, metadata !3067, null}
!3073 = metadata !{i32 786689, metadata !1252, metadata !"operation", metadata !903, i32 16777251, metadata !59, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3074 = metadata !{i32 35, i32 6, metadata !1252, null}
!3075 = metadata !{i32 786689, metadata !1252, metadata !"contact_in", metadata !903, i32 33554468, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3076 = metadata !{i32 36, i32 7, metadata !1252, null}
!3077 = metadata !{i32 786689, metadata !1252, metadata !"db_mem", metadata !903, i32 50331685, metadata !1255, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3078 = metadata !{i32 37, i32 7, metadata !1252, null}
!3079 = metadata !{i32 786689, metadata !1252, metadata !"offset", metadata !903, i32 67108902, metadata !984, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3080 = metadata !{i32 38, i32 21, metadata !1252, null}
!3081 = metadata !{i32 786689, metadata !1252, metadata !"db_size_in", metadata !903, i32 83886119, metadata !968, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3082 = metadata !{i32 39, i32 15, metadata !1252, null}
!3083 = metadata !{i32 786689, metadata !1252, metadata !"error_out", metadata !903, i32 100663336, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3084 = metadata !{i32 40, i32 7, metadata !1252, null}
!3085 = metadata !{i32 786689, metadata !1252, metadata !"contacts_size_out", metadata !903, i32 117440553, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3086 = metadata !{i32 41, i32 7, metadata !1252, null}
!3087 = metadata !{i32 786689, metadata !1252, metadata !"results_out", metadata !903, i32 134217770, metadata !1257, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3088 = metadata !{i32 42, i32 30, metadata !1252, null}
!3089 = metadata !{i32 786689, metadata !1252, metadata !"current_offset", metadata !903, i32 150994987, metadata !1308, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3090 = metadata !{i32 43, i32 22, metadata !1252, null}
!3091 = metadata !{i32 44, i32 3, metadata !3092, null}
!3092 = metadata !{i32 786443, metadata !1252, i32 44, i32 2, metadata !903, i32 3} ; [ DW_TAG_lexical_block ]
!3093 = metadata !{i32 45, i32 1, metadata !3092, null}
!3094 = metadata !{i32 46, i32 1, metadata !3092, null}
!3095 = metadata !{i32 47, i32 1, metadata !3092, null}
!3096 = metadata !{i32 48, i32 1, metadata !3092, null}
!3097 = metadata !{i32 49, i32 1, metadata !3092, null}
!3098 = metadata !{i32 50, i32 1, metadata !3092, null}
!3099 = metadata !{i32 52, i32 1, metadata !3092, null}
!3100 = metadata !{i32 53, i32 1, metadata !3092, null}
!3101 = metadata !{i32 55, i32 1, metadata !3092, null}
!3102 = metadata !{i32 56, i32 1, metadata !3092, null}
!3103 = metadata !{i32 57, i32 1, metadata !3092, null}
!3104 = metadata !{i32 58, i32 1, metadata !3092, null}
!3105 = metadata !{i32 59, i32 1, metadata !3092, null}
!3106 = metadata !{i32 60, i32 1, metadata !3092, null}
!3107 = metadata !{i32 61, i32 1, metadata !3092, null}
!3108 = metadata !{i32 62, i32 1, metadata !3092, null}
!3109 = metadata !{i32 66, i32 2, metadata !3092, null}
!3110 = metadata !{i32 69, i32 4, metadata !3111, null}
!3111 = metadata !{i32 786443, metadata !3092, i32 66, i32 19, metadata !903, i32 4} ; [ DW_TAG_lexical_block ]
!3112 = metadata !{i32 70, i32 4, metadata !3111, null}
!3113 = metadata !{i32 71, i32 4, metadata !3111, null}
!3114 = metadata !{i32 72, i32 5, metadata !3115, null}
!3115 = metadata !{i32 786443, metadata !3111, i32 71, i32 28, metadata !903, i32 5} ; [ DW_TAG_lexical_block ]
!3116 = metadata !{i32 73, i32 5, metadata !3115, null}
!3117 = metadata !{i32 74, i32 4, metadata !3115, null}
!3118 = metadata !{i32 75, i32 5, metadata !3119, null}
!3119 = metadata !{i32 786443, metadata !3111, i32 74, i32 10, metadata !903, i32 6} ; [ DW_TAG_lexical_block ]
!3120 = metadata !{i32 786689, metadata !1310, metadata !"op2", metadata !908, i32 33554711, metadata !1237, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3121 = metadata !{i32 279, i32 87, metadata !1310, metadata !3118}
!3122 = metadata !{i32 280, i32 10, metadata !3123, metadata !3118}
!3123 = metadata !{i32 786443, metadata !1310, i32 279, i32 92, metadata !908, i32 13} ; [ DW_TAG_lexical_block ]
!3124 = metadata !{i32 76, i32 5, metadata !3119, null}
!3125 = metadata !{i32 79, i32 4, metadata !3111, null}
!3126 = metadata !{i32 82, i32 4, metadata !3111, null}
!3127 = metadata !{i32 83, i32 4, metadata !3111, null}
!3128 = metadata !{i32 99, i32 40, metadata !3129, null}
!3129 = metadata !{i32 786443, metadata !3130, i32 94, i32 24, metadata !903, i32 10} ; [ DW_TAG_lexical_block ]
!3130 = metadata !{i32 786443, metadata !3131, i32 94, i32 5, metadata !903, i32 9} ; [ DW_TAG_lexical_block ]
!3131 = metadata !{i32 786443, metadata !3132, i32 84, i32 76, metadata !903, i32 8} ; [ DW_TAG_lexical_block ]
!3132 = metadata !{i32 786443, metadata !3111, i32 84, i32 4, metadata !903, i32 7} ; [ DW_TAG_lexical_block ]
!3133 = metadata !{i32 146, i32 9, metadata !3134, metadata !3128}
!3134 = metadata !{i32 786443, metadata !1309, i32 144, i32 79, metadata !1260, i32 12} ; [ DW_TAG_lexical_block ]
!3135 = metadata !{i32 84, i32 8, metadata !3132, null}
!3136 = metadata !{i32 94, i32 9, metadata !3130, null}
!3137 = metadata !{i32 95, i32 6, metadata !3129, null}
!3138 = metadata !{i32 786689, metadata !1309, metadata !"this", metadata !1260, i32 16777360, metadata !3139, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3139 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1258} ; [ DW_TAG_pointer_type ]
!3140 = metadata !{i32 144, i32 48, metadata !1309, metadata !3128}
!3141 = metadata !{i32 786688, metadata !3134, metadata !"tmp", metadata !1260, i32 145, metadata !954, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3142 = metadata !{i32 145, i32 22, metadata !3134, metadata !3128}
!3143 = metadata !{i32 145, i32 31, metadata !3134, metadata !3128}
!3144 = metadata !{i32 100, i32 6, metadata !3129, null}
!3145 = metadata !{i32 94, i32 20, metadata !3130, null}
!3146 = metadata !{i32 786688, metadata !3092, metadata !"i", metadata !903, i32 63, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3147 = metadata !{i32 84, i32 57, metadata !3132, null}
!3148 = metadata !{i32 786688, metadata !3092, metadata !"database_index", metadata !903, i32 63, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3149 = metadata !{i32 106, i32 4, metadata !3111, null}
!3150 = metadata !{i32 107, i32 4, metadata !3111, null}
!3151 = metadata !{i32 108, i32 4, metadata !3111, null}
!3152 = metadata !{i32 109, i32 4, metadata !3111, null}
!3153 = metadata !{i32 112, i32 4, metadata !3111, null}
!3154 = metadata !{i32 113, i32 4, metadata !3111, null}
!3155 = metadata !{i32 114, i32 4, metadata !3111, null}
!3156 = metadata !{i32 116, i32 1, metadata !3092, null}
