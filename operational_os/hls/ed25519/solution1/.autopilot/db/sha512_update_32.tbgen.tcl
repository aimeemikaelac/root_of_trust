set moduleName sha512_update_32
...
set C_modelName {sha512_update_32}
...
set C_modelArgList {
	...
	{ in_r int 8 regular {array 32 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ in_r_address0 sc_out sc_lv 5 signal 4 } 
	{ in_r_ce0 sc_out sc_logic 1 signal 4 } 
	{ in_r_q0 sc_in sc_lv 8 signal 4 } 
	{ in_r_address1 sc_out sc_lv 5 signal 4 } 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "6"],
		...
		"Port" : [
			...
			{"Name" : "md_state", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_sha512_compress_32_1_fu_344", "Port" : "md_state"},
					{"ID" : "6", "SubInstance" : "grp_sha512_compress_128_fu_356", "Port" : "md_state"}]},
			{"Name" : "md_curlen", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "md_buf", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "in_r", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_sha512_compress_32_1_fu_344", "Port" : "buf_r"}]},
			{"Name" : "K", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_sha512_compress_32_1_fu_344", "Port" : "K"},
					{"ID" : "6", "SubInstance" : "grp_sha512_compress_128_fu_356", "Port" : "K"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.temp_buf_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_32_1_fu_344", "Parent" : "0", "Child" : ["3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "K", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_32_1_fu_344.K_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_32_1_fu_344.S_U", "Parent" : "2"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_32_1_fu_344.W_U", "Parent" : "2"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_128_fu_356", "Parent" : "0", "Child" : ["7", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "buf_r", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "K", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_128_fu_356.K_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_128_fu_356.S_U", "Parent" : "6"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha512_compress_128_fu_356.W_U", "Parent" : "6"}]}
...
set Spec2ImplPortList { 
	...
	in_r { ap_memory {  { in_r_address0 mem_address 1 5 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 8 }  { in_r_address1 mem_address 1 5 }  { in_r_ce1 mem_ce 1 1 }  { in_r_q1 mem_dout 0 8 } } }
}
