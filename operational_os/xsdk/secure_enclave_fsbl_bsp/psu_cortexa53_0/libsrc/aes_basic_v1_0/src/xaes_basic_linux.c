...
typedef struct {
    ...
    XAes_basic_uio_map maps[ MAX_UIO_MAPS ];
} XAes_basic_uio_info;

/***************** Variable Definitions **************************************/
static XAes_basic_uio_info uio_info;
...
static int uio_info_read_name(XAes_basic_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XAes_basic_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XAes_basic_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XAes_basic_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XAes_basic_Initialize(XAes_basic *InstancePtr, const char* InstanceName) {
	XAes_basic_uio_info *InfoPtr = &uio_info;
