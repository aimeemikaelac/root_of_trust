...
wire   [2:0] tmp_1729_fu_500_p1;
reg   [2:0] tmp_1729_reg_840;
...
wire   [2:0] tmp_1730_fu_505_p1;
reg   [2:0] tmp_1730_reg_950;
...
always @ (posedge ap_clk) begin
    if (((grp_fe_cmov_fu_336_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        tmp_1730_reg_950 <= tmp_1730_fu_505_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (grp_fe_cmov_fu_336_ap_done == 1'b1))) begin
        ...
        tmp_1729_reg_840 <= tmp_1729_fu_500_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        grp_fe_cmov_fu_336_u_xy2d_offset = tmp_1730_reg_950;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        grp_fe_cmov_fu_336_u_xy2d_offset = tmp_1729_reg_840;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
assign tmp_1729_fu_500_p1 = u_yminusx_offset[2:0];

assign tmp_1730_fu_505_p1 = u_xy2d_offset[2:0];
