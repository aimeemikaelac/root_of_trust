...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module aes_sboxes_0_rom (
...
initial begin
    $readmemh("./aes_sboxes_0_rom.dat", ram0);
    $readmemh("./aes_sboxes_0_rom.dat", ram1);
    $readmemh("./aes_sboxes_0_rom.dat", ram2);
    $readmemh("./aes_sboxes_0_rom.dat", ram3);
    $readmemh("./aes_sboxes_0_rom.dat", ram4);
end
...
aes_sboxes_0_rom aes_sboxes_0_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
