...
#ifndef __crypto_sign_mac_mpcA__HH__
#define __crypto_sign_mac_mpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_mac_mpcA) {
    ...
    SC_CTOR(crypto_sign_mac_mpcA):  simcore_mac_0_U ("simcore_mac_0_U") {
