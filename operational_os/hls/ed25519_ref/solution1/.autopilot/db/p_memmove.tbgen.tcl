...
set C_modelName {_memmove}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 8 regular {array 64 { 0 } 0 1 }  }
...
set portList { 
	...
	{ dst_address0 sc_out sc_lv 6 signal 0 } 
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 6 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 8 } } }
