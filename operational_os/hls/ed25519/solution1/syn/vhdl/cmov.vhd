...
architecture behav of cmov is 
    ...
    signal tmp_1728_fu_500_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1728_reg_840 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_1729_fu_505_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1729_reg_950 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    grp_fe_cmov_fu_336_u_xy2d_offset_assign_proc : process(tmp_reg_730, ap_CS_fsm_state2, tmp_1728_reg_840, ap_CS_fsm_state3, tmp_1729_reg_950, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    tmp_1728_fu_500_p1 <= u_yminusx_offset(3 - 1 downto 0);
    tmp_1729_fu_505_p1 <= u_xy2d_offset(3 - 1 downto 0);
