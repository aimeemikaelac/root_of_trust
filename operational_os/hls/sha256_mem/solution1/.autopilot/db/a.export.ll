...
@sha256_mem_str = internal unnamed_addr constant [11 x i8] c"sha256_mem\00"
...
define void @sha256_mem(i8* %mem, i32 %message_addr, i32 %num_blocks, [32 x i8]* %digest_out, i1* %digest_valid) {
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %mem), !map !38
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %message_addr) nounwind, !map !44
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %num_blocks) nounwind, !map !50
  call void (...)* @_ssdm_op_SpecBitsMap([32 x i8]* %digest_out) nounwind, !map !54
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %digest_valid) nounwind, !map !60
  ...
  %message_addr_read = call i32 @_ssdm_op_Read.ap_vld.i32(i32 %message_addr)
  %data_buffer = alloca [64 x i8], align 16
  %cipher_m_block = alloca [128 x i8], align 1
  %cipher_m_h = alloca [8 x i32], align 4
  call void (...)* @_ssdm_op_SpecInterface(i1* %digest_valid, [8 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %message_addr, [7 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32 %message_addr, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %num_blocks, [7 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32 %num_blocks, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
...
; <label>:1                                       ; preds = %5, %0
  %cipher_m_len = phi i32 [ 0, %0 ], [ %cipher_m_len_1, %5 ]
  %cipher_m_tot_len = phi i32 [ 0, %0 ], [ %cipher_m_tot_len_1, %5 ]
  %indvars_iv = phi i32 [ 64, %0 ], [ %indvars_iv_next, %5 ]
  %block_counter = phi i32 [ 0, %0 ], [ %block_counter_1, %5 ]
  %data_index = phi i32 [ 0, %0 ], [ %data_index_2, %5 ]
  %exitcond2 = icmp eq i32 %block_counter, %num_blocks_read
  %block_counter_1 = add nsw i32 %block_counter, 1
  br i1 %exitcond2, label %6, label %2

; <label>:2                                       ; preds = %1
  %data_index_2 = add i32 %data_index, 64
  br label %3

; <label>:3                                       ; preds = %4, %2
  %data_index_1 = phi i32 [ %data_index, %2 ], [ %tmp_3, %4 ]
  %buffer_index = phi i7 [ 0, %2 ], [ %buffer_index_1, %4 ]
  %exitcond = icmp eq i32 %data_index_1, %indvars_iv
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) nounwind
  %buffer_index_1 = add i7 %buffer_index, 1
  br i1 %exitcond, label %5, label %4

; <label>:4                                       ; preds = %3
  %tmp = add i32 %data_index_1, %message_addr_read
  %tmp_1 = zext i32 %tmp to i64
  %mem_addr = getelementptr i8* %mem, i64 %tmp_1
  %mem_load_req = call i1 @_ssdm_op_ReadReq.m_axi.i8P(i8* %mem_addr, i32 1)
  %mem_addr_read = call i8 @_ssdm_op_Read.m_axi.i8P(i8* %mem_addr)
  %tmp_2 = zext i7 %buffer_index to i64
  %data_buffer_addr = getelementptr inbounds [64 x i8]* %data_buffer, i64 0, i64 %tmp_2
  store i8 %mem_addr_read, i8* %data_buffer_addr, align 1
  %tmp_3 = add nsw i32 %data_index_1, 1
  br label %3

; <label>:5                                       ; preds = %3
  %call_ret = call fastcc { i32, i32 } @update(i32 %cipher_m_tot_len, i32 %cipher_m_len, [128 x i8]* %cipher_m_block, [8 x i32]* %cipher_m_h, [64 x i8]* %data_buffer) nounwind
  %cipher_m_tot_len_1 = extractvalue { i32, i32 } %call_ret, 0
  %cipher_m_len_1 = extractvalue { i32, i32 } %call_ret, 1
  %indvars_iv_next = add i32 %indvars_iv, 64
  br label %1

; <label>:6                                       ; preds = %1
  call fastcc void @final(i32 %cipher_m_tot_len, i32 %cipher_m_len, [128 x i8]* %cipher_m_block, [8 x i32]* %cipher_m_h, [32 x i8]* %digest_out) nounwind
  call void @_ssdm_op_Write.ap_none.i1P(i1* %digest_valid, i1 true)
  ret void
}
...
define internal fastcc void @final(i32 %SHA256_m_tot_len_read, i32 %SHA256_m_len_read, [128 x i8]* nocapture %SHA256_m_block, [8 x i32]* nocapture %SHA256_m_h, [32 x i8]* nocapture %digest) {
  ...
  %tmp_95 = trunc i32 %SHA256_m_len_read_2 to i29
  %tmp_99 = trunc i32 %SHA256_m_tot_len_rea to i29
  %tmp_100 = trunc i32 %SHA256_m_tot_len_rea to i13
  %tmp_101 = trunc i32 %SHA256_m_len_read_2 to i13
  %tmp_102 = trunc i32 %SHA256_m_tot_len_rea to i21
  %tmp_103 = trunc i32 %SHA256_m_len_read_2 to i21
  %tmp_84 = add i29 %tmp_95, %tmp_99
  %tmp_90_cast3 = add i21 %tmp_102, %tmp_103
  %tmp_90_cast = add i13 %tmp_100, %tmp_101
  %tmp_104 = trunc i32 %SHA256_m_len_read_2 to i5
  %tmp_105 = trunc i32 %SHA256_m_tot_len_rea to i5
  %pm_len_cast_cast = select i1 %tmp_s, i32 128, i32 64
  %tmp_85 = zext i32 %SHA256_m_len_read_2 to i64
  %tmp_106 = trunc i32 %SHA256_m_len_read_2 to i9
...
; <label>:2                                       ; preds = %1
  %tmp_107 = trunc i32 %i_i to i9
  %sum_i = add i9 %tmp_107, %tmp_106
...
; <label>:4                                       ; preds = %3
  ...
  %SHA256_m_h_load = load i32* %SHA256_m_h_addr, align 4
  %tmp_108 = trunc i32 %SHA256_m_h_load to i8
  %tmp_109 = trunc i4 %i to i3
  %tmp_92 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_109, i2 0)
  ...
  store i8 %tmp_108, i8* %digest_addr, align 1
  ...
  %tmp_96 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %SHA256_m_h_load, i32 16, i32 23)
  %p_sum4 = or i5 %tmp_92, 1
  %p_sum4_cast = zext i5 %p_sum4 to i64
  %digest_addr_2 = getelementptr [32 x i8]* %digest, i64 0, i64 %p_sum4_cast
  store i8 %tmp_96, i8* %digest_addr_2, align 1
  %tmp_97 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %SHA256_m_h_load, i32 24, i32 31)
  %digest_addr_3 = getelementptr [32 x i8]* %digest, i64 0, i64 %tmp_93
  store i8 %tmp_97, i8* %digest_addr_3, align 1
  br label %3
...
entry:
  ...
  %empty_25 = trunc i29 %empty to i8
  ret i8 %empty_25
}
...
entry:
  ...
  %empty_26 = trunc i21 %empty to i8
  ret i8 %empty_26
}
...
entry:
  ...
  %empty_27 = trunc i13 %empty to i8
  ret i8 %empty_27
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_28 = trunc i32 %empty to i7
  ret i7 %empty_28
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_30 = trunc i32 %empty to i29
  ret i29 %empty_30
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_31 = trunc i32 %empty to i26
  ret i26 %empty_31
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_32 = trunc i32 %empty to i25
  ret i25 %empty_32
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_33 = trunc i32 %empty to i22
  ret i22 %empty_33
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_34 = trunc i32 %empty to i21
  ret i21 %empty_34
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_36 = trunc i32 %empty to i19
  ret i19 %empty_36
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_37 = trunc i32 %empty to i15
  ret i15 %empty_37
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_38 = trunc i32 %empty to i14
  ret i14 %empty_38
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_39 = trunc i32 %empty to i13
  ret i13 %empty_39
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_40 = trunc i32 %empty to i10
  ret i10 %empty_40
}
...
entry:
  ...
  %empty_44 = zext i3 %1 to i8
  %empty_45 = shl i8 %empty, 3
...
entry:
  ...
  %empty_47 = zext i6 %1 to i8
  %empty_48 = shl i8 %empty, 6
  %empty_49 = or i8 %empty_48, %empty_47
  ret i8 %empty_49
}
...
entry:
  ...
  %empty_50 = zext i6 %1 to i7
  %empty_51 = shl i7 %empty, 6
  %empty_52 = or i7 %empty_51, %empty_50
  ret i7 %empty_52
}
...
entry:
  ...
  %empty_53 = zext i2 %2 to i6
  %empty_54 = shl i6 %empty, 2
  %empty_55 = or i6 %empty_54, %empty_53
  %empty_56 = zext i1 %0 to i7
  %empty_57 = zext i6 %empty_55 to i7
  %empty_58 = shl i7 %empty_56, 6
...
entry:
  ...
  %empty_60 = zext i2 %1 to i6
  %empty_61 = shl i6 %empty, 2
...
entry:
  ...
  %empty_63 = zext i1 %2 to i2
  %empty_64 = shl i2 %empty, 1
  %empty_65 = or i2 %empty_64, %empty_63
  %empty_66 = zext i4 %0 to i6
  %empty_67 = zext i2 %empty_65 to i6
  %empty_68 = shl i6 %empty_66, 2
...
entry:
  ...
  %empty_70 = zext i2 %1 to i5
  %empty_71 = shl i5 %empty, 2
...
entry:
  ...
  %empty_73 = zext i8 %3 to i16
  %empty_74 = shl i16 %empty, 8
  %empty_75 = or i16 %empty_74, %empty_73
  %empty_76 = zext i8 %1 to i24
  %empty_77 = zext i16 %empty_75 to i24
  %empty_78 = shl i24 %empty_76, 16
  %empty_79 = or i24 %empty_78, %empty_77
  %empty_80 = zext i8 %0 to i32
  %empty_81 = zext i24 %empty_79 to i32
  %empty_82 = shl i32 %empty_80, 24
...
entry:
  ...
  %empty_84 = zext i25 %1 to i32
  %empty_85 = shl i32 %empty, 25
...
entry:
  ...
  %empty_87 = zext i26 %1 to i32
  %empty_88 = shl i32 %empty, 26
  %empty_89 = or i32 %empty_88, %empty_87
  ret i32 %empty_89
}
...
entry:
  ...
  %empty_90 = zext i7 %1 to i32
  %empty_91 = shl i32 %empty, 7
...
entry:
  ...
  %empty_93 = zext i10 %1 to i32
  %empty_94 = shl i32 %empty, 10
  %empty_95 = or i32 %empty_94, %empty_93
  ret i32 %empty_95
}
...
entry:
  ...
  %empty_96 = zext i30 %1 to i32
  %empty_97 = shl i32 %empty, 30
  %empty_98 = or i32 %empty_97, %empty_96
  ret i32 %empty_98
}
...
entry:
  ...
  %empty_99 = zext i13 %1 to i32
  %empty_100 = shl i32 %empty, 13
  %empty_101 = or i32 %empty_100, %empty_99
  ret i32 %empty_101
}
...
entry:
  ...
  %empty_102 = zext i14 %1 to i32
  %empty_103 = shl i32 %empty, 14
...
entry:
  ...
  %empty_105 = zext i15 %1 to i32
  %empty_106 = shl i32 %empty, 15
...
entry:
  ...
  %empty_108 = zext i19 %1 to i32
  %empty_109 = shl i32 %empty, 19
...
entry:
  ...
  %empty_111 = zext i21 %1 to i32
  %empty_112 = shl i32 %empty, 21
...
!41 = metadata !{metadata !"mem", metadata !42, metadata !"unsigned char", i32 0, i32 7}
!42 = metadata !{metadata !43}
!43 = metadata !{i32 0, i32 131071, i32 1}
!44 = metadata !{metadata !45}
!45 = metadata !{i32 0, i32 31, metadata !46}
!46 = metadata !{metadata !47}
!47 = metadata !{metadata !"message_addr", metadata !48, metadata !"unsigned int", i32 0, i32 31}
!48 = metadata !{metadata !49}
!49 = metadata !{i32 0, i32 0, i32 0}
!50 = metadata !{metadata !51}
!51 = metadata !{i32 0, i32 31, metadata !52}
!52 = metadata !{metadata !53}
!53 = metadata !{metadata !"num_blocks", metadata !48, metadata !"unsigned int", i32 0, i32 31}
!54 = metadata !{metadata !55}
!55 = metadata !{i32 0, i32 7, metadata !56}
!56 = metadata !{metadata !57}
!57 = metadata !{metadata !"digest_out", metadata !58, metadata !"unsigned char", i32 0, i32 7}
!58 = metadata !{metadata !59}
!59 = metadata !{i32 0, i32 31, i32 1}
!60 = metadata !{metadata !61}
!61 = metadata !{i32 0, i32 0, metadata !62}
!62 = metadata !{metadata !63}
!63 = metadata !{metadata !"digest_valid", metadata !64, metadata !"bool", i32 0, i32 0}
