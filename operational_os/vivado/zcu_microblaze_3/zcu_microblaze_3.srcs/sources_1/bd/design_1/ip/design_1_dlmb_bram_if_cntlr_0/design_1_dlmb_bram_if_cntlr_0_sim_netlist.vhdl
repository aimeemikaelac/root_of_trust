...
-- Date        : Thu May  4 14:55:12 2017
-- Host        : SchoolComputer running 64-bit Ubuntu 16.10
-- Command     : write_vhdl -force -mode funcsim
--               /home/michael/hardware_security/zcu102/root_of_trust/operational_os/vivado/zcu_microblaze_3/zcu_microblaze_3.srcs/sources_1/bd/design_1/ip/design_1_dlmb_bram_if_cntlr_0/design_1_dlmb_bram_if_cntlr_0_sim_netlist.vhdl
...
entity design_1_dlmb_bram_if_cntlr_0_lmb_mux is
  port (
    ...
    lmb_as : in STD_LOGIC;
    Sl_Rdy : in STD_LOGIC;
    LMB_ABus : in STD_LOGIC_VECTOR ( 31 downto 0 );
    LMB_AddrStrobe : in STD_LOGIC;
    LMB_BE : in STD_LOGIC_VECTOR ( 0 to 3 );
    LMB_WriteStrobe : in STD_LOGIC;
    LMB1_ABus : in STD_LOGIC_VECTOR ( 31 downto 0 );
...
architecture STRUCTURE of design_1_dlmb_bram_if_cntlr_0_lmb_mux is
  ...
  signal \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \BRAM_WEN_A[0]_INST_0_i_3\ : label is "soft_lutpair0";
...
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
      ...
      I1 => LMB_AddrStrobe,
      I2 => LMB1_AddrStrobe,
      O => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\
    );
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q_reg[1][10]\: unisim.vcomponents.FDRE
     port map (
      C => LMB_Clk,
      CE => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\,
      D => LMB1_ABus(25),
...
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q_reg[1][32]\: unisim.vcomponents.FDRE
     port map (
      C => LMB_Clk,
      CE => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\,
      D => LMB1_ABus(3),
...
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q_reg[1][33]\: unisim.vcomponents.FDRE
     port map (
      C => LMB_Clk,
      CE => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\,
      D => LMB1_ABus(2),
...
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q_reg[1][34]\: unisim.vcomponents.FDRE
     port map (
      C => LMB_Clk,
      CE => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\,
      D => LMB1_ABus(1),
...
\more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q_reg[1][35]\: unisim.vcomponents.FDRE
     port map (
      C => LMB_Clk,
      CE => \more_than_one_lmb.lmb_mux_generate[1].LMB_ABus_vec_Q[1][4]_i_1_n_0\,
      D => LMB1_ABus(0),
...
entity design_1_dlmb_bram_if_cntlr_0_lmb_bram_if_cntlr is
  ...
  attribute C_LMB_AWIDTH of design_1_dlmb_bram_if_cntlr_0_lmb_bram_if_cntlr : entity is 36;
...
lmb_mux_I: entity work.design_1_dlmb_bram_if_cntlr_0_lmb_mux
     port map (
      ...
      LMB1_ABus(31) => LMB1_ABus(4),
      LMB1_ABus(30) => LMB1_ABus(5),
      LMB1_ABus(29) => LMB1_ABus(6),
      LMB1_ABus(28) => LMB1_ABus(7),
      LMB1_ABus(27) => LMB1_ABus(8),
      LMB1_ABus(26) => LMB1_ABus(9),
      LMB1_ABus(25) => LMB1_ABus(10),
      LMB1_ABus(24) => LMB1_ABus(11),
      LMB1_ABus(23) => LMB1_ABus(12),
      LMB1_ABus(22) => LMB1_ABus(13),
      LMB1_ABus(21) => LMB1_ABus(14),
      LMB1_ABus(20) => LMB1_ABus(15),
      LMB1_ABus(19) => LMB1_ABus(16),
      LMB1_ABus(18) => LMB1_ABus(17),
      LMB1_ABus(17) => LMB1_ABus(18),
      LMB1_ABus(16) => LMB1_ABus(19),
      LMB1_ABus(15) => LMB1_ABus(20),
      LMB1_ABus(14) => LMB1_ABus(21),
      LMB1_ABus(13) => LMB1_ABus(22),
      LMB1_ABus(12) => LMB1_ABus(23),
      LMB1_ABus(11) => LMB1_ABus(24),
      LMB1_ABus(10) => LMB1_ABus(25),
      LMB1_ABus(9) => LMB1_ABus(26),
      LMB1_ABus(8) => LMB1_ABus(27),
      LMB1_ABus(7) => LMB1_ABus(28),
      LMB1_ABus(6) => LMB1_ABus(29),
      LMB1_ABus(5) => LMB1_ABus(30),
      LMB1_ABus(4) => LMB1_ABus(31),
      LMB1_ABus(3) => LMB1_ABus(32),
      LMB1_ABus(2) => LMB1_ABus(33),
      LMB1_ABus(1) => LMB1_ABus(34),
      LMB1_ABus(0) => LMB1_ABus(35),
      LMB1_AddrStrobe => LMB1_AddrStrobe,
      LMB1_BE(0 to 3) => LMB1_BE(0 to 3),
      LMB1_WriteDBus(0 to 31) => LMB1_WriteDBus(0 to 31),
      LMB1_WriteStrobe => LMB1_WriteStrobe,
      LMB_ABus(31) => LMB_ABus(4),
      LMB_ABus(30) => LMB_ABus(5),
      LMB_ABus(29) => LMB_ABus(6),
      LMB_ABus(28) => LMB_ABus(7),
      LMB_ABus(27) => LMB_ABus(8),
      LMB_ABus(26) => LMB_ABus(9),
      LMB_ABus(25) => LMB_ABus(10),
      LMB_ABus(24) => LMB_ABus(11),
      LMB_ABus(23) => LMB_ABus(12),
      LMB_ABus(22) => LMB_ABus(13),
      LMB_ABus(21) => LMB_ABus(14),
      LMB_ABus(20) => LMB_ABus(15),
      LMB_ABus(19) => LMB_ABus(16),
      LMB_ABus(18) => LMB_ABus(17),
      LMB_ABus(17) => LMB_ABus(18),
      LMB_ABus(16) => LMB_ABus(19),
      LMB_ABus(15) => LMB_ABus(20),
      LMB_ABus(14) => LMB_ABus(21),
      LMB_ABus(13) => LMB_ABus(22),
      LMB_ABus(12) => LMB_ABus(23),
      LMB_ABus(11) => LMB_ABus(24),
      LMB_ABus(10) => LMB_ABus(25),
      LMB_ABus(9) => LMB_ABus(26),
      LMB_ABus(8) => LMB_ABus(27),
      LMB_ABus(7) => LMB_ABus(28),
      LMB_ABus(6) => LMB_ABus(29),
      LMB_ABus(5) => LMB_ABus(30),
      LMB_ABus(4) => LMB_ABus(31),
      LMB_ABus(3) => LMB_ABus(32),
      LMB_ABus(2) => LMB_ABus(33),
      LMB_ABus(1) => LMB_ABus(34),
      LMB_ABus(0) => LMB_ABus(35),
...
architecture STRUCTURE of design_1_dlmb_bram_if_cntlr_0 is
  ...
  attribute C_LMB_AWIDTH : integer;
  attribute C_LMB_AWIDTH of U0 : label is 36;
  attribute C_LMB_DWIDTH : integer;
...
U0: entity work.design_1_dlmb_bram_if_cntlr_0_lmb_bram_if_cntlr
     port map (
      ...
      LMB1_ABus(0 to 35) => LMB1_ABus(0 to 35),
      LMB1_AddrStrobe => LMB1_AddrStrobe,
      LMB1_BE(0 to 3) => LMB1_BE(0 to 3),
      LMB1_ReadStrobe => LMB1_ReadStrobe,
      LMB1_WriteDBus(0 to 31) => LMB1_WriteDBus(0 to 31),
      LMB1_WriteStrobe => LMB1_WriteStrobe,
      LMB2_ABus(0 to 35) => B"000000000000000000000000000000000000",
      LMB2_AddrStrobe => '0',
      LMB2_BE(0 to 3) => B"0000",
      LMB2_ReadStrobe => '0',
      LMB2_WriteDBus(0 to 31) => B"00000000000000000000000000000000",
      LMB2_WriteStrobe => '0',
      LMB3_ABus(0 to 35) => B"000000000000000000000000000000000000",
      LMB3_AddrStrobe => '0',
      LMB3_BE(0 to 3) => B"0000",
      LMB3_ReadStrobe => '0',
      LMB3_WriteDBus(0 to 31) => B"00000000000000000000000000000000",
      LMB3_WriteStrobe => '0',
      LMB_ABus(0 to 35) => LMB_ABus(0 to 35),
      LMB_AddrStrobe => LMB_AddrStrobe,
      LMB_BE(0 to 3) => LMB_BE(0 to 3),
      LMB_Clk => LMB_Clk,
