...
set ID 21
set MemName sha256_data_buffer
...
# Memory (RAM/ROM)  definition:
set ID 22
set MemName sha256_cipher_m_bdEe
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 128
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_V_TDATA { I 8 vector } stream_in_V_TVALID { I 1 bit } stream_in_V_TREADY { O 1 bit } } \
} "
} else {
