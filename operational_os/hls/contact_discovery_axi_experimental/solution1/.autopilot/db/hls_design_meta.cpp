...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("db_in_V_V_TDATA", 512, hls_in, 2, "axis", "in_data", 1),
	Port_Property("db_in_V_V_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("db_in_V_V_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
