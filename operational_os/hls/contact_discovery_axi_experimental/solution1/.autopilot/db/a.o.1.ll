...
define internal fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %db_item) nounwind uwtable {
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %db_item}, metadata !3010), !dbg !3011 ; [debug line = 21:28] [debug variable = db_item]
  %db_item.addr = getelementptr inbounds %struct.ap_uint.3* %db_item, i64 0, i32 0, i32 0, i32 0, !dbg !3012 ; [#uses=1 type=i512*] [debug line = 2925:9@25:15]
  %db_item.load = load i512* %db_item.addr, align 64, !dbg !3012 ; [#uses=2 type=i512] [debug line = 2925:9@25:15]
  br label %1, !dbg !3018                         ; [debug line = 24:6]

; <label>:1                                       ; preds = %2, %0
  %contacts_index = phi i32 [ 0, %0 ], [ %contacts_index.1, %2 ] ; [#uses=3 type=i32]
  %matched = phi i1 [ false, %0 ], [ %matched.1, %2 ] ; [#uses=2 type=i1]
  %exitcond = icmp eq i32 %contacts_index, 128, !dbg !3018 ; [#uses=1 type=i1] [debug line = 24:6]
  br i1 %exitcond, label %3, label %2, !dbg !3018 ; [debug line = 24:6]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %contacts_index to i64, !dbg !3014 ; [#uses=1 type=i64] [debug line = 25:15]
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp, i32 0, i32 0, i32 0, !dbg !3012 ; [#uses=1 type=i512*] [debug line = 2925:9@25:15]
  %contacts.load = load i512* %contacts.addr, align 64, !dbg !3012 ; [#uses=2 type=i512] [debug line = 2925:9@25:15]
  ...
  %tmp.1 = icmp eq i512 %contacts.load, %db_item.load, !dbg !3012 ; [#uses=1 type=i1] [debug line = 2925:9@25:15]
  %matched.1 = or i1 %matched, %tmp.1, !dbg !3014 ; [#uses=1 type=i1] [debug line = 25:15]
  call void @llvm.dbg.value(metadata !{i1 %matched.1}, i64 0, metadata !3019), !dbg !3014 ; [debug line = 25:15] [debug variable = matched]
  %contacts_index.1 = add nsw i32 %contacts_index, 1, !dbg !3020 ; [#uses=1 type=i32] [debug line = 24:46]
  call void @llvm.dbg.value(metadata !{i32 %contacts_index.1}, i64 0, metadata !3021), !dbg !3020 ; [debug line = 24:46] [debug variable = contacts_index]
  br label %1, !dbg !3020                         ; [debug line = 24:46]

; <label>:3                                       ; preds = %1
  %matched.0.lcssa = phi i1 [ %matched, %1 ]      ; [#uses=1 type=i1]
  ret i1 %matched.0.lcssa, !dbg !3022             ; [debug line = 27:2]
}
...
; [#uses=0]
define void @contact_discovery(i32 %operation, %struct.ap_uint.3* byval align 64 %contact_in, %struct.ap_uint.3* %db_mem, i64 %offset, i32 %db_size_in, i32* %error_out, i32* %contacts_size_out, i8* %results_out) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32 %operation}, i64 0, metadata !3023), !dbg !3024 ; [debug line = 40:6] [debug variable = operation]
  call void @llvm.dbg.declare(metadata !{%struct.ap_uint.3* %contact_in}, metadata !3025), !dbg !3026 ; [debug line = 41:7] [debug variable = contact_in]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %db_mem}, i64 0, metadata !3027), !dbg !3028 ; [debug line = 42:7] [debug variable = db_mem]
  call void @llvm.dbg.value(metadata !{i64 %offset}, i64 0, metadata !3029), !dbg !3030 ; [debug line = 43:21] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %db_size_in}, i64 0, metadata !3031), !dbg !3032 ; [debug line = 44:15] [debug variable = db_size_in]
  call void @llvm.dbg.value(metadata !{i32* %error_out}, i64 0, metadata !3033), !dbg !3034 ; [debug line = 45:7] [debug variable = error_out]
  call void @llvm.dbg.value(metadata !{i32* %contacts_size_out}, i64 0, metadata !3035), !dbg !3036 ; [debug line = 46:7] [debug variable = contacts_size_out]
  call void @llvm.dbg.value(metadata !{i8* %results_out}, i64 0, metadata !3037), !dbg !3038 ; [debug line = 47:16] [debug variable = results_out]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_uint.3* %db_mem, i32 8388608) nounwind, !dbg !3039 ; [debug line = 48:3]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %results_out, i32 1048576) nounwind, !dbg !3041 ; [debug line = 48:42]
  call void (...)* @_ssdm_op_SpecInterface(i8* %results_out, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 8388608, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3042 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3043 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i64 %offset, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3044 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %db_mem, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 536870912, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3045 ; [debug line = 52:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3046 ; [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %db_size_in, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3047 ; [debug line = 55:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3048 ; [debug line = 57:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3049 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3050 ; [debug line = 59:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %contacts_size_out, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3051 ; [debug line = 60:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3052 ; [debug line = 61:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %error_out, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3053 ; [debug line = 62:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %operation, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3054 ; [debug line = 63:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.3* %contact_in, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3055 ; [debug line = 64:1]
  switch i32 %operation, label %11 [
    i32 0, label %2
    i32 1, label %6
    i32 2, label %10
  ], !dbg !3056                                   ; [debug line = 69:2]

; <label>:2                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3057 ; [debug line = 72:4]
  %contacts_size.load.1 = load i32* @contacts_size, align 4, !dbg !3059 ; [#uses=1 type=i32] [debug line = 73:4]
  store i32 %contacts_size.load.1, i32* %contacts_size_out, align 4, !dbg !3059 ; [debug line = 73:4]
  %contacts_size.load.2 = load i32* @contacts_size, align 4, !dbg !3060 ; [#uses=3 type=i32] [debug line = 74:4]
  %tmp = icmp sgt i32 %contacts_size.load.2, 127, !dbg !3060 ; [#uses=1 type=i1] [debug line = 74:4]
  br i1 %tmp, label %3, label %4, !dbg !3060      ; [debug line = 74:4]

; <label>:3                                       ; preds = %2
  store i32 1, i32* %error_out, align 4, !dbg !3061 ; [debug line = 75:5]
  %contacts_size.load.4 = load i32* @contacts_size, align 4, !dbg !3063 ; [#uses=1 type=i32] [debug line = 76:5]
  br label %5, !dbg !3064                         ; [debug line = 77:4]

; <label>:4                                       ; preds = %2
  %tmp.4 = sext i32 %contacts_size.load.2 to i64, !dbg !3065 ; [#uses=1 type=i64] [debug line = 78:5]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.3* %contact_in}, i64 0, metadata !3067), !dbg !3068 ; [debug line = 279:87@78:5] [debug variable = op2]
  %contact_in.addr = getelementptr inbounds %struct.ap_uint.3* %contact_in, i64 0, i32 0, i32 0, i32 0, !dbg !3069 ; [#uses=1 type=i512*] [debug line = 280:10@78:5]
  %contact_in.load = load i512* %contact_in.addr, align 64, !dbg !3069 ; [#uses=2 type=i512] [debug line = 280:10@78:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %contact_in.load) nounwind
  %contacts.addr = getelementptr inbounds [128 x %struct.ap_uint.3]* @contacts, i64 0, i64 %tmp.4, i32 0, i32 0, i32 0, !dbg !3069 ; [#uses=1 type=i512*] [debug line = 280:10@78:5]
  store i512 %contact_in.load, i512* %contacts.addr, align 64, !dbg !3069 ; [debug line = 280:10@78:5]
  %tmp.5 = add nsw i32 %contacts_size.load.2, 1, !dbg !3071 ; [#uses=2 type=i32] [debug line = 79:5]
  store i32 %tmp.5, i32* @contacts_size, align 4, !dbg !3071 ; [debug line = 79:5]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %storemerge = phi i32 [ %tmp.5, %4 ], [ %contacts_size.load.4, %3 ] ; [#uses=1 type=i32]
  store i32 %storemerge, i32* %contacts_size_out, align 4, !dbg !3063 ; [debug line = 76:5]
  br label %12, !dbg !3072                        ; [debug line = 82:4]

; <label>:6                                       ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3073 ; [debug line = 85:4]
  %contacts_size.load.3 = load i32* @contacts_size, align 4, !dbg !3074 ; [#uses=1 type=i32] [debug line = 86:4]
  store i32 %contacts_size.load.3, i32* %contacts_size_out, align 4, !dbg !3074 ; [debug line = 86:4]
  %db_length = zext i32 %db_size_in to i64, !dbg !3075 ; [#uses=1 type=i64] [debug line = 87:4]
  call void @llvm.dbg.value(metadata !{i64 %db_length}, i64 0, metadata !3076), !dbg !3075 ; [debug line = 87:4] [debug variable = db_length]
  %.addr = getelementptr inbounds %struct.ap_uint.3* %1, i64 0, i32 0, i32 0, i32 0, !dbg !3077 ; [#uses=1 type=i512*] [debug line = 100:52]
  br label %7, !dbg !3081                         ; [debug line = 89:8]

; <label>:7                                       ; preds = %9, %6
  %database_index = phi i32 [ 0, %6 ], [ %database_index.1, %9 ] ; [#uses=3 type=i32]
  %tmp.6 = icmp slt i32 %database_index, 8388608, !dbg !3081 ; [#uses=1 type=i1] [debug line = 89:8]
  br i1 %tmp.6, label %8, label %.loopexit, !dbg !3081 ; [debug line = 89:8]

; <label>:8                                       ; preds = %7
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3082 ; [#uses=1 type=i32] [debug line = 89:72]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3083 ; [debug line = 90:1]
  %tmp.7 = sext i32 %database_index to i64, !dbg !3084 ; [#uses=3 type=i64] [debug line = 99:5]
  %tmp.8 = icmp slt i64 %tmp.7, %db_length, !dbg !3084 ; [#uses=1 type=i1] [debug line = 99:5]
  br i1 %tmp.8, label %9, label %.loopexit, !dbg !3084 ; [debug line = 99:5]

; <label>:9                                       ; preds = %8
  %tmp.9 = add i64 %tmp.7, %offset, !dbg !3077    ; [#uses=1 type=i64] [debug line = 100:52]
  %db_mem.addr = getelementptr inbounds %struct.ap_uint.3* %db_mem, i64 %tmp.9, i32 0, i32 0, i32 0, !dbg !3077 ; [#uses=1 type=i512*] [debug line = 100:52]
  %db_mem.load = load i512* %db_mem.addr, align 8, !dbg !3077 ; [#uses=2 type=i512] [debug line = 100:52]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i512 %db_mem.load) nounwind
  store i512 %db_mem.load, i512* %.addr, align 64, !dbg !3077 ; [debug line = 100:52]
  %tmp.10 = call fastcc zeroext i1 @match_db_contact(%struct.ap_uint.3* byval align 64 %1), !dbg !3077 ; [#uses=1 type=i1] [debug line = 100:52]
  %tmp.11 = zext i1 %tmp.10 to i8, !dbg !3077     ; [#uses=1 type=i8] [debug line = 100:52]
  %results_out.addr = getelementptr inbounds i8* %results_out, i64 %tmp.7, !dbg !3077 ; [#uses=1 type=i8*] [debug line = 100:52]
  store i8 %tmp.11, i8* %results_out.addr, align 1, !dbg !3077 ; [debug line = 100:52]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3085 ; [#uses=0 type=i32] [debug line = 120:4]
  %database_index.1 = add nsw i32 %database_index, 1, !dbg !3086 ; [#uses=1 type=i32] [debug line = 89:54]
  call void @llvm.dbg.value(metadata !{i32 %database_index.1}, i64 0, metadata !3087), !dbg !3086 ; [debug line = 89:54] [debug variable = database_index]
  br label %7, !dbg !3086                         ; [debug line = 89:54]

.loopexit:                                        ; preds = %8, %7
  br label %12, !dbg !3088                        ; [debug line = 121:4]

; <label>:10                                      ; preds = %0
  store i32 0, i32* %error_out, align 4, !dbg !3089 ; [debug line = 124:4]
  store i32 0, i32* @contacts_size, align 4, !dbg !3090 ; [debug line = 125:4]
  store i32 0, i32* %contacts_size_out, align 4, !dbg !3091 ; [debug line = 126:4]
  br label %12, !dbg !3092                        ; [debug line = 127:4]

; <label>:11                                      ; preds = %0
  %contacts_size.load = load i32* @contacts_size, align 4, !dbg !3093 ; [#uses=1 type=i32] [debug line = 130:4]
  store i32 %contacts_size.load, i32* %contacts_size_out, align 4, !dbg !3093 ; [debug line = 130:4]
  store i32 3, i32* %error_out, align 4, !dbg !3094 ; [debug line = 131:4]
  br label %12, !dbg !3095                        ; [debug line = 132:4]

; <label>:12                                      ; preds = %11, %10, %.loopexit, %5
  ret void, !dbg !3096                            ; [debug line = 134:1]
}
...
!llvm.dbg.cu = !{!0, !3}
!hls.encrypted.func = !{}
!opencl.kernels = !{!2986, !2993, !2999, !3002, !3004, !3004, !3004, !3004}
...
!1258 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi512EEaSERKS0_", metadata !908, i32 279, metadata !1249, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1248, metadata !92, i32 279} ; [ DW_TAG_subprogram ]
...
!1262 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi512EEC1Ev", metadata !908, i32 185, metadata !1181, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1180, metadata !92, i32 185} ; [ DW_TAG_subprogram ]
!1263 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi512EEC2Ev", metadata !908, i32 185, metadata !1181, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1180, metadata !92, i32 185} ; [ DW_TAG_subprogram ]
!1264 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi512ELb0ELb0EEC2Ev", metadata !894, i32 2381, metadata !927, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !926, metadata !92, i32 2381} ; [ DW_TAG_subprogram ]
!1265 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi512ELb0EEC2Ev", metadata !915, i32 526, metadata !920, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !919, metadata !92, i32 526} ; [ DW_TAG_subprogram ]
...
!1316 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1318, i32 74, metadata !1319, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!1328 = metadata !{i32 786484, i32 0, null, metadata !"contacts", metadata !"contacts", metadata !"_ZL8contacts", metadata !903, i32 13, metadata !1329, i32 1, i32 1, [128 x %struct.ap_uint.3]* @contacts} ; [ DW_TAG_variable ]
...
!1332 = metadata !{i32 786484, i32 0, null, metadata !"db_buffer", metadata !"db_buffer", metadata !"_ZL9db_buffer", metadata !903, i32 14, metadata !1333, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!1336 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !1337, i32 315, metadata !1338, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1339 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !1337, i32 316, metadata !1338, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1340 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !1337, i32 317, metadata !1338, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1341 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1342, i32 26, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1343 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1342, i32 30, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1344 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1345, i32 168, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1346 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1347, i32 73, metadata !1348, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1349 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1347, i32 76, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1350 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1347, i32 111, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1351 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1347, i32 114, metadata !1348, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1352 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1347, i32 117, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1353 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1347, i32 120, metadata !171, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1354 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1355, i32 283, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1356 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1355, i32 297, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1357 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1355, i32 403, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1358 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !1359, i32 57, metadata !216, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1360 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1359, i32 71, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1361 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1359, i32 76, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1362 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1359, i32 80, metadata !59, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1363 = metadata !{i32 786484, i32 0, metadata !1364, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1365, i32 70, metadata !1366, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1368 = metadata !{i32 786484, i32 0, metadata !118, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !120, i32 307, metadata !1369, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1371 = metadata !{i32 786484, i32 0, metadata !131, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !120, i32 353, metadata !1369, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1372 = metadata !{i32 786484, i32 0, metadata !254, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !120, i32 456, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1373 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !120, i32 634, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1374 = metadata !{i32 786484, i32 0, metadata !1319, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !8, i32 542, metadata !87, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1375 = metadata !{i32 786484, i32 0, metadata !1319, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !8, i32 543, metadata !241, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1376 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1377, i32 613, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1480 = metadata !{i32 786484, i32 0, metadata !1395, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1377, i32 696, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1481 = metadata !{i32 786484, i32 0, metadata !1482, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1377, i32 1198, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1612 = metadata !{i32 786484, i32 0, metadata !1613, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1377, i32 1543, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1619 = metadata !{i32 786484, i32 0, metadata !1613, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1377, i32 1547, metadata !175, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1620 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1377, i32 1657, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1621 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1377, i32 1926, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1622 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1377, i32 2264, metadata !254, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1623 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1318, i32 60, metadata !1624, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2304 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1318, i32 61, metadata !2305, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2306 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1318, i32 62, metadata !2305, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2307 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1318, i32 63, metadata !2305, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2308 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1318, i32 66, metadata !2309, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2981 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1318, i32 67, metadata !2982, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2983 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1318, i32 68, metadata !2982, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2984 = metadata !{i32 786484, i32 0, metadata !1317, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1318, i32 69, metadata !2982, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2985 = metadata !{i32 786484, i32 0, null, metadata !"contacts_size", metadata !"contacts_size", metadata !"_ZL13contacts_size", metadata !903, i32 16, metadata !59, i32 1, i32 1, i32* @contacts_size} ; [ DW_TAG_variable ]
!2986 = metadata !{i1 (%struct.ap_uint.3*)* @match_db_contact, metadata !2987, metadata !2988, metadata !2989, metadata !2990, metadata !2991, metadata !2992}
...
!2993 = metadata !{void (i32, %struct.ap_uint.3*, %struct.ap_uint.3*, i64, i32, i32*, i32*, i8*)* @contact_discovery, metadata !2994, metadata !2995, metadata !2996, metadata !2997, metadata !2998, metadata !2992}
...
!2999 = metadata !{null, metadata !2987, metadata !2988, metadata !3000, metadata !2990, metadata !3001, metadata !2992}
!3000 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<512> &"}
!3001 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3002 = metadata !{null, metadata !2987, metadata !2988, metadata !3003, metadata !2990, metadata !3001, metadata !2992}
!3003 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<512, false> &"}
!3004 = metadata !{null, metadata !3005, metadata !3006, metadata !3007, metadata !3008, metadata !3009, metadata !2992}
...
!3010 = metadata !{i32 786689, metadata !902, metadata !"db_item", metadata !903, i32 16777237, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3011 = metadata !{i32 21, i32 28, metadata !902, null}
!3012 = metadata !{i32 2925, i32 9, metadata !3013, metadata !3014}
!3013 = metadata !{i32 786443, metadata !1259, i32 2924, i32 107, metadata !894, i32 12} ; [ DW_TAG_lexical_block ]
!3014 = metadata !{i32 25, i32 15, metadata !3015, null}
!3015 = metadata !{i32 786443, metadata !3016, i32 24, i32 63, metadata !903, i32 2} ; [ DW_TAG_lexical_block ]
!3016 = metadata !{i32 786443, metadata !3017, i32 24, i32 2, metadata !903, i32 1} ; [ DW_TAG_lexical_block ]
!3017 = metadata !{i32 786443, metadata !902, i32 21, i32 36, metadata !903, i32 0} ; [ DW_TAG_lexical_block ]
!3018 = metadata !{i32 24, i32 6, metadata !3016, null}
!3019 = metadata !{i32 786688, metadata !3017, metadata !"matched", metadata !903, i32 23, metadata !241, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3020 = metadata !{i32 24, i32 46, metadata !3016, null}
!3021 = metadata !{i32 786688, metadata !3017, metadata !"contacts_index", metadata !903, i32 22, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3022 = metadata !{i32 27, i32 2, metadata !3017, null}
!3023 = metadata !{i32 786689, metadata !1252, metadata !"operation", metadata !903, i32 16777256, metadata !59, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3024 = metadata !{i32 40, i32 6, metadata !1252, null}
!3025 = metadata !{i32 786689, metadata !1252, metadata !"contact_in", metadata !903, i32 33554473, metadata !906, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3026 = metadata !{i32 41, i32 7, metadata !1252, null}
!3027 = metadata !{i32 786689, metadata !1252, metadata !"db_mem", metadata !903, i32 50331690, metadata !1255, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3028 = metadata !{i32 42, i32 7, metadata !1252, null}
!3029 = metadata !{i32 786689, metadata !1252, metadata !"offset", metadata !903, i32 67108907, metadata !984, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3030 = metadata !{i32 43, i32 21, metadata !1252, null}
!3031 = metadata !{i32 786689, metadata !1252, metadata !"db_size_in", metadata !903, i32 83886124, metadata !968, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3032 = metadata !{i32 44, i32 15, metadata !1252, null}
!3033 = metadata !{i32 786689, metadata !1252, metadata !"error_out", metadata !903, i32 100663341, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3034 = metadata !{i32 45, i32 7, metadata !1252, null}
!3035 = metadata !{i32 786689, metadata !1252, metadata !"contacts_size_out", metadata !903, i32 117440558, metadata !1256, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3036 = metadata !{i32 46, i32 7, metadata !1252, null}
!3037 = metadata !{i32 786689, metadata !1252, metadata !"results_out", metadata !903, i32 134217775, metadata !1257, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3038 = metadata !{i32 47, i32 16, metadata !1252, null}
!3039 = metadata !{i32 48, i32 3, metadata !3040, null}
!3040 = metadata !{i32 786443, metadata !1252, i32 48, i32 2, metadata !903, i32 3} ; [ DW_TAG_lexical_block ]
!3041 = metadata !{i32 48, i32 42, metadata !3040, null}
!3042 = metadata !{i32 49, i32 1, metadata !3040, null}
!3043 = metadata !{i32 50, i32 1, metadata !3040, null}
!3044 = metadata !{i32 51, i32 1, metadata !3040, null}
!3045 = metadata !{i32 52, i32 1, metadata !3040, null}
!3046 = metadata !{i32 54, i32 1, metadata !3040, null}
!3047 = metadata !{i32 55, i32 1, metadata !3040, null}
!3048 = metadata !{i32 57, i32 1, metadata !3040, null}
!3049 = metadata !{i32 58, i32 1, metadata !3040, null}
!3050 = metadata !{i32 59, i32 1, metadata !3040, null}
!3051 = metadata !{i32 60, i32 1, metadata !3040, null}
!3052 = metadata !{i32 61, i32 1, metadata !3040, null}
!3053 = metadata !{i32 62, i32 1, metadata !3040, null}
!3054 = metadata !{i32 63, i32 1, metadata !3040, null}
!3055 = metadata !{i32 64, i32 1, metadata !3040, null}
!3056 = metadata !{i32 69, i32 2, metadata !3040, null}
!3057 = metadata !{i32 72, i32 4, metadata !3058, null}
!3058 = metadata !{i32 786443, metadata !3040, i32 69, i32 19, metadata !903, i32 4} ; [ DW_TAG_lexical_block ]
!3059 = metadata !{i32 73, i32 4, metadata !3058, null}
!3060 = metadata !{i32 74, i32 4, metadata !3058, null}
!3061 = metadata !{i32 75, i32 5, metadata !3062, null}
!3062 = metadata !{i32 786443, metadata !3058, i32 74, i32 28, metadata !903, i32 5} ; [ DW_TAG_lexical_block ]
!3063 = metadata !{i32 76, i32 5, metadata !3062, null}
!3064 = metadata !{i32 77, i32 4, metadata !3062, null}
!3065 = metadata !{i32 78, i32 5, metadata !3066, null}
!3066 = metadata !{i32 786443, metadata !3058, i32 77, i32 10, metadata !903, i32 6} ; [ DW_TAG_lexical_block ]
!3067 = metadata !{i32 786689, metadata !1258, metadata !"op2", metadata !908, i32 33554711, metadata !1237, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3068 = metadata !{i32 279, i32 87, metadata !1258, metadata !3065}
!3069 = metadata !{i32 280, i32 10, metadata !3070, metadata !3065}
!3070 = metadata !{i32 786443, metadata !1258, i32 279, i32 92, metadata !908, i32 11} ; [ DW_TAG_lexical_block ]
!3071 = metadata !{i32 79, i32 5, metadata !3066, null}
!3072 = metadata !{i32 82, i32 4, metadata !3058, null}
!3073 = metadata !{i32 85, i32 4, metadata !3058, null}
!3074 = metadata !{i32 86, i32 4, metadata !3058, null}
!3075 = metadata !{i32 87, i32 4, metadata !3058, null}
!3076 = metadata !{i32 786688, metadata !3040, metadata !"db_length", metadata !903, i32 66, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3077 = metadata !{i32 100, i32 52, metadata !3078, null}
!3078 = metadata !{i32 786443, metadata !3079, i32 99, i32 35, metadata !903, i32 9} ; [ DW_TAG_lexical_block ]
!3079 = metadata !{i32 786443, metadata !3080, i32 89, i32 71, metadata !903, i32 8} ; [ DW_TAG_lexical_block ]
!3080 = metadata !{i32 786443, metadata !3058, i32 89, i32 4, metadata !903, i32 7} ; [ DW_TAG_lexical_block ]
!3081 = metadata !{i32 89, i32 8, metadata !3080, null}
!3082 = metadata !{i32 89, i32 72, metadata !3079, null}
!3083 = metadata !{i32 90, i32 1, metadata !3079, null}
!3084 = metadata !{i32 99, i32 5, metadata !3079, null}
!3085 = metadata !{i32 120, i32 4, metadata !3079, null}
!3086 = metadata !{i32 89, i32 54, metadata !3080, null}
!3087 = metadata !{i32 786688, metadata !3040, metadata !"database_index", metadata !903, i32 65, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3088 = metadata !{i32 121, i32 4, metadata !3058, null}
!3089 = metadata !{i32 124, i32 4, metadata !3058, null}
!3090 = metadata !{i32 125, i32 4, metadata !3058, null}
!3091 = metadata !{i32 126, i32 4, metadata !3058, null}
!3092 = metadata !{i32 127, i32 4, metadata !3058, null}
!3093 = metadata !{i32 130, i32 4, metadata !3058, null}
!3094 = metadata !{i32 131, i32 4, metadata !3058, null}
!3095 = metadata !{i32 132, i32 4, metadata !3058, null}
!3096 = metadata !{i32 134, i32 1, metadata !3040, null}
